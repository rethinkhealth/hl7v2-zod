 ...
 */
export const DLN_3 = SimpleTypes.DT.max(24).optional().register(hl7v2Metadata, {
  "title": "DLN.3",
  "version": "2.5",
...
/**
 * DLN - HL7 v2.5 DLN composite data type
 * 
 * Components:
...
export const DLN = z.object({
  ...
  title: 'DLN',
  version: '2.5',
  description: 'HL7 v2.5 DLN composite data type'
});
