...
/**
 * HL7 v2.5 PPN Composite Data Type
 * 
 * HL7 v2.5 PPN composite data type
 ...
 */
export const PPN_11 = SimpleTypes.ST.max(1).optional().register(hl7v2Metadata, {
  "title": "PPN.11",
  "version": "2.5",
 ...
 */
export const PPN_15 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "PPN.15",
  "version": "2.5",
 ...
 * PPN.17 - Name Context
 */
export const PPN_17 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "PPN.17",
  "version": "2.5",
 ...
 */
export const PPN_20 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "PPN.20",
  "version": "2.5",
 ...
 */
export const PPN_21 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "PPN.21",
  "version": "2.5",
...
/**
 * PPN - HL7 v2.5 PPN composite data type
 * 
 * Components:
 * - PPN.1: ID Number (ST)
 ...
 * - PPN.15: Date/Time Action Performed (TS)
 * - PPN.16: Name Representation Code (ID)
 * - PPN.17: Name Context (CE)
 * - PPN.18: Name Validity Range (DR)
 * - PPN.19: Name Assembly Order (ID)
 * - PPN.20: Effective Date (TS)
 * - PPN.21: Expiration Date (TS)
...
export const PPN = z.object({
  ...
  title: 'PPN',
  version: '2.5',
  description: 'HL7 v2.5 PPN composite data type'
});
