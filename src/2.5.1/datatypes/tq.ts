...
/**
 * HL7 v2.5 TQ Composite Data Type
 * 
 * HL7 v2.5 TQ composite data type
 ...
 */
export const TQ_4 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "TQ.4",
  "version": "2.5",
 ...
 * TQ.5 - End Date/Time
 */
export const TQ_5 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "TQ.5",
  "version": "2.5",
 ...
 */
export const TQ_11 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "TQ.11",
  "version": "2.5",
...
/**
 * TQ - HL7 v2.5 TQ composite data type
 * 
 * Components:
 * - TQ.1: Quantity (CQ)
 * - TQ.2: Interval (RI)
...
export const TQ = z.object({
  ...
  title: 'TQ',
  version: '2.5',
  description: 'HL7 v2.5 TQ composite data type'
});
