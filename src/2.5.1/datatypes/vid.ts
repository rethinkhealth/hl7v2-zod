 ...
 * VID.1 - Version ID
 */
export const VID_1 = SimpleTypes.ID.max(5).optional().register(hl7v2Metadata, {
  "title": "VID.1",
  "version": "2.5",
 ...
 */
export const VID_2 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "VID.2",
  "version": "2.5",
 ...
 */
export const VID_3 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "VID.3",
  "version": "2.5",
...
/**
 * VID - HL7 v2.5 VID composite data type
 * 
 * Components:
 * - VID.1: Version ID (ID)
...
export const VID = z.object({
  ...
  title: 'VID',
  version: '2.5',
  description: 'HL7 v2.5 VID composite data type'
});
