...
export const OBX_12 = datatypes.ST.register(hl7v2Metadata, {
  "title": "OBX.12",
  "version": "2.5",
  "description": "Effective Date of Reference Range Values",
  "type": "Field",
  "item": 580,
  "table": "",
  "longName": "HL7Effective Date of Reference Range Values",
  "length": 26
});
...
export const OBX_15 = datatypes.ST.register(hl7v2Metadata, {
  "title": "OBX.15",
  "version": "2.5",
  "description": "Producer's Reference",
  "type": "Field",
  "item": 583,
  "table": "",
  "longName": "HL7Producer's Reference",
  "length": 250
});
...
/**
 * OBX.20 - Reserved for harmonization with V2.6
 */
export const OBX_20 = datatypes.VARIES.register(hl7v2Metadata, {
  "title": "OBX.20",
  "version": "2.5",
  "description": "Reserved for harmonization with V2.6",
  "type": "Field",
  "item": 9999,
  "table": "",
  "longName": "HL7Reserved for harmonization with V2.6"
});

/**
 * OBX.21 - Reserved for harmonization with V2.6
 */
export const OBX_21 = datatypes.VARIES.register(hl7v2Metadata, {
  "title": "OBX.21",
  "version": "2.5",
  "description": "Reserved for harmonization with V2.6",
  "type": "Field",
...
/**
 * OBX.22 - Reserved for harmonization with V2.6
 */
export const OBX_22 = datatypes.VARIES.register(hl7v2Metadata, {
  "title": "OBX.22",
  "version": "2.5",
  "description": "Reserved for harmonization with V2.6",
  "type": "Field",
