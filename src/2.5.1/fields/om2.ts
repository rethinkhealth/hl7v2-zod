 ...
 * HL7 v2.5 OM2 Fields
 * 
 * HL7 v2.5 OM2 field definitions
 ...
 */
export const OM2_2 = datatypes.ST.register(hl7v2Metadata, {
  "title": "OM2.2",
  "version": "2.5",
 ...
 */
export const OM2_4 = datatypes.ST.register(hl7v2Metadata, {
  "title": "OM2.4",
  "version": "2.5",
...
/**
 * OM2.6 - Reference (Normal) Range - Ordinal and Continuous Observations
 */
export const OM2_6 = datatypes.RFR.register(hl7v2Metadata, {
  "title": "OM2.6",
  "version": "2.5",
  "description": "Reference (Normal) Range - Ordinal and Continuous Observations",
  "type": "Field",
  "item": 631,
  "table": "",
  "longName": "HL7Reference (Normal) Range - Ordinal and Continuous Observations",
  "length": 250
});
