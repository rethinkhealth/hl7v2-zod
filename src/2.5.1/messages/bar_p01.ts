...
/**
 * HL7 v2.5 BAR_P01 Message
 * 
 * HL7 v2.5 BAR_P01 message definition
...
export const barP01ProcedureSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 BAR_P01.PROCEDURE group",
  type: "Group"
});
...
export const barP01InsuranceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 BAR_P01.INSURANCE group",
  type: "Group"
});
...
export const barP01VisitSchema = z.object({
  ...
  title: "BAR_P01.VISIT",
  version: "2.5",
  description: "HL7 v2.5 BAR_P01.VISIT group",
  type: "Group"
});
...
export const bar_p01Schema = z.object({
  ...
  title: "BAR_P01",
  version: "2.5",
  description: "HL7 v2.5 BAR_P01 message",
  type: "Message"
});
