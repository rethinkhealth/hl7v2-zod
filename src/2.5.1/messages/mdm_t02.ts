...
/**
 * HL7 v2.5 MDM_T02 Message
 * 
 * HL7 v2.5 MDM_T02 message definition
...
export const mdmT02TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 MDM_T02.TIMING group",
  type: "Group"
});
...
export const mdmT02ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 MDM_T02.OBSERVATION group",
  type: "Group"
});
...
export const mdmT02CommonOrderSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 MDM_T02.COMMON_ORDER group",
  type: "Group"
});
...
export const mdm_t02Schema = z.object({
  ...
  title: "MDM_T02",
  version: "2.5",
  description: "HL7 v2.5 MDM_T02 message",
  type: "Message"
});
