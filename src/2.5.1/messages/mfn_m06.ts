...
/**
 * HL7 v2.5 MFN_M06 Message
 * 
 * HL7 v2.5 MFN_M06 message definition
 ...
 */
export const mfnM06MfPhaseSchedDetailSchema = z.object({
  "CM1": segments.cm1Schema,
  "CM2": z.array(segments.cm2Schema).optional()
}).register(hl7v2Metadata, {
  title: "MFN_M06.MF_PHASE_SCHED_DETAIL",
  version: "2.5",
  description: "HL7 v2.5 MFN_M06.MF_PHASE_SCHED_DETAIL group",
  type: "Group"
});
 ...
 */
export const mfnM06MfClinStudySchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 MFN_M06.MF_CLIN_STUDY group",
  type: "Group"
});
 ...
 */
export const mfn_m06Schema = z.object({
  ...
  title: "MFN_M06",
  version: "2.5",
  description: "HL7 v2.5 MFN_M06 message",
  type: "Message"
});
