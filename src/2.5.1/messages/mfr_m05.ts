...
/**
 * HL7 v2.5 MFR_M05 Message
 * 
 * HL7 v2.5 MFR_M05 message definition
 ...
 */
export const mfrM05MfQuerySchema = z.object({
  ...
  "LDP": z.array(segments.ldpSchema),
  "LCH_1": z.array(segments.lchSchema).optional(),
  "LCC": z.array(segments.lccSchema).optional()
}).register(hl7v2Metadata, {
  title: "MFR_M05.MF_QUERY",
  version: "2.5",
  description: "HL7 v2.5 MFR_M05.MF_QUERY group",
  type: "Group"
});
 ...
 */
export const mfr_m05Schema = z.object({
  ...
  title: "MFR_M05",
  version: "2.5",
  description: "HL7 v2.5 MFR_M05 message",
  type: "Message"
});
