...
/**
 * HL7 v2.5 MFR_M06 Message
 * 
 * HL7 v2.5 MFR_M06 message definition
 ...
 */
export const mfrM06MfQuerySchema = z.object({
  "MFE": segments.mfeSchema,
  "CM0": segments.cm0Schema,
  "CM1": z.array(segments.cm1Schema).optional(),
  "CM2": z.array(segments.cm2Schema).optional()
}).register(hl7v2Metadata, {
  title: "MFR_M06.MF_QUERY",
  version: "2.5",
  description: "HL7 v2.5 MFR_M06.MF_QUERY group",
  type: "Group"
});
 ...
 */
export const mfr_m06Schema = z.object({
  ...
  title: "MFR_M06",
  version: "2.5",
  description: "HL7 v2.5 MFR_M06 message",
  type: "Message"
});
