...
/**
 * HL7 v2.5 NMQ_N01 Message
 * 
 * HL7 v2.5 NMQ_N01 message definition
 ...
 */
export const nmqN01QryWithDetailSchema = z.object({
  "QRD": segments.qrdSchema,
  "QRF": segments.qrfSchema.optional()
}).register(hl7v2Metadata, {
  title: "NMQ_N01.QRY_WITH_DETAIL",
  version: "2.5",
  description: "HL7 v2.5 NMQ_N01.QRY_WITH_DETAIL group",
  type: "Group"
});
 ...
 */
export const nmqN01ClockAndStatisticsSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 NMQ_N01.CLOCK_AND_STATISTICS group",
  type: "Group"
});
 ...
 */
export const nmq_n01Schema = z.object({
  ...
  title: "NMQ_N01",
  version: "2.5",
  description: "HL7 v2.5 NMQ_N01 message",
  type: "Message"
});
