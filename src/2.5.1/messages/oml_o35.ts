...
/**
 * HL7 v2.5 OML_O35 Message
 * 
 * HL7 v2.5 OML_O35 message definition
...
export const omlO35PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.PATIENT_VISIT group",
  type: "Group"
});
...
export const omlO35InsuranceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.INSURANCE group",
  type: "Group"
});
...
export const omlO35TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.TIMING group",
  type: "Group"
});
...
export const omlO35ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.OBSERVATION group",
  type: "Group"
});
...
export const omlO35PatientPriorSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.PATIENT_PRIOR group",
  type: "Group"
});
...
export const omlO35PatientVisitPriorSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.PATIENT_VISIT_PRIOR group",
  type: "Group"
});
...
export const omlO35TimingPriorSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.TIMING_PRIOR group",
  type: "Group"
});
...
export const omlO35ObservationPriorSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.OBSERVATION_PRIOR group",
  type: "Group"
});
...
export const omlO35PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.PATIENT group",
  type: "Group"
});
...
export const omlO35OrderPriorSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.ORDER_PRIOR group",
  type: "Group"
});
...
export const omlO35PriorResultSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.PRIOR_RESULT group",
  type: "Group"
});
...
export const omlO35ObservationRequestSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const omlO35OrderSchema = z.object({
  ...
  title: "OML_O35.ORDER",
  version: "2.5",
  description: "HL7 v2.5 OML_O35.ORDER group",
  type: "Group"
});
...
export const omlO35SpecimenContainerSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.SPECIMEN_CONTAINER group",
  type: "Group"
});
...
export const omlO35SpecimenSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OML_O35.SPECIMEN group",
  type: "Group"
});
...
export const oml_o35Schema = z.object({
  ...
  title: "OML_O35",
  version: "2.5",
  description: "HL7 v2.5 OML_O35 message",
  type: "Message"
});
