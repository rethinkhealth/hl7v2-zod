...
/**
 * HL7 v2.5 OMN_O07 Message
 * 
 * HL7 v2.5 OMN_O07 message definition
...
export const omnO07PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMN_O07.PATIENT_VISIT group",
  type: "Group"
});
...
export const omnO07InsuranceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMN_O07.INSURANCE group",
  type: "Group"
});
...
export const omnO07TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMN_O07.TIMING group",
  type: "Group"
});
...
export const omnO07ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMN_O07.OBSERVATION group",
  type: "Group"
});
...
export const omnO07PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMN_O07.PATIENT group",
  type: "Group"
});
...
export const omnO07OrderSchema = z.object({
  ...
  title: "OMN_O07.ORDER",
  version: "2.5",
  description: "HL7 v2.5 OMN_O07.ORDER group",
  type: "Group"
});
...
export const omn_o07Schema = z.object({
  ...
  title: "OMN_O07",
  version: "2.5",
  description: "HL7 v2.5 OMN_O07 message",
  type: "Message"
});
