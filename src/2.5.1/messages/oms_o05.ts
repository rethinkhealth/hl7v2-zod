...
/**
 * HL7 v2.5 OMS_O05 Message
 * 
 * HL7 v2.5 OMS_O05 message definition
...
export const omsO05PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMS_O05.PATIENT_VISIT group",
  type: "Group"
});
...
export const omsO05InsuranceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMS_O05.INSURANCE group",
  type: "Group"
});
...
export const omsO05TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMS_O05.TIMING group",
  type: "Group"
});
...
export const omsO05ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMS_O05.OBSERVATION group",
  type: "Group"
});
...
export const omsO05PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OMS_O05.PATIENT group",
  type: "Group"
});
...
export const omsO05OrderSchema = z.object({
  ...
  title: "OMS_O05.ORDER",
  version: "2.5",
  description: "HL7 v2.5 OMS_O05.ORDER group",
  type: "Group"
});
...
export const oms_o05Schema = z.object({
  ...
  title: "OMS_O05",
  version: "2.5",
  description: "HL7 v2.5 OMS_O05 message",
  type: "Message"
});
