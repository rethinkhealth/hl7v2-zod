...
/**
 * HL7 v2.5 ORL_O22 Message
 * 
 * HL7 v2.5 ORL_O22 message definition
...
export const orlO22TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORL_O22.TIMING group",
  type: "Group"
});
...
export const orlO22SpecimenSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORL_O22.SPECIMEN group",
  type: "Group"
});
...
export const orlO22ObservationRequestSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORL_O22.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const orlO22OrderSchema = z.object({
  ...
  title: "ORL_O22.ORDER",
  version: "2.5",
  description: "HL7 v2.5 ORL_O22.ORDER group",
  type: "Group"
});
...
/**
 * ORL_O22.PATIENT group schema
 * Defines the structure and validation rules for the ORL_O22.PATIENT group
 */
export const orlO22PatientSchema = z.object({
  "PID": segments.pidSchema,
  "ORDER": z.array(orlO22OrderSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORL_O22.PATIENT",
  version: "2.5",
  description: "HL7 v2.5 ORL_O22.PATIENT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORL_O22.PATIENT schema
 */
export type ORL_O22_PATIENT = z.infer<typeof orlO22PatientSchema>;
...
export const orlO22ResponseSchema = z.object({
  "PATIENT": orlO22PatientSchema.optional()
}).register(hl7v2Metadata, {
  title: "ORL_O22.RESPONSE",
  version: "2.5",
  description: "HL7 v2.5 ORL_O22.RESPONSE group",
  type: "Group"
});
...
export const orl_o22Schema = z.object({
  ...
  title: "ORL_O22",
  version: "2.5",
  description: "HL7 v2.5 ORL_O22 message",
  type: "Message"
});
