 ...
 */
export const ormO01PatientVisitSchema = z.object({
 ...
 */
export const ormO01InsuranceSchema = z.object({
 ...
 */
export const ormO01ChoiceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORM_O01.CHOICE group",
  type: "Group"
});
 ...
 */
export const ormO01ObservationSchema = z.object({
 ...
 */
export const ormO01PatientSchema = z.object({
 ...
 */
export const ormO01OrderDetailSchema = z.object({
 ...
 */
export const ormO01OrderSchema = z.object({
 ...
 */
export const orm_o01Schema = z.object({
