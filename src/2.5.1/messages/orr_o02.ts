...
/**
 * HL7 v2.5 ORR_O02 Message
 * 
 * HL7 v2.5 ORR_O02 message definition
...
export const orrO02PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORR_O02.PATIENT group",
  type: "Group"
});
...
export const orrO02ChoiceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORR_O02.CHOICE group",
  type: "Group"
});
...
export const orrO02OrderSchema = z.object({
  ...
  title: "ORR_O02.ORDER",
  version: "2.5",
  description: "HL7 v2.5 ORR_O02.ORDER group",
  type: "Group"
});
...
export const orrO02ResponseSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 ORR_O02.RESPONSE group",
  type: "Group"
});
...
export const orr_o02Schema = z.object({
  ...
  title: "ORR_O02",
  version: "2.5",
  description: "HL7 v2.5 ORR_O02 message",
  type: "Message"
});
