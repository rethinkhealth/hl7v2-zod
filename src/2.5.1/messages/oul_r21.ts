...
/**
 * HL7 v2.5 OUL_R21 Message
 * 
 * HL7 v2.5 OUL_R21 message definition
 ...
 */
export const oulR21PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OUL_R21.PATIENT group",
  type: "Group"
});
 ...
 */
export const oulR21VisitSchema = z.object({
  "PV1": segments.pv1Schema,
  "PV2": segments.pv2Schema.optional()
}).register(hl7v2Metadata, {
  title: "OUL_R21.VISIT",
  version: "2.5",
  description: "HL7 v2.5 OUL_R21.VISIT group",
  type: "Group"
});
 ...
 */
export const oulR21ContainerSchema = z.object({
  "SAC": segments.sacSchema,
  "SID": segments.sidSchema.optional()
}).register(hl7v2Metadata, {
  title: "OUL_R21.CONTAINER",
  version: "2.5",
  description: "HL7 v2.5 OUL_R21.CONTAINER group",
  type: "Group"
});
 ...
 */
export const oulR21TimingQtySchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R21.TIMING_QTY",
  version: "2.5",
  description: "HL7 v2.5 OUL_R21.TIMING_QTY group",
  type: "Group"
});
 ...
 */
export const oulR21ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OUL_R21.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const oulR21OrderObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 OUL_R21.ORDER_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const oul_r21Schema = z.object({
  ...
  title: "OUL_R21",
  version: "2.5",
  description: "HL7 v2.5 OUL_R21 message",
  type: "Message"
});
