...
/**
 * HL7 v2.5 PEX_P07 Message
 * 
 * HL7 v2.5 PEX_P07 message definition
...
export const pexP07VisitSchema = z.object({
  ...
  title: "PEX_P07.VISIT",
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.VISIT group",
  type: "Group"
});
...
export const pexP07TimingQtySchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.TIMING_QTY group",
  type: "Group"
});
...
export const pexP07RxAdministrationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.RX_ADMINISTRATION group",
  type: "Group"
});
...
export const pexP07Nk1TimingQtySchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.NK1_TIMING_QTY group",
  type: "Group"
});
...
export const pexP07AssociatedRxAdminSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.ASSOCIATED_RX_ADMIN group",
  type: "Group"
});
...
export const pexP07StudySchema = z.object({
  ...
  title: "PEX_P07.STUDY",
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.STUDY group",
  type: "Group"
});
...
export const pexP07RxOrderSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.RX_ORDER group",
  type: "Group"
});
...
export const pexP07AssociatedRxOrderSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.ASSOCIATED_RX_ORDER group",
  type: "Group"
});
...
export const pexP07AssociatedPersonSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.ASSOCIATED_PERSON group",
  type: "Group"
});
...
export const pexP07PexCauseSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.PEX_CAUSE group",
  type: "Group"
});
...
export const pexP07PexObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.PEX_OBSERVATION group",
  type: "Group"
});
...
export const pexP07ExperienceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 PEX_P07.EXPERIENCE group",
  type: "Group"
});
...
export const pex_p07Schema = z.object({
  ...
  title: "PEX_P07",
  version: "2.5",
  description: "HL7 v2.5 PEX_P07 message",
  type: "Message"
});
