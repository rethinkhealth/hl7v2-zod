...
/**
 * HL7 v2.5 RAS_O17 Message
 * 
 * HL7 v2.5 RAS_O17 message definition
...
export const rasO17PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.PATIENT_VISIT group",
  type: "Group"
});
...
export const rasO17TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.TIMING group",
  type: "Group"
});
...
export const rasO17ComponentsSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.COMPONENTS group",
  type: "Group"
});
...
export const rasO17TimingEncodedSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.TIMING_ENCODED group",
  type: "Group"
});
...
export const rasO17ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.OBSERVATION group",
  type: "Group"
});
...
export const rasO17PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.PATIENT group",
  type: "Group"
});
...
export const rasO17OrderDetailSupplementSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.ORDER_DETAIL_SUPPLEMENT group",
  type: "Group"
});
...
export const rasO17EncodingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.ENCODING group",
  type: "Group"
});
...
export const rasO17AdministrationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.ADMINISTRATION group",
  type: "Group"
});
...
export const rasO17OrderDetailSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.ORDER_DETAIL group",
  type: "Group"
});
...
export const rasO17OrderSchema = z.object({
  ...
  title: "RAS_O17.ORDER",
  version: "2.5",
  description: "HL7 v2.5 RAS_O17.ORDER group",
  type: "Group"
});
...
export const ras_o17Schema = z.object({
  ...
  title: "RAS_O17",
  version: "2.5",
  description: "HL7 v2.5 RAS_O17 message",
  type: "Message"
});
