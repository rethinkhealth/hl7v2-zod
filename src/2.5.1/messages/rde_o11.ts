...
/**
 * HL7 v2.5 RDE_O11 Message
 * 
 * HL7 v2.5 RDE_O11 message definition
...
export const rdeO11PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.PATIENT_VISIT group",
  type: "Group"
});
...
export const rdeO11InsuranceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.INSURANCE group",
  type: "Group"
});
...
export const rdeO11TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.TIMING group",
  type: "Group"
});
...
export const rdeO11ComponentSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.COMPONENT group",
  type: "Group"
});
...
export const rdeO11TimingEncodedSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.TIMING_ENCODED group",
  type: "Group"
});
...
export const rdeO11ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.OBSERVATION group",
  type: "Group"
});
...
export const rdeO11PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.PATIENT group",
  type: "Group"
});
...
export const rdeO11OrderDetailSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.ORDER_DETAIL group",
  type: "Group"
});
...
export const rdeO11OrderSchema = z.object({
  ...
  title: "RDE_O11.ORDER",
  version: "2.5",
  description: "HL7 v2.5 RDE_O11.ORDER group",
  type: "Group"
});
...
export const rde_o11Schema = z.object({
  ...
  title: "RDE_O11",
  version: "2.5",
  description: "HL7 v2.5 RDE_O11 message",
  type: "Message"
});
