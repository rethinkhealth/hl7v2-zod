...
/**
 * HL7 v2.5 RGV_O15 Message
 * 
 * HL7 v2.5 RGV_O15 message definition
...
export const rgvO15PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.PATIENT_VISIT group",
  type: "Group"
});
...
export const rgvO15TimingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.TIMING group",
  type: "Group"
});
...
export const rgvO15ComponentsSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.COMPONENTS group",
  type: "Group"
});
...
export const rgvO15TimingEncodedSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.TIMING_ENCODED group",
  type: "Group"
});
...
export const rgvO15TimingGiveSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.TIMING_GIVE group",
  type: "Group"
});
...
export const rgvO15ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.OBSERVATION group",
  type: "Group"
});
...
export const rgvO15PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.PATIENT group",
  type: "Group"
});
...
export const rgvO15OrderDetailSupplementSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.ORDER_DETAIL_SUPPLEMENT group",
  type: "Group"
});
...
export const rgvO15EncodingSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.ENCODING group",
  type: "Group"
});
...
export const rgvO15GiveSchema = z.object({
  ...
  title: "RGV_O15.GIVE",
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.GIVE group",
  type: "Group"
});
...
export const rgvO15OrderDetailSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.ORDER_DETAIL group",
  type: "Group"
});
...
export const rgvO15OrderSchema = z.object({
  ...
  title: "RGV_O15.ORDER",
  version: "2.5",
  description: "HL7 v2.5 RGV_O15.ORDER group",
  type: "Group"
});
...
export const rgv_o15Schema = z.object({
  ...
  title: "RGV_O15",
  version: "2.5",
  description: "HL7 v2.5 RGV_O15 message",
  type: "Message"
});
