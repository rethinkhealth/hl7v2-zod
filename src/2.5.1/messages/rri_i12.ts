...
/**
 * HL7 v2.5 RRI_I12 Message
 * 
 * HL7 v2.5 RRI_I12 message definition
...
export const rriI12AuthorizationContactSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RRI_I12.AUTHORIZATION_CONTACT group",
  type: "Group"
});
...
export const rriI12ProviderContactSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RRI_I12.PROVIDER_CONTACT group",
  type: "Group"
});
...
export const rriI12ResultsNotesSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RRI_I12.RESULTS_NOTES group",
  type: "Group"
});
...
export const rriI12PatientVisitSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RRI_I12.PATIENT_VISIT group",
  type: "Group"
});
...
export const rriI12ProcedureSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RRI_I12.PROCEDURE group",
  type: "Group"
});
...
export const rriI12ObservationSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RRI_I12.OBSERVATION group",
  type: "Group"
});
...
export const rri_i12Schema = z.object({
  ...
  title: "RRI_I12",
  version: "2.5",
  description: "HL7 v2.5 RRI_I12 message",
  type: "Message"
});
