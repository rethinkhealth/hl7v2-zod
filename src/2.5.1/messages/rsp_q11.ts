...
/**
 * HL7 v2.5 RSP_Q11 Message
 * 
 * HL7 v2.5 RSP_Q11 message definition
 ...
 */
export const rspQ11MfLocDeptSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RSP_Q11.MF_LOC_DEPT group",
  type: "Group"
});
 ...
 */
export const rspQ11QueryResultClusterSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RSP_Q11.QUERY_RESULT_CLUSTER group",
  type: "Group"
});
 ...
 */
export const rsp_q11Schema = z.object({
  ...
  title: "RSP_Q11",
  version: "2.5",
  description: "HL7 v2.5 RSP_Q11 message",
  type: "Message"
});
