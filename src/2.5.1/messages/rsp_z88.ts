...
/**
 * HL7 v2.5 RSP_Z88 Message
 * 
 * HL7 v2.5 RSP_Z88 message definition
 ...
 */
export const rspZ88VisitSchema = z.object({
  "PV1": segments.pv1Schema,
  "PV2": segments.pv2Schema.optional()
}).register(hl7v2Metadata, {
  title: "RSP_Z88.VISIT",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.VISIT group",
  type: "Group"
});
 ...
 */
export const rspZ88TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RSP_Z88.TIMING",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.TIMING group",
  type: "Group"
});
 ...
 */
export const rspZ88ComponentSchema = z.object({
  "RXC": z.array(segments.rxcSchema),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RSP_Z88.COMPONENT",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.COMPONENT group",
  type: "Group"
});
 ...
 */
export const rspZ88TimingEncodedSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RSP_Z88.TIMING_ENCODED",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.TIMING_ENCODED group",
  type: "Group"
});
 ...
 */
export const rspZ88ObservationSchema = z.object({
  "OBX": segments.obxSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RSP_Z88.OBSERVATION",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rspZ88AllergySchema = z.object({
  "AL1": z.array(segments.al1Schema),
  "VISIT": rspZ88VisitSchema.optional()
}).register(hl7v2Metadata, {
  title: "RSP_Z88.ALLERGY",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.ALLERGY group",
  type: "Group"
});
 ...
 */
export const rspZ88OrderDetailSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.ORDER_DETAIL group",
  type: "Group"
});
 ...
 */
export const rspZ88OrderEncodedSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.ORDER_ENCODED group",
  type: "Group"
});
 ...
 */
export const rspZ88PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.PATIENT group",
  type: "Group"
});
 ...
 */
export const rspZ88CommonOrderSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88.COMMON_ORDER group",
  type: "Group"
});
 ...
 */
export const rsp_z88Schema = z.object({
  ...
  title: "RSP_Z88",
  version: "2.5",
  description: "HL7 v2.5 RSP_Z88 message",
  type: "Message"
});
