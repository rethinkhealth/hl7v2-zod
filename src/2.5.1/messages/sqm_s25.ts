...
/**
 * HL7 v2.5 SQM_S25 Message
 * 
 * HL7 v2.5 SQM_S25 message definition
 ...
 */
export const sqmS25ServiceSchema = z.object({
  "AIS": segments.aisSchema,
  "APR": segments.aprSchema.optional()
}).register(hl7v2Metadata, {
  title: "SQM_S25.SERVICE",
  version: "2.5",
  description: "HL7 v2.5 SQM_S25.SERVICE group",
  type: "Group"
});
 ...
 */
export const sqmS25GeneralResourceSchema = z.object({
  "AIG": segments.aigSchema,
  "APR": segments.aprSchema.optional()
}).register(hl7v2Metadata, {
  title: "SQM_S25.GENERAL_RESOURCE",
  version: "2.5",
  description: "HL7 v2.5 SQM_S25.GENERAL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const sqmS25PersonnelResourceSchema = z.object({
  "AIP": segments.aipSchema,
  "APR": segments.aprSchema.optional()
}).register(hl7v2Metadata, {
  title: "SQM_S25.PERSONNEL_RESOURCE",
  version: "2.5",
  description: "HL7 v2.5 SQM_S25.PERSONNEL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const sqmS25LocationResourceSchema = z.object({
  "AIL": segments.ailSchema,
  "APR": segments.aprSchema.optional()
}).register(hl7v2Metadata, {
  title: "SQM_S25.LOCATION_RESOURCE",
  version: "2.5",
  description: "HL7 v2.5 SQM_S25.LOCATION_RESOURCE group",
  type: "Group"
});
 ...
 */
export const sqmS25ResourcesSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SQM_S25.RESOURCES group",
  type: "Group"
});
 ...
 */
export const sqmS25RequestSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SQM_S25.REQUEST group",
  type: "Group"
});
 ...
 */
export const sqm_s25Schema = z.object({
  ...
  title: "SQM_S25",
  version: "2.5",
  description: "HL7 v2.5 SQM_S25 message",
  type: "Message"
});
