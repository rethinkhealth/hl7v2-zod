...
/**
 * HL7 v2.5 SQR_S25 Message
 * 
 * HL7 v2.5 SQR_S25 message definition
 ...
 */
export const sqrS25PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.PATIENT group",
  type: "Group"
});
 ...
 */
export const sqrS25ServiceSchema = z.object({
  "AIS": segments.aisSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SQR_S25.SERVICE",
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.SERVICE group",
  type: "Group"
});
 ...
 */
export const sqrS25GeneralResourceSchema = z.object({
  "AIG": segments.aigSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SQR_S25.GENERAL_RESOURCE",
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.GENERAL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const sqrS25PersonnelResourceSchema = z.object({
  "AIP": segments.aipSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SQR_S25.PERSONNEL_RESOURCE",
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.PERSONNEL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const sqrS25LocationResourceSchema = z.object({
  "AIL": segments.ailSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SQR_S25.LOCATION_RESOURCE",
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.LOCATION_RESOURCE group",
  type: "Group"
});
 ...
 */
export const sqrS25ResourcesSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.RESOURCES group",
  type: "Group"
});
 ...
 */
export const sqrS25ScheduleSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SQR_S25.SCHEDULE group",
  type: "Group"
});
 ...
 */
export const sqr_s25Schema = z.object({
  ...
  title: "SQR_S25",
  version: "2.5",
  description: "HL7 v2.5 SQR_S25 message",
  type: "Message"
});
