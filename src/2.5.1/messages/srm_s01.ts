...
/**
 * HL7 v2.5 SRM_S01 Message
 * 
 * HL7 v2.5 SRM_S01 message definition
...
export const srmS01PatientSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SRM_S01.PATIENT group",
  type: "Group"
});
...
export const srmS01ServiceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SRM_S01.SERVICE group",
  type: "Group"
});
...
export const srmS01GeneralResourceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SRM_S01.GENERAL_RESOURCE group",
  type: "Group"
});
...
export const srmS01LocationResourceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SRM_S01.LOCATION_RESOURCE group",
  type: "Group"
});
...
export const srmS01PersonnelResourceSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SRM_S01.PERSONNEL_RESOURCE group",
  type: "Group"
});
...
export const srmS01ResourcesSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SRM_S01.RESOURCES group",
  type: "Group"
});
...
export const srm_s01Schema = z.object({
  ...
  title: "SRM_S01",
  version: "2.5",
  description: "HL7 v2.5 SRM_S01 message",
  type: "Message"
});
