...
/**
 * HL7 v2.5 SSU_U03 Message
 * 
 * HL7 v2.5 SSU_U03 message definition
...
export const ssuU03SpecimenSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SSU_U03.SPECIMEN group",
  type: "Group"
});
...
export const ssuU03SpecimenContainerSchema = z.object({
  ...
  version: "2.5",
  description: "HL7 v2.5 SSU_U03.SPECIMEN_CONTAINER group",
  type: "Group"
});
...
export const ssu_u03Schema = z.object({
  ...
  title: "SSU_U03",
  version: "2.5",
  description: "HL7 v2.5 SSU_U03 message",
  type: "Message"
});
