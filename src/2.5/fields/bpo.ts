 ...
 * HL7 v2.5 BPO Fields
 *
 * HL7 v2.5 BPO field definitions
...
/**
 * BPO.2 - BP Universal Service ID
 */
export const BPO_2 = datatypes.CWE.register(hl7v2Metadata, {
  title: "BPO.2",
  version: "2.5",
  description: "BP Universal Service ID",
  type: "Field",
  item: 1701,
  table: "",
  longName: "HL7BP Universal Service ID",
  length: 250
});
 ...
 * BPO.6 - BP Units
 */
export const BPO_6 = datatypes.ST.register(hl7v2Metadata, {
  title: "BPO.6",
  version: "2.5",
 ...
 */
export const BPO_7 = datatypes.ST.register(hl7v2Metadata, {
  title: "BPO.7",
  version: "2.5",
 ...
 */
export const BPO_10 = datatypes.ST.register(hl7v2Metadata, {
  title: "BPO.10",
  version: "2.5",
