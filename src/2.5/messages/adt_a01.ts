...
/**
 * HL7 v2.5 ADT_A01 Message
 *
 * HL7 v2.5 ADT_A01 message definition
 ...
 */
export const adtA01ProcedureSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ADT_A01.PROCEDURE group",
    type: "Group"
  });
 ...
 */
export const adtA01InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ADT_A01.INSURANCE group",
    type: "Group"
  });
...
export const adt_a01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ADT_A01",
    version: "2.5",
    description: "HL7 v2.5 ADT_A01 message",
    type: "Message"
  });
