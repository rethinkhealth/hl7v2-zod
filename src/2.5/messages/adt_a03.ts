...
/**
 * HL7 v2.5 ADT_A03 Message
 *
 * HL7 v2.5 ADT_A03 message definition
...
export const adtA03ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ADT_A03.PROCEDURE group",
    type: "Group"
  });
...
export const adtA03InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ADT_A03.INSURANCE group",
    type: "Group"
  });
...
export const adt_a03Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ADT_A03",
    version: "2.5",
    description: "HL7 v2.5 ADT_A03 message",
    type: "Message"
  });
