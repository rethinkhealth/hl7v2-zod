...
/**
 * HL7 v2.5 NMR_N01 Message
 *
 * HL7 v2.5 NMR_N01 message definition
 ...
 */
export const nmrN01ClockSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "NMR_N01.CLOCK",
    version: "2.5",
    description: "HL7 v2.5 NMR_N01.CLOCK group",
    type: "Group"
  });
 ...
 */
export const nmrN01AppStatsSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 NMR_N01.APP_STATS group",
    type: "Group"
  });
 ...
 */
export const nmrN01AppStatusSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 NMR_N01.APP_STATUS group",
    type: "Group"
  });
 ...
 */
export const nmrN01ClockAndStatsWithNotesAltSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 NMR_N01.CLOCK_AND_STATS_WITH_NOTES_ALT group",
    type: "Group"
  });
 ...
 */
export type NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT = z.infer<
  typeof nmrN01ClockAndStatsWithNotesAltSchema
>;
...
export const nmr_n01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "NMR_N01",
    version: "2.5",
    description: "HL7 v2.5 NMR_N01 message",
    type: "Message"
  });
