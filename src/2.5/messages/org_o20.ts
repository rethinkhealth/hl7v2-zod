...
/**
 * HL7 v2.5 ORG_O20 Message
 *
 * HL7 v2.5 ORG_O20 message definition
...
export const orgO20PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORG_O20.PATIENT group",
    type: "Group"
  });
...
export const orgO20TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORG_O20.TIMING group",
    type: "Group"
  });
...
export const orgO20SpecimenSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORG_O20.SPECIMEN group",
    type: "Group"
  });
...
export const orgO20OrderSchema = z
  .object({
    ...
    OBR: segments.obrSchema.optional(),
    NTE: z.array(segments.nteSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    title: "ORG_O20.ORDER",
    version: "2.5",
    description: "HL7 v2.5 ORG_O20.ORDER group",
    type: "Group"
  });
...
export const orgO20ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORG_O20.RESPONSE group",
    type: "Group"
  });
...
export const org_o20Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORG_O20",
    version: "2.5",
    description: "HL7 v2.5 ORG_O20 message",
    type: "Message"
  });
