...
/**
 * Simplified ORL_O34.SPECIMEN group schema
 * Defines the structure and validation rules for the ORL_O34.SPECIMEN group
 */
export const orlO34SimplifiedSpecimenSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O34.SPECIMEN (simplified)",
    version: "2.5",
    description: "HL7 v2.5 ORL_O34.SPECIMEN (simplified) group",
    type: "Group"
  });
 ...
 */
export type ORL_O34_REQUEST_SPECIMEN = z.infer<typeof orlO34SimplifiedSpecimenSchema>;
...
export const orlO34ObservationRequestSchema = z
  .object({
    ...
    SPECIMEN: z.array(orlO34SimplifiedSpecimenSchema).optional()
  })
  .register(hl7v2Metadata, {
 ...
 */
export const orlO34PatientSchema = z
  .object({
