...
/**
 * HL7 v2.5 ORL_O36 Message
 *
 * HL7 v2.5 ORL_O36 message definition
...
export const orlO36TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.TIMING group",
    type: "Group"
  });
...
export const orlO36ObservationRequestSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.OBSERVATION_REQUEST group",
    type: "Group"
  });
...
export const orlO36OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O36.ORDER",
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.ORDER group",
    type: "Group"
  });
...
export const orlO36SpecimenContainerSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.SPECIMEN_CONTAINER group",
    type: "Group"
  });
...
export const orlO36SpecimenSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.SPECIMEN group",
    type: "Group"
  });
...
/**
 * ORL_O36.PATIENT group schema
 * Defines the structure and validation rules for the ORL_O36.PATIENT group
 */
export const orlO36PatientSchema = z
  .object({
    PID: segments.pidSchema,
    SPECIMEN: z.array(orlO36SpecimenSchema)
  })
  .register(hl7v2Metadata, {
    title: "ORL_O36.PATIENT",
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.PATIENT group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the ORL_O36.PATIENT schema
 */
export type ORL_O36_PATIENT = z.infer<typeof orlO36PatientSchema>;
...
export const orlO36ResponseSchema = z
  .object({
    PATIENT: orlO36PatientSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "ORL_O36.RESPONSE",
    version: "2.5",
    description: "HL7 v2.5 ORL_O36.RESPONSE group",
    type: "Group"
  });
...
export const orl_o36Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O36",
    version: "2.5",
    description: "HL7 v2.5 ORL_O36 message",
    type: "Message"
  });
