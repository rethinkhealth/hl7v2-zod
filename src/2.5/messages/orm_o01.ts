...
/**
 * HL7 v2.5 ORM_O01 Message
 *
 * HL7 v2.5 ORM_O01 message definition
...
export const ormO01PatientVisitSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.PATIENT_VISIT group",
    type: "Group"
  });
...
export const ormO01InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.INSURANCE group",
    type: "Group"
  });
...
/**
 * ORM_O01.ORDER_CHOICE group schema
 * Defines the structure and validation rules for the ORM_O01.ORDER_CHOICE group
 */
export const ormO01OrderChoiceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "ORM_O01.ORDER_CHOICE",
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.ORDER_CHOICE group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the ORM_O01.ORDER_CHOICE schema
 */
export type ORM_O01_ORDER_CHOICE = z.infer<typeof ormO01OrderChoiceSchema>;
...
export const ormO01ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.OBSERVATION group",
    type: "Group"
  });
...
export const ormO01PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.PATIENT group",
    type: "Group"
  });
...
export const ormO01OrderDetailSchema = z
  .object({
    ORDER_CHOICE: ormO01OrderChoiceSchema,
    NTE: z.array(segments.nteSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.ORDER_DETAIL group",
    type: "Group"
  });
...
export const ormO01OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORM_O01.ORDER",
    version: "2.5",
    description: "HL7 v2.5 ORM_O01.ORDER group",
    type: "Group"
  });
...
export const orm_o01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORM_O01",
    version: "2.5",
    description: "HL7 v2.5 ORM_O01 message",
    type: "Message"
  });
