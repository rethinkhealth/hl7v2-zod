...
/**
 * HL7 v2.5 ORN_O08 Message
 *
 * HL7 v2.5 ORN_O08 message definition
...
export const ornO08PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORN_O08.PATIENT group",
    type: "Group"
  });
...
export const ornO08TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORN_O08.TIMING group",
    type: "Group"
  });
...
export const ornO08OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORN_O08.ORDER",
    version: "2.5",
    description: "HL7 v2.5 ORN_O08.ORDER group",
    type: "Group"
  });
...
export const ornO08ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 ORN_O08.RESPONSE group",
    type: "Group"
  });
...
export const orn_o08Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORN_O08",
    version: "2.5",
    description: "HL7 v2.5 ORN_O08 message",
    type: "Message"
  });
