...
/**
 * HL7 v2.5 OSR_Q06 Message
 *
 * HL7 v2.5 OSR_Q06 message definition
 ...
 */
export const osrQ06PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 OSR_Q06.PATIENT group",
    type: "Group"
  });
 ...
 */
export const osrQ06TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 OSR_Q06.TIMING group",
    type: "Group"
  });
 ...
 */
export const osrQ06ChoiceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 OSR_Q06.CHOICE group",
    type: "Group"
  });
 ...
 */
export const osrQ06OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "OSR_Q06.ORDER",
    version: "2.5",
    description: "HL7 v2.5 OSR_Q06.ORDER group",
    type: "Group"
  });
 ...
 */
export const osrQ06ResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 OSR_Q06.RESPONSE group",
    type: "Group"
  });
...
export const osr_q06Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OSR_Q06",
    version: "2.5",
    description: "HL7 v2.5 OSR_Q06 message",
    type: "Message"
  });
