...
/**
 * HL7 v2.5 RDS_O13 Message
 *
 * HL7 v2.5 RDS_O13 message definition
...
export const rdsO13PatientVisitSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.PATIENT_VISIT group",
    type: "Group"
  });
...
export const rdsO13TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.TIMING group",
    type: "Group"
  });
...
export const rdsO13ComponentSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.COMPONENT group",
    type: "Group"
  });
...
export const rdsO13TimingEncodedSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.TIMING_ENCODED group",
    type: "Group"
  });
...
export const rdsO13ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.OBSERVATION group",
    type: "Group"
  });
...
export const rdsO13PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.PATIENT group",
    type: "Group"
  });
...
export const rdsO13OrderDetailSupplementSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.ORDER_DETAIL_SUPPLEMENT group",
    type: "Group"
  });
...
export const rdsO13EncodingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.ENCODING group",
    type: "Group"
  });
...
export const rdsO13OrderDetailSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.ORDER_DETAIL group",
    type: "Group"
  });
...
export const rdsO13OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "RDS_O13.ORDER",
    version: "2.5",
    description: "HL7 v2.5 RDS_O13.ORDER group",
    type: "Group"
  });
...
export const rds_o13Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RDS_O13",
    version: "2.5",
    description: "HL7 v2.5 RDS_O13 message",
    type: "Message"
  });
