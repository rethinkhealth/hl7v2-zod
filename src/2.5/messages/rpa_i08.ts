...
/**
 * HL7 v2.5 RPA_I08 Message
 *
 * HL7 v2.5 RPA_I08 message definition
...
/**
 * RPA_I08.AUTHORIZATION_1 group schema
 * Defines the structure and validation rules for the RPA_I08.AUTHORIZATION_1 group
 */
export const rpaI08Authorization1Schema = z
  .object({
    AUT: segments.autSchema,
    CTD: segments.ctdSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "RPA_I08.AUTHORIZATION_1",
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.AUTHORIZATION_1 group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the RPA_I08.AUTHORIZATION_1 schema
 */
export type RPA_I08_AUTHORIZATION_1 = z.infer<typeof rpaI08Authorization1Schema>;
...
export const rpaI08ProviderSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.PROVIDER group",
    type: "Group"
  });
...
export const rpaI08InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.INSURANCE group",
    type: "Group"
  });
...
/**
 * RPA_I08.AUTHORIZATION_2 group schema
 * Defines the structure and validation rules for the RPA_I08.AUTHORIZATION_2 group
 */
export const rpaI08Authorization2Schema = z
  .object({
    AUT: segments.autSchema,
    CTD: segments.ctdSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "RPA_I08.AUTHORIZATION_2",
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.AUTHORIZATION_2 group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the RPA_I08.AUTHORIZATION_2 schema
 */
export type RPA_I08_AUTHORIZATION_2 = z.infer<typeof rpaI08Authorization2Schema>;
...
export const rpaI08ResultsSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.RESULTS group",
    type: "Group"
  });
...
export const rpaI08VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "RPA_I08.VISIT",
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.VISIT group",
    type: "Group"
  });
...
export const rpaI08ProcedureSchema = z
  .object({
    ...
    AUTHORIZATION_2: rpaI08Authorization2Schema.optional()
  })
  .register(hl7v2Metadata, {
    title: "RPA_I08.PROCEDURE",
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.PROCEDURE group",
    type: "Group"
  });
...
export const rpaI08ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RPA_I08.OBSERVATION group",
    type: "Group"
  });
...
export const rpa_i08Schema = z
  .object({
    ...
    AUTHORIZATION_1: rpaI08Authorization1Schema.optional(),
  ...
  .register(hl7v2Metadata, {
    title: "RPA_I08",
    version: "2.5",
    description: "HL7 v2.5 RPA_I08 message",
    type: "Message"
  });
