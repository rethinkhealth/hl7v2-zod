...
/**
 * HL7 v2.5 RQA_I08 Message
 *
 * HL7 v2.5 RQA_I08 message definition
...
export const rqaI08AuthorizationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.AUTHORIZATION group",
    type: "Group"
  });
...
export const rqaI08ProviderSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.PROVIDER group",
    type: "Group"
  });
...
export const rqaI08InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.INSURANCE group",
    type: "Group"
  });
...
export const rqaI08ResultsSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.RESULTS group",
    type: "Group"
  });
...
export const rqaI08VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "RQA_I08.VISIT",
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.VISIT group",
    type: "Group"
  });
...
export const rqaI08ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.PROCEDURE group",
    type: "Group"
  });
...
export const rqaI08GuarantorInsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.GUARANTOR_INSURANCE group",
    type: "Group"
  });
...
export const rqaI08ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RQA_I08.OBSERVATION group",
    type: "Group"
  });
...
export const rqa_i08Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RQA_I08",
    version: "2.5",
    description: "HL7 v2.5 RQA_I08 message",
    type: "Message"
  });
