...
/**
 * HL7 v2.5 RSP_K11 Message
 *
 * HL7 v2.5 RSP_K11 message definition
 ...
 */
export const rspK11RowDefinitionSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K11.ROW_DEFINITION group",
    type: "Group"
  });
...
export const rsp_k11Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_K11",
    version: "2.5",
    description: "HL7 v2.5 RSP_K11 message",
    type: "Message"
  });
