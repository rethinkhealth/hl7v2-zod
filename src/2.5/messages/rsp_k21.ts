...
/**
 * HL7 v2.5 RSP_K21 Message
 *
 * HL7 v2.5 RSP_K21 message definition
...
export const rspK21QueryResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K21.QUERY_RESPONSE group",
    type: "Group"
  });
...
export const rsp_k21Schema = z
  .object({
    ...
    QUERY_RESPONSE: z.array(rspK21QueryResponseSchema).optional(),
    DSC: segments.dscSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "RSP_K21",
    version: "2.5",
    description: "HL7 v2.5 RSP_K21 message",
    type: "Message"
  });
