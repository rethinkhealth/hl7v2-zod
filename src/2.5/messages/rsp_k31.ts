...
/**
 * HL7 v2.5 RSP_K31 Message
 *
 * HL7 v2.5 RSP_K31 message definition
...
export const rspK31PatientVisitSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.PATIENT_VISIT group",
    type: "Group"
  });
...
export const rspK31TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.TIMING group",
    type: "Group"
  });
...
export const rspK31ComponentsSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.COMPONENTS group",
    type: "Group"
  });
...
export const rspK31TimingEncodedSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.TIMING_ENCODED group",
    type: "Group"
  });
...
export const rspK31ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.OBSERVATION group",
    type: "Group"
  });
...
export const rspK31PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.PATIENT group",
    type: "Group"
  });
...
export const rspK31OrderDetailSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.ORDER_DETAIL group",
    type: "Group"
  });
...
export const rspK31EncodingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.ENCODING group",
    type: "Group"
  });
...
export const rspK31OrderSchema = z
  .object({
    ...
    RXR: z.array(segments.rxrSchema),
    RXC: z.array(segments.rxcSchema).optional(),
    OBSERVATION: z.array(rspK31ObservationSchema)
  })
  .register(hl7v2Metadata, {
    title: "RSP_K31.ORDER",
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.ORDER group",
    type: "Group"
  });
...
export const rspK31ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 RSP_K31.RESPONSE group",
    type: "Group"
  });
...
export const rsp_k31Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_K31",
    version: "2.5",
    description: "HL7 v2.5 RSP_K31 message",
    type: "Message"
  });
