...
/**
 * HL7 v2.5 SRR_S01 Message
 *
 * HL7 v2.5 SRR_S01 message definition
...
export const srrS01PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.PATIENT group",
    type: "Group"
  });
...
export const srrS01ServiceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.SERVICE group",
    type: "Group"
  });
...
export const srrS01GeneralResourceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.GENERAL_RESOURCE group",
    type: "Group"
  });
...
export const srrS01LocationResourceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.LOCATION_RESOURCE group",
    type: "Group"
  });
...
export const srrS01PersonnelResourceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.PERSONNEL_RESOURCE group",
    type: "Group"
  });
...
export const srrS01ResourcesSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.RESOURCES group",
    type: "Group"
  });
...
export const srrS01ScheduleSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.5",
    description: "HL7 v2.5 SRR_S01.SCHEDULE group",
    type: "Group"
  });
...
export const srr_s01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "SRR_S01",
    version: "2.5",
    description: "HL7 v2.5 SRR_S01 message",
    type: "Message"
  });
