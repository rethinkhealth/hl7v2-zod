...
/**
 * HL7 v2.6 CCP Composite Data Type
 * 
 * HL7 v2.6 CCP composite data type
 ...
 */
export const CCP_1 = SimpleTypes.NM.max(6).optional().register(hl7v2Metadata, {
  "title": "CCP.1",
  "version": "2.6",
 ...
 */
export const CCP_2 = SimpleTypes.NM.max(6).optional().register(hl7v2Metadata, {
  "title": "CCP.2",
  "version": "2.6",
 ...
 */
export const CCP_3 = SimpleTypes.NM.max(6).optional().register(hl7v2Metadata, {
  "title": "CCP.3",
  "version": "2.6",
...
/**
 * CCP - HL7 v2.6 CCP composite data type
 * 
 * Components:
...
export const CCP = z.object({
  ...
  title: 'CCP',
  version: '2.6',
  description: 'HL7 v2.6 CCP composite data type'
});
