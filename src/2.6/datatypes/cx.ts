...
/**
 * HL7 v2.6 CX Composite Data Type
 *
 * HL7 v2.6 CX composite data type
 ...
 */
export const CX_2 = SimpleTypes.ST.max(4).optional().register(hl7v2Metadata, {
  title: 'CX.2',
  version: '2.6',
...
/**
 * CX - HL7 v2.6 CX composite data type
 *
 * Components:
 * - CX.1: ID Number (ST)
...
export const CX = z
  ...
  .register(hl7v2Metadata, {
    title: 'CX',
    version: '2.6',
    description: 'HL7 v2.6 CX composite data type',
  });
