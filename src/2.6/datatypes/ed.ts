...
/**
 * HL7 v2.6 ED Composite Data Type
 * 
 * HL7 v2.6 ED composite data type
 ...
 * ED.2 - Type of Data
 */
export const ED_2 = SimpleTypes.ID.max(11).register(hl7v2Metadata, {
  "title": "ED.2",
  "version": "2.6",
 ...
 * ED.3 - Data Subtype
 */
export const ED_3 = SimpleTypes.ID.max(32).optional().register(hl7v2Metadata, {
  "title": "ED.3",
  "version": "2.6",
...
/**
 * ED - HL7 v2.6 ED composite data type
 * 
 * Components:
...
export const ED = z.object({
  ...
  title: 'ED',
  version: '2.6',
  description: 'HL7 v2.6 ED composite data type'
});
