...
/**
 * HL7 v2.6 ELD Composite Data Type
 * 
 * HL7 v2.6 ELD composite data type
 ...
 */
export const ELD_4 = CWE.optional().register(hl7v2Metadata, {
  "title": "ELD.4",
  "version": "2.6",
...
/**
 * ELD - HL7 v2.6 ELD composite data type
 * 
 * Components:
 * - ELD.1: Segment ID (ST)
 * - ELD.2: Segment Sequence (NM)
 * - ELD.3: Field Position (NM)
 * - ELD.4: Code Identifying Error (CWE)
 */
export const ELD = z.object({
  ...
  title: 'ELD',
  version: '2.6',
  description: 'HL7 v2.6 ELD composite data type'
});
