...
/**
 * HL7 v2.6 HD Composite Data Type
 * 
 * HL7 v2.6 HD composite data type
 ...
 * HD.1 - Namespace ID
 */
export const HD_1 = SimpleTypes.IS.max(20).optional().register(hl7v2Metadata, {
  "title": "HD.1",
  "version": "2.6",
 ...
 * HD.2 - Universal ID
 */
export const HD_2 = SimpleTypes.ST.max(999).optional().register(hl7v2Metadata, {
  "title": "HD.2",
  "version": "2.6",
...
/**
 * HD - HL7 v2.6 HD composite data type
 * 
 * Components:
...
export const HD = z.object({
  ...
  title: 'HD',
  version: '2.6',
  description: 'HL7 v2.6 HD composite data type'
});
