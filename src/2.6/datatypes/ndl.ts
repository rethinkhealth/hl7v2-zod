...
/**
 * HL7 v2.6 NDL Composite Data Type
 * 
 * HL7 v2.6 NDL composite data type
 ...
 */
export const NDL_2 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  "title": "NDL.2",
  "version": "2.6",
 ...
 * NDL.3 - End Date/time
 */
export const NDL_3 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  "title": "NDL.3",
  "version": "2.6",
...
/**
 * NDL - HL7 v2.6 NDL composite data type
 * 
 * Components:
 * - NDL.1: Name (CNN)
...
export const NDL = z.object({
  ...
  title: 'NDL',
  version: '2.6',
  description: 'HL7 v2.6 NDL composite data type'
});
