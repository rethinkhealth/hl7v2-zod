...
/**
 * HL7 v2.6 OSP Composite Data Type
 *
 * HL7 v2.6 OSP composite data type
 ...
 */
export const OSP_2 = SimpleTypes.DT.max(8).optional().register(hl7v2Metadata, {
  title: "OSP.2",
  version: "2.6",
 ...
 */
export const OSP_3 = SimpleTypes.DT.max(8).optional().register(hl7v2Metadata, {
  title: "OSP.3",
  version: "2.6",
...
/**
 * OSP - HL7 v2.6 OSP composite data type
 *
 * Components:
...
export const OSP = z
  ...
  .register(hl7v2Metadata, {
    title: "OSP",
    version: "2.6",
    description: "HL7 v2.6 OSP composite data type"
  });
