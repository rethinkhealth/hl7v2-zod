...
/**
 * HL7 v2.6 PT Composite Data Type
 * 
 * HL7 v2.6 PT composite data type
 ...
 * PT.1 - Processing ID
 */
export const PT_1 = SimpleTypes.ID.max(1).optional().register(hl7v2Metadata, {
  "title": "PT.1",
  "version": "2.6",
...
/**
 * PT - HL7 v2.6 PT composite data type
 * 
 * Components:
...
export const PT = z.object({
  ...
  title: 'PT',
  version: '2.6',
  description: 'HL7 v2.6 PT composite data type'
});
