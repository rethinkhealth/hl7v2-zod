...
/**
 * HL7 v2.6 VH Composite Data Type
 * 
 * HL7 v2.6 VH composite data type
 ...
 */
export const VH_3 = SimpleTypes.TM.max(16).optional().register(hl7v2Metadata, {
  "title": "VH.3",
  "version": "2.6",
 ...
 * VH.4 - End Hour Range
 */
export const VH_4 = SimpleTypes.TM.max(16).optional().register(hl7v2Metadata, {
  "title": "VH.4",
  "version": "2.6",
...
/**
 * VH - HL7 v2.6 VH composite data type
 * 
 * Components:
...
export const VH = z.object({
  ...
  title: 'VH',
  version: '2.6',
  description: 'HL7 v2.6 VH composite data type'
});
