...
/**
 * HL7 v2.6 XCN Composite Data Type
 *
 * HL7 v2.6 XCN composite data type
 ...
 */
export const XCN_11 = SimpleTypes.ST.max(4).optional().register(hl7v2Metadata, {
  title: 'XCN.11',
  version: '2.6',
 ...
 */
export const XCN_19 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  title: 'XCN.19',
  version: '2.6',
 ...
 */
export const XCN_20 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  title: 'XCN.20',
  version: '2.6',
...
/**
 * XCN - HL7 v2.6 XCN composite data type
 *
 * Components:
 * - XCN.1: ID Number (ST)
...
export const XCN = z
  ...
  .register(hl7v2Metadata, {
    title: 'XCN',
    version: '2.6',
    description: 'HL7 v2.6 XCN composite data type',
  });
