...
/**
 * HL7 v2.6 XON Composite Data Type
 *
 * HL7 v2.6 XON composite data type
 ...
 */
export const XON_4 = SimpleTypes.NM.max(4).optional().register(hl7v2Metadata, {
  title: 'XON.4',
  version: '2.6',
...
/**
 * XON - HL7 v2.6 XON composite data type
 *
 * Components:
...
export const XON = z
  ...
  .register(hl7v2Metadata, {
    title: 'XON',
    version: '2.6',
    description: 'HL7 v2.6 XON composite data type',
  });
