...
/**
 * HL7 v2.6 XPN Composite Data Type
 *
 * HL7 v2.6 XPN composite data type
 ...
 */
export const XPN_12 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  title: 'XPN.12',
  version: '2.6',
 ...
 */
export const XPN_13 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  title: 'XPN.13',
  version: '2.6',
...
/**
 * XPN - HL7 v2.6 XPN composite data type
 *
 * Components:
...
export const XPN = z
  ...
  .register(hl7v2Metadata, {
    title: 'XPN',
    version: '2.6',
    description: 'HL7 v2.6 XPN composite data type',
  });
