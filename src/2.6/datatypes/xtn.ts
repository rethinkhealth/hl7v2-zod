...
/**
 * HL7 v2.6 XTN Composite Data Type
 *
 * HL7 v2.6 XTN composite data type
 ...
 */
export const XTN_13 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  title: "XTN.13",
  version: "2.6",
 ...
 */
export const XTN_14 = SimpleTypes.DTM.max(24).optional().register(hl7v2Metadata, {
  title: "XTN.14",
  version: "2.6",
 ...
 */
export const XTN_18 = SimpleTypes.NM.max(2).optional().register(hl7v2Metadata, {
  title: "XTN.18",
  version: "2.6",
...
/**
 * XTN - HL7 v2.6 XTN composite data type
 *
 * Components:
...
export const XTN = z
  ...
  .register(hl7v2Metadata, {
    title: "XTN",
    version: "2.6",
    description: "HL7 v2.6 XTN composite data type"
  });
