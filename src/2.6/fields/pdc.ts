 ...
 * HL7 v2.6 PDC Fields
 *
 * HL7 v2.6 PDC field definitions
 ...
 * PDC.2 - Country
 */
export const PDC_2 = datatypes.CWE.register(hl7v2Metadata, {
  title: "PDC.2",
  version: "2.6",
  description: "Country",
  type: "Field",
 ...
 * PDC.5 - Generic Name
 */
export const PDC_5 = datatypes.CWE.register(hl7v2Metadata, {
  title: "PDC.5",
  version: "2.6",
 ...
 * PDC.9 - Product Code
 */
export const PDC_9 = datatypes.CWE.register(hl7v2Metadata, {
  title: "PDC.9",
  version: "2.6",
 ...
 */
export const PDC_14 = datatypes.DTM.register(hl7v2Metadata, {
  title: "PDC.14",
  version: "2.6",
 ...
 */
export const PDC_15 = datatypes.DTM.register(hl7v2Metadata, {
  title: "PDC.15",
  version: "2.6",
