...
/**
 * HL7 v2.6 ADT_A05 Message
 *
 * HL7 v2.6 ADT_A05 message definition
...
export const adtA05ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ADT_A05.PROCEDURE group",
    type: "Group"
  });
...
export const adtA05InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ADT_A05.INSURANCE group",
    type: "Group"
  });
...
export const adt_a05Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ADT_A05",
    version: "2.6",
    description: "HL7 v2.6 ADT_A05 message",
    type: "Message"
  });
