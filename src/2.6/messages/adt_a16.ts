...
/**
 * HL7 v2.6 ADT_A16 Message
 *
 * HL7 v2.6 ADT_A16 message definition
...
export const adtA16ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ADT_A16.PROCEDURE group",
    type: "Group"
  });
...
export const adtA16InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ADT_A16.INSURANCE group",
    type: "Group"
  });
...
export const adt_a16Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ADT_A16",
    version: "2.6",
    description: "HL7 v2.6 ADT_A16 message",
    type: "Message"
  });
