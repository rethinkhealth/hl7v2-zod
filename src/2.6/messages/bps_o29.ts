...
/**
 * HL7 v2.6 BPS_O29 Message
 * 
 * HL7 v2.6 BPS_O29 message definition
...
export const bpsO29PatientVisitSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 BPS_O29.PATIENT_VISIT group",
  type: "Group"
});
...
export const bpsO29TimingSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 BPS_O29.TIMING group",
  type: "Group"
});
...
export const bpsO29ProductSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 BPS_O29.PRODUCT group",
  type: "Group"
});
...
export const bpsO29PatientSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 BPS_O29.PATIENT group",
  type: "Group"
});
...
export const bpsO29OrderSchema = z.object({
  ...
  title: "BPS_O29.ORDER",
  version: "2.6",
  description: "HL7 v2.6 BPS_O29.ORDER group",
  type: "Group"
});
...
export const bps_o29Schema = z.object({
  ...
  title: "BPS_O29",
  version: "2.6",
  description: "HL7 v2.6 BPS_O29 message",
  type: "Message"
});
