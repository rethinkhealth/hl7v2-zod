...
/**
 * HL7 v2.6 BTS_O31 Message
 * 
 * HL7 v2.6 BTS_O31 message definition
 ...
 */
export const btsO31PatientVisitSchema = z.object({
  "PV1": segments.pv1Schema,
  "PV2": segments.pv2Schema.optional()
}).register(hl7v2Metadata, {
  title: "BTS_O31.PATIENT_VISIT",
  version: "2.6",
  description: "HL7 v2.6 BTS_O31.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const btsO31TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "BTS_O31.TIMING",
  version: "2.6",
  description: "HL7 v2.6 BTS_O31.TIMING group",
  type: "Group"
});
 ...
 */
export const btsO31ProductStatusSchema = z.object({
  "BTX": segments.btxSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "BTS_O31.PRODUCT_STATUS",
  version: "2.6",
  description: "HL7 v2.6 BTS_O31.PRODUCT_STATUS group",
  type: "Group"
});
 ...
 */
export const btsO31PatientSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 BTS_O31.PATIENT group",
  type: "Group"
});
 ...
 */
export const btsO31OrderSchema = z.object({
  ...
  title: "BTS_O31.ORDER",
  version: "2.6",
  description: "HL7 v2.6 BTS_O31.ORDER group",
  type: "Group"
});
 ...
 */
export const bts_o31Schema = z.object({
  ...
  title: "BTS_O31",
  version: "2.6",
  description: "HL7 v2.6 BTS_O31 message",
  type: "Message"
});
