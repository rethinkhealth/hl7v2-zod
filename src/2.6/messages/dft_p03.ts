...
/**
 * HL7 v2.6 DFT_P03 Message
 * 
 * HL7 v2.6 DFT_P03 message definition
...
export const dftP03VisitSchema = z.object({
  ...
  title: "DFT_P03.VISIT",
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.VISIT group",
  type: "Group"
});
...
export const dftP03TimingQuantitySchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.TIMING_QUANTITY group",
  type: "Group"
});
...
export const dftP03OrderSchema = z.object({
  ...
  title: "DFT_P03.ORDER",
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.ORDER group",
  type: "Group"
});
...
export const dftP03ObservationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.OBSERVATION group",
  type: "Group"
});
...
export const dftP03FinancialProcedureSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.FINANCIAL_PROCEDURE group",
  type: "Group"
});
...
export const dftP03FinancialTimingQuantitySchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.FINANCIAL_TIMING_QUANTITY group",
  type: "Group"
});
...
export const dftP03FinancialOrderSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.FINANCIAL_ORDER group",
  type: "Group"
});
...
export const dftP03FinancialObservationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.FINANCIAL_OBSERVATION group",
  type: "Group"
});
...
export const dftP03InsuranceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.INSURANCE group",
  type: "Group"
});
...
export const dftP03CommonOrderSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.COMMON_ORDER group",
  type: "Group"
});
...
export const dftP03FinancialCommonOrderSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.FINANCIAL_COMMON_ORDER group",
  type: "Group"
});
...
export const dftP03FinancialSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 DFT_P03.FINANCIAL group",
  type: "Group"
});
...
export const dft_p03Schema = z.object({
  "MSH": z.array(segments.mshSchema),
  ...
  title: "DFT_P03",
  version: "2.6",
  description: "HL7 v2.6 DFT_P03 message",
  type: "Message"
});
