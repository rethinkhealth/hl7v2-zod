...
/**
 * HL7 v2.6 EAC_U07 Message
 *
 * HL7 v2.6 EAC_U07 message definition
...
export const eacU07SpecimenContainerSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 EAC_U07.SPECIMEN_CONTAINER group",
    type: "Group"
  });
...
export const eacU07CommandSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 EAC_U07.COMMAND group",
    type: "Group"
  });
...
export const eac_u07Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "EAC_U07",
    version: "2.6",
    description: "HL7 v2.6 EAC_U07 message",
    type: "Message"
  });
