...
/**
 * HL7 v2.6 EHC_E01 Message
 * 
 * HL7 v2.6 EHC_E01 message definition
...
export const ehcE01InsuranceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.INSURANCE group",
  type: "Group"
});
...
export const ehcE01DiagnosisSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.DIAGNOSIS group",
  type: "Group"
});
...
export const ehcE01ProductServiceLineItemSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.PRODUCT_SERVICE_LINE_ITEM group",
  type: "Group"
});
...
export const ehcE01ProcedureSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.PROCEDURE group",
  type: "Group"
});
 ...
 */
export const ehcE01InvoiceProcessingSchema = z.object({
  "IPR": segments.iprSchema
}).register(hl7v2Metadata, {
  title: "EHC_E01.INVOICE_PROCESSING",
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.INVOICE_PROCESSING group",
  type: "Group"
});
...
export const ehcE01PatientInfoSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.PATIENT_INFO group",
  type: "Group"
});
...
export const ehcE01ProductServiceGroupSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
...
export const ehcE01ProductServiceSectionSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.PRODUCT_SERVICE_SECTION group",
  type: "Group"
});
 ...
 */
export const ehcE01InvoiceInformationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E01.INVOICE_INFORMATION group",
  type: "Group"
});
...
export const ehc_e01Schema = z.object({
  ...
  title: "EHC_E01",
  version: "2.6",
  description: "HL7 v2.6 EHC_E01 message",
  type: "Message"
});
