...
/**
 * HL7 v2.6 EHC_E02 Message
 *
 * HL7 v2.6 EHC_E02 message definition
...
export const ehcE02PsgSchema = z
  ...
  .register(hl7v2Metadata, {
    title: 'EHC_E02.PSG',
    version: '2.6',
    description: 'HL7 v2.6 EHC_E02.PSG group',
    type: 'Group',
  });
...
export const ehcE02ProductServiceSectionSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 EHC_E02.PRODUCT_SERVICE_SECTION group',
    type: 'Group',
  });
...
export const ehcE02InvoiceInformationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 EHC_E02.INVOICE_INFORMATION group',
    type: 'Group',
  });
...
export const ehc_e02Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'EHC_E02',
    version: '2.6',
    description: 'HL7 v2.6 EHC_E02 message',
    type: 'Message',
  });
