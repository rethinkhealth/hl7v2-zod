...
/**
 * HL7 v2.6 EHC_E21 Message
 * 
 * HL7 v2.6 EHC_E21 message definition
 ...
 */
export const ehcE21PslItemInfoSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 EHC_E21.PSL_ITEM_INFO group",
  type: "Group"
});
 ...
 */
export const ehcE21AuthorizationRequestSchema = z.object({
  "IVC": segments.ivcSchema,
  "PSL_ITEM_INFO": z.array(ehcE21PslItemInfoSchema)
}).register(hl7v2Metadata, {
  title: "EHC_E21.AUTHORIZATION_REQUEST",
  version: "2.6",
  description: "HL7 v2.6 EHC_E21.AUTHORIZATION_REQUEST group",
  type: "Group"
});
 ...
 */
export const ehc_e21Schema = z.object({
  ...
  title: "EHC_E21",
  version: "2.6",
  description: "HL7 v2.6 EHC_E21 message",
  type: "Message"
});
