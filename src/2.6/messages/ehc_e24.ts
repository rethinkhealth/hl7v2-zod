...
/**
 * HL7 v2.6 EHC_E24 Message
 *
 * HL7 v2.6 EHC_E24 message definition
...
/**
 * EHC_E24.PAYER_ADJUSTMENT group schema
 * Defines the structure and validation rules for the EHC_E24.PAYER_ADJUSTMENT group
 */
export const ehcE24PayerAdjustmentSchema = z
  .object({
    ADJ: segments.adjSchema
  })
  .register(hl7v2Metadata, {
    title: "EHC_E24.PAYER_ADJUSTMENT",
    version: "2.6",
    description: "HL7 v2.6 EHC_E24.PAYER_ADJUSTMENT group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the EHC_E24.PAYER_ADJUSTMENT schema
 */
export type EHC_E24_PAYER_ADJUSTMENT = z.infer<typeof ehcE24PayerAdjustmentSchema>;

/**
 * EHC_E24.PSL_ITEM_INFO group schema
 * Defines the structure and validation rules for the EHC_E24.PSL_ITEM_INFO group
 */
export const ehcE24PslItemInfoSchema = z
  .object({
    PSL: segments.pslSchema,
    AUT: segments.autSchema.optional(),
    PAYER_ADJUSTMENT: z.array(ehcE24PayerAdjustmentSchema).optional()
  })
  .register(hl7v2Metadata, {
    title: "EHC_E24.PSL_ITEM_INFO",
    version: "2.6",
    description: "HL7 v2.6 EHC_E24.PSL_ITEM_INFO group",
    type: "Group"
  });
 ...
 */
export const ehcE24AuthorizationResponseInfoSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 EHC_E24.AUTHORIZATION_RESPONSE_INFO group",
    type: "Group"
  });
 ...
 */
export type EHC_E24_AUTHORIZATION_RESPONSE_INFO = z.infer<
  typeof ehcE24AuthorizationResponseInfoSchema
>;
...
export const ehc_e24Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E24",
    version: "2.6",
    description: "HL7 v2.6 EHC_E24 message",
    type: "Message"
  });
