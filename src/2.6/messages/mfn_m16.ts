...
/**
 * HL7 v2.6 MFN_M16 Message
 *
 * HL7 v2.6 MFN_M16 message definition
...
export const mfnM16SterilizationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 MFN_M16.STERILIZATION group',
    type: 'Group',
  });
...
export const mfnM16PackagingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 MFN_M16.PACKAGING group',
    type: 'Group',
  });
...
export const mfnM16MaterialLocationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 MFN_M16.MATERIAL_LOCATION group',
    type: 'Group',
  });
...
export const mfnM16PurchasingVendorSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 MFN_M16.PURCHASING_VENDOR group',
    type: 'Group',
  });
...
export const mfnM16MaterialItemRecordSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 MFN_M16.MATERIAL_ITEM_RECORD group',
    type: 'Group',
  });
...
export const mfn_m16Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'MFN_M16',
    version: '2.6',
    description: 'HL7 v2.6 MFN_M16 message',
    type: 'Message',
  });
