...
/**
 * HL7 v2.6 MFR_M01 Message
 * 
 * HL7 v2.6 MFR_M01 message definition
 ...
 */
export const mfrM01MfQuerySchema = z.object({
  "MFE": segments.mfeSchema
}).register(hl7v2Metadata, {
  title: "MFR_M01.MF_QUERY",
  version: "2.6",
  description: "HL7 v2.6 MFR_M01.MF_QUERY group",
  type: "Group"
});
 ...
 */
export const mfr_m01Schema = z.object({
  ...
  title: "MFR_M01",
  version: "2.6",
  description: "HL7 v2.6 MFR_M01 message",
  type: "Message"
});
