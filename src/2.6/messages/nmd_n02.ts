...
/**
 * HL7 v2.6 NMD_N02 Message
 *
 * HL7 v2.6 NMD_N02 message definition
 ...
 */
export const nmdN02ClockSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "NMD_N02.CLOCK",
    version: "2.6",
    description: "HL7 v2.6 NMD_N02.CLOCK group",
    type: "Group"
  });
 ...
 */
export const nmdN02AppStatsSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 NMD_N02.APP_STATS group",
    type: "Group"
  });
 ...
 */
export const nmdN02AppStatusSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 NMD_N02.APP_STATUS group",
    type: "Group"
  });
 ...
 */
export const nmdN02ClockAndStatsWithNotesSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 NMD_N02.CLOCK_AND_STATS_WITH_NOTES group",
    type: "Group"
  });
...
export const nmd_n02Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "NMD_N02",
    version: "2.6",
    description: "HL7 v2.6 NMD_N02 message",
    type: "Message"
  });
