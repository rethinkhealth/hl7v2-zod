...
/**
 * HL7 v2.6 OMI_O23 Message
 * 
 * HL7 v2.6 OMI_O23 message definition
...
export const omiO23PatientVisitSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 OMI_O23.PATIENT_VISIT group",
  type: "Group"
});
...
export const omiO23InsuranceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 OMI_O23.INSURANCE group",
  type: "Group"
});
...
export const omiO23TimingSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 OMI_O23.TIMING group",
  type: "Group"
});
...
export const omiO23ObservationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 OMI_O23.OBSERVATION group",
  type: "Group"
});
...
export const omiO23PatientSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 OMI_O23.PATIENT group",
  type: "Group"
});
...
export const omiO23OrderSchema = z.object({
  ...
  title: "OMI_O23.ORDER",
  version: "2.6",
  description: "HL7 v2.6 OMI_O23.ORDER group",
  type: "Group"
});
...
export const omi_o23Schema = z.object({
  ...
  title: "OMI_O23",
  version: "2.6",
  description: "HL7 v2.6 OMI_O23 message",
  type: "Message"
});
