...
/**
 * HL7 v2.6 OPL_O37 Message
 *
 * HL7 v2.6 OPL_O37 message definition
...
export const oplO37GuarantorSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.GUARANTOR group',
    type: 'Group',
  });
...
export const oplO37InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.INSURANCE group',
    type: 'Group',
  });
...
export const oplO37ContainerSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.CONTAINER group',
    type: 'Group',
  });
...
export const oplO37TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.TIMING group',
    type: 'Group',
  });
...
export const oplO37PatientPriorSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.PATIENT_PRIOR group',
    type: 'Group',
  });
...
export const oplO37PatientVisitPriorSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.PATIENT_VISIT_PRIOR group',
    type: 'Group',
  });
...
export const oplO37PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.PATIENT group',
    type: 'Group',
  });
...
export const oplO37ObservationRequestSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.OBSERVATION_REQUEST group',
    type: 'Group',
  });
...
export const oplO37OrderPriorSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.ORDER_PRIOR group',
    type: 'Group',
  });
...
export const oplO37SpecimenSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.SPECIMEN group',
    type: 'Group',
  });
...
export const oplO37PriorResultSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.PRIOR_RESULT group',
    type: 'Group',
  });
...
export const oplO37OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: 'OPL_O37.ORDER',
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37.ORDER group',
    type: 'Group',
  });
...
export const opl_o37Schema = z
  .object({
    ...
    NTE: z.array(segments.nteSchema).optional(),
    ROL: z.array(segments.rolSchema),
  ...
  .register(hl7v2Metadata, {
    title: 'OPL_O37',
    version: '2.6',
    description: 'HL7 v2.6 OPL_O37 message',
    type: 'Message',
  });
