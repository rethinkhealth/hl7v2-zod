...
/**
 * HL7 v2.6 ORD_O04 Message
 *
 * HL7 v2.6 ORD_O04 message definition
...
export const ordO04PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORD_O04.PATIENT group",
    type: "Group"
  });
...
export const ordO04TimingDietSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORD_O04.TIMING_DIET group",
    type: "Group"
  });
...
export const ordO04TimingTraySchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORD_O04.TIMING_TRAY group",
    type: "Group"
  });
...
export const ordO04OrderDietSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORD_O04.ORDER_DIET group",
    type: "Group"
  });
...
export const ordO04OrderTraySchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORD_O04.ORDER_TRAY group",
    type: "Group"
  });
...
export const ordO04ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORD_O04.RESPONSE group",
    type: "Group"
  });
...
export const ord_o04Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORD_O04",
    version: "2.6",
    description: "HL7 v2.6 ORD_O04 message",
    type: "Message"
  });
