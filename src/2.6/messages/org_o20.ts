...
/**
 * HL7 v2.6 ORG_O20 Message
 *
 * HL7 v2.6 ORG_O20 message definition
 ...
 */
export const orgO20PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20.PATIENT group',
    type: 'Group',
  });
 ...
 */
export const orgO20TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20.TIMING group',
    type: 'Group',
  });
 ...
 */
export const orgO20ObservationGroupSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20.OBSERVATION_GROUP group',
    type: 'Group',
  });
 ...
 */
export const orgO20SpecimenSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20.SPECIMEN group',
    type: 'Group',
  });
 ...
 */
export const orgO20OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: 'ORG_O20.ORDER',
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20.ORDER group',
    type: 'Group',
  });
 ...
 */
export const orgO20ResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20.RESPONSE group',
    type: 'Group',
  });
...
export const org_o20Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'ORG_O20',
    version: '2.6',
    description: 'HL7 v2.6 ORG_O20 message',
    type: 'Message',
  });
