...
/**
 * HL7 v2.6 ORN_O08 Message
 *
 * HL7 v2.6 ORN_O08 message definition
 ...
 */
export const ornO08PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORN_O08.PATIENT group",
    type: "Group"
  });
 ...
 */
export const ornO08TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORN_O08.TIMING group",
    type: "Group"
  });
 ...
 */
export const ornO08OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "ORN_O08.ORDER",
    version: "2.6",
    description: "HL7 v2.6 ORN_O08.ORDER group",
    type: "Group"
  });
 ...
 */
export const ornO08ResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORN_O08.RESPONSE group",
    type: "Group"
  });
...
export const orn_o08Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORN_O08",
    version: "2.6",
    description: "HL7 v2.6 ORN_O08 message",
    type: "Message"
  });
