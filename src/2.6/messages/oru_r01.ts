...
/**
 * HL7 v2.6 ORU_R01 Message
 *
 * HL7 v2.6 ORU_R01 message definition
...
export const oruR01VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORU_R01.VISIT",
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.VISIT group",
    type: "Group"
  });
...
export const oruR01TimingQtySchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.TIMING_QTY group",
    type: "Group"
  });
...
export const oruR01ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.OBSERVATION group",
    type: "Group"
  });
...
export const oruR01SpecimenSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.SPECIMEN group",
    type: "Group"
  });
...
export const oruR01PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.PATIENT group",
    type: "Group"
  });
...
export const oruR01OrderObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.ORDER_OBSERVATION group",
    type: "Group"
  });
...
export const oruR01PatientResultSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 ORU_R01.PATIENT_RESULT group",
    type: "Group"
  });
...
export const oru_r01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORU_R01",
    version: "2.6",
    description: "HL7 v2.6 ORU_R01 message",
    type: "Message"
  });
