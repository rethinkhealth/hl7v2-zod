...
/**
 * HL7 v2.6 QBP_E22 Message
 *
 * HL7 v2.6 QBP_E22 message definition
 ...
 */
export const qbpE22QuerySchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: 'QBP_E22.QUERY',
    version: '2.6',
    description: 'HL7 v2.6 QBP_E22.QUERY group',
    type: 'Group',
  });
...
export const qbp_e22Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'QBP_E22',
    version: '2.6',
    description: 'HL7 v2.6 QBP_E22 message',
    type: 'Message',
  });
