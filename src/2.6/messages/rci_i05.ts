...
/**
 * HL7 v2.6 RCI_I05 Message
 * 
 * HL7 v2.6 RCI_I05 message definition
...
export const rciI05ProviderSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RCI_I05.PROVIDER group",
  type: "Group"
});
...
export const rciI05ResultsSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RCI_I05.RESULTS group",
  type: "Group"
});
...
export const rciI05ObservationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RCI_I05.OBSERVATION group",
  type: "Group"
});
...
export const rci_i05Schema = z.object({
  ...
  title: "RCI_I05",
  version: "2.6",
  description: "HL7 v2.6 RCI_I05 message",
  type: "Message"
});
