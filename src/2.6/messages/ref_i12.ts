...
/**
 * HL7 v2.6 REF_I12 Message
 *
 * HL7 v2.6 REF_I12 message definition
...
export const refI12AuthorizationContactSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.AUTHORIZATION_CONTACT group",
    type: "Group"
  });
...
export const refI12ProviderContactSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.PROVIDER_CONTACT group",
    type: "Group"
  });
...
export const refI12InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.INSURANCE group",
    type: "Group"
  });
...
export const refI12ResultsNotesSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.RESULTS_NOTES group",
    type: "Group"
  });
...
export const refI12PatientVisitSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.PATIENT_VISIT group",
    type: "Group"
  });
...
export const refI12ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.PROCEDURE group",
    type: "Group"
  });
...
export const refI12ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 REF_I12.OBSERVATION group",
    type: "Group"
  });
...
export const ref_i12Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "REF_I12",
    version: "2.6",
    description: "HL7 v2.6 REF_I12 message",
    type: "Message"
  });
