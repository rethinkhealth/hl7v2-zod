...
/**
 * HL7 v2.6 RRD_O14 Message
 *
 * HL7 v2.6 RRD_O14 message definition
 ...
 */
export const rrdO14PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RRD_O14.PATIENT group",
    type: "Group"
  });
 ...
 */
export const rrdO14TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RRD_O14.TIMING group",
    type: "Group"
  });
 ...
 */
export const rrdO14DispenseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RRD_O14.DISPENSE group",
    type: "Group"
  });
 ...
 */
export const rrdO14OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "RRD_O14.ORDER",
    version: "2.6",
    description: "HL7 v2.6 RRD_O14.ORDER group",
    type: "Group"
  });
 ...
 */
export const rrdO14ResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RRD_O14.RESPONSE group",
    type: "Group"
  });
...
export const rrd_o14Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RRD_O14",
    version: "2.6",
    description: "HL7 v2.6 RRD_O14 message",
    type: "Message"
  });
