...
/**
 * HL7 v2.6 RRE_O12 Message
 * 
 * HL7 v2.6 RRE_O12 message definition
 ...
 */
export const rreO12PatientSchema = z.object({
  "PID": segments.pidSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RRE_O12.PATIENT",
  version: "2.6",
  description: "HL7 v2.6 RRE_O12.PATIENT group",
  type: "Group"
});
 ...
 */
export const rreO12TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RRE_O12.TIMING",
  version: "2.6",
  description: "HL7 v2.6 RRE_O12.TIMING group",
  type: "Group"
});
 ...
 */
export const rreO12TimingEncodedSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RRE_O12.TIMING_ENCODED",
  version: "2.6",
  description: "HL7 v2.6 RRE_O12.TIMING_ENCODED group",
  type: "Group"
});
 ...
 */
export const rreO12EncodingSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RRE_O12.ENCODING group",
  type: "Group"
});
 ...
 */
export const rreO12OrderSchema = z.object({
  ...
  title: "RRE_O12.ORDER",
  version: "2.6",
  description: "HL7 v2.6 RRE_O12.ORDER group",
  type: "Group"
});
 ...
 */
export const rre_o12Schema = z.object({
  ...
  title: "RRE_O12",
  version: "2.6",
  description: "HL7 v2.6 RRE_O12 message",
  type: "Message"
});
