...
/**
 * HL7 v2.6 RSP_K22 Message
 *
 * HL7 v2.6 RSP_K22 message definition
 ...
 */
export const rspK22QueryResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 RSP_K22.QUERY_RESPONSE group',
    type: 'Group',
  });
...
export const rsp_k22Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'RSP_K22',
    version: '2.6',
    description: 'HL7 v2.6 RSP_K22 message',
    type: 'Message',
  });
