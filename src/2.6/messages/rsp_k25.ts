...
/**
 * HL7 v2.6 RSP_K25 Message
 *
 * HL7 v2.6 RSP_K25 message definition
 ...
 */
export const rspK25StaffSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: 'RSP_K25.STAFF',
    version: '2.6',
    description: 'HL7 v2.6 RSP_K25.STAFF group',
    type: 'Group',
  });
...
export const rsp_k25Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'RSP_K25',
    version: '2.6',
    description: 'HL7 v2.6 RSP_K25 message',
    type: 'Message',
  });
