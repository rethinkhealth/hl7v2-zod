...
/**
 * HL7 v2.6 RSP_Z86 Message
 * 
 * HL7 v2.6 RSP_Z86 message definition
...
export const rspZ86PatientSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.PATIENT group",
  type: "Group"
});
...
export const rspZ86TimingSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.TIMING group",
  type: "Group"
});
...
export const rspZ86OrderDetailSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.ORDER_DETAIL group",
  type: "Group"
});
...
export const rspZ86TimingEncodedSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.TIMING_ENCODED group",
  type: "Group"
});
...
export const rspZ86DispenseSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.DISPENSE group",
  type: "Group"
});
...
export const rspZ86GiveSchema = z.object({
  ...
  title: "RSP_Z86.GIVE",
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.GIVE group",
  type: "Group"
});
...
export const rspZ86AdministrationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.ADMINISTRATION group",
  type: "Group"
});
...
export const rspZ86ObservationSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.OBSERVATION group",
  type: "Group"
});
...
export const rspZ86EncodedOrderSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.ENCODED_ORDER group",
  type: "Group"
});
...
export const rspZ86CommonOrderSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.COMMON_ORDER group",
  type: "Group"
});
...
export const rspZ86QueryResponseSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86.QUERY_RESPONSE group",
  type: "Group"
});
...
export const rsp_z86Schema = z.object({
  ...
  title: "RSP_Z86",
  version: "2.6",
  description: "HL7 v2.6 RSP_Z86 message",
  type: "Message"
});
