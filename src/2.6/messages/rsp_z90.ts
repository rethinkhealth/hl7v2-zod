...
/**
 * HL7 v2.6 RSP_Z90 Message
 *
 * HL7 v2.6 RSP_Z90 message definition
 ...
 */
export const rspZ90VisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "RSP_Z90.VISIT",
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.VISIT group",
    type: "Group"
  });
 ...
 */
export const rspZ90TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.TIMING group",
    type: "Group"
  });
 ...
 */
export const rspZ90ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const rspZ90SpecimenSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.SPECIMEN group",
    type: "Group"
  });
 ...
 */
export const rspZ90PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.PATIENT group",
    type: "Group"
  });
 ...
 */
export const rspZ90CommonOrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.COMMON_ORDER group",
    type: "Group"
  });
 ...
 */
export const rspZ90QueryResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90.QUERY_RESPONSE group",
    type: "Group"
  });
...
export const rsp_z90Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_Z90",
    version: "2.6",
    description: "HL7 v2.6 RSP_Z90 message",
    type: "Message"
  });
