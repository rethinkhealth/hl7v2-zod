...
/**
 * HL7 v2.6 SIU_S12 Message
 * 
 * HL7 v2.6 SIU_S12 message definition
...
export const siuS12PatientSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 SIU_S12.PATIENT group",
  type: "Group"
});
...
export const siuS12ServiceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 SIU_S12.SERVICE group",
  type: "Group"
});
...
export const siuS12GeneralResourceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 SIU_S12.GENERAL_RESOURCE group",
  type: "Group"
});
...
export const siuS12LocationResourceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 SIU_S12.LOCATION_RESOURCE group",
  type: "Group"
});
...
export const siuS12PersonnelResourceSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 SIU_S12.PERSONNEL_RESOURCE group",
  type: "Group"
});
...
export const siuS12ResourcesSchema = z.object({
  ...
  version: "2.6",
  description: "HL7 v2.6 SIU_S12.RESOURCES group",
  type: "Group"
});
...
export const siu_s12Schema = z.object({
  ...
  title: "SIU_S12",
  version: "2.6",
  description: "HL7 v2.6 SIU_S12 message",
  type: "Message"
});
