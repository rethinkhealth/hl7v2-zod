...
/**
 * HL7 v2.6 SSR_U04 Message
 *
 * HL7 v2.6 SSR_U04 message definition
 ...
 */
export const ssrU04SpecimenContainerSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: '2.6',
    description: 'HL7 v2.6 SSR_U04.SPECIMEN_CONTAINER group',
    type: 'Group',
  });
...
export const ssr_u04Schema = z
  ...
  .register(hl7v2Metadata, {
    title: 'SSR_U04',
    version: '2.6',
    description: 'HL7 v2.6 SSR_U04 message',
    type: 'Message',
  });
