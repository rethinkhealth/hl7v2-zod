...
/**
 * HL7 v2.6 SUR_P09 Message
 *
 * HL7 v2.6 SUR_P09 message definition
 ...
 */
export const surP09ProductSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 SUR_P09.PRODUCT group",
    type: "Group"
  });
 ...
 */
export const surP09FacilityDetailSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 SUR_P09.FACILITY_DETAIL group",
    type: "Group"
  });
 ...
 */
export const surP09FacilitySchema = z
  .object({
    FAC: segments.facSchema,
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 SUR_P09.FACILITY group",
    type: "Group"
  });
...
export const sur_p09Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "SUR_P09",
    version: "2.6",
    description: "HL7 v2.6 SUR_P09 message",
    type: "Message"
  });
