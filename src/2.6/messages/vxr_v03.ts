...
/**
 * HL7 v2.6 VXR_V03 Message
 *
 * HL7 v2.6 VXR_V03 message definition
 ...
 */
export const vxrV03PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 VXR_V03.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const vxrV03InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 VXR_V03.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const vxrV03TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 VXR_V03.TIMING group",
    type: "Group"
  });
 ...
 */
export const vxrV03ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.6",
    description: "HL7 v2.6 VXR_V03.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const vxrV03OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "VXR_V03.ORDER",
    version: "2.6",
    description: "HL7 v2.6 VXR_V03.ORDER group",
    type: "Group"
  });
...
export const vxr_v03Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "VXR_V03",
    version: "2.6",
    description: "HL7 v2.6 VXR_V03 message",
    type: "Message"
  });
