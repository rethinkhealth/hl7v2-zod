...
/**
 * HL7 v2.7 ERL Composite Data Type
 * 
 * HL7 v2.7 ERL composite data type
 ...
 */
export const ERL_2 = SimpleTypes.NM.register(hl7v2Metadata, {
  "title": "ERL.2",
  "version": "2.7",
 ...
 */
export const ERL_3 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "ERL.3",
  "version": "2.7",
 ...
 */
export const ERL_4 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "ERL.4",
  "version": "2.7",
 ...
 */
export const ERL_5 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "ERL.5",
  "version": "2.7",
 ...
 */
export const ERL_6 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "ERL.6",
  "version": "2.7",
...
/**
 * ERL - HL7 v2.7 ERL composite data type
 * 
 * Components:
 * - ERL.1: Segment ID (ST)
...
export const ERL = z.object({
  ...
  title: 'ERL',
  version: '2.7',
  description: 'HL7 v2.7 ERL composite data type'
});
