 ...
 * HL7 v2.7 UB2 Fields
 * 
 * HL7 v2.7 UB2 field definitions
...
/**
 * UB2.10 - Uniform Billing 11 (State)
 */
export const UB2_10 = datatypes.ST.register(hl7v2Metadata, {
  "title": "UB2.10",
  "version": "2.7",
  "description": "Uniform Billing 11 (State)",
  "type": "Field",
  "item": 562,
  "table": "",
  "longName": "HL7Uniform Billing 11 (State)",
  "length": 12
});

/**
 * UB2.11 - Uniform Billing 31 (National)
 */
export const UB2_11 = datatypes.ST.register(hl7v2Metadata, {
  "title": "UB2.11",
  "version": "2.7",
  "description": "Uniform Billing 31 (National)",
  "type": "Field",
  "item": 563,
  "table": "",
  "longName": "HL7Uniform Billing 31 (National)",
  "length": 5
});
...
/**
 * UB2.13 - Uniform Billing 49 (National)
 */
export const UB2_13 = datatypes.ST.register(hl7v2Metadata, {
  "title": "UB2.13",
  "version": "2.7",
  "description": "Uniform Billing 49 (National)",
  "type": "Field",
  "item": 565,
  "table": "",
  "longName": "HL7Uniform Billing 49 (National)",
  "length": 4
});

/**
 * UB2.14 - Uniform Billing 56 (State)
 */
export const UB2_14 = datatypes.ST.register(hl7v2Metadata, {
  "title": "UB2.14",
  "version": "2.7",
  "description": "Uniform Billing 56 (State)",
  "type": "Field",
  "item": 566,
  "table": "",
  "longName": "HL7Uniform Billing 56 (State)",
  "length": 14
});

/**
 * UB2.15 - Uniform Billing 57 (National)
 */
export const UB2_15 = datatypes.ST.register(hl7v2Metadata, {
  "title": "UB2.15",
  "version": "2.7",
  "description": "Uniform Billing 57 (National)",
  "type": "Field",
  "item": 567,
  "table": "",
  "longName": "HL7Uniform Billing 57 (National)",
  "length": 27
});

/**
 * UB2.16 - Uniform Billing 78 (State)
 */
export const UB2_16 = datatypes.ST.register(hl7v2Metadata, {
  "title": "UB2.16",
  "version": "2.7",
  "description": "Uniform Billing 78 (State)",
  "type": "Field",
  "item": 568,
  "table": "",
  "longName": "HL7Uniform Billing 78 (State)",
  "length": 2
});
