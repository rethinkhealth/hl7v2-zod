...
/**
 * HL7 v2.7 ADT_A01 Message
 *
 * HL7 v2.7 ADT_A01 message definition
...
export const adtA01ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ADT_A01.PROCEDURE group",
    type: "Group"
  });
...
export const adtA01InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ADT_A01.INSURANCE group",
    type: "Group"
  });
...
export const adt_a01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ADT_A01",
    version: "2.7",
    description: "HL7 v2.7 ADT_A01 message",
    type: "Message"
  });
