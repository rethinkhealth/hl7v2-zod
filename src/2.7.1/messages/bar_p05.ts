...
/**
 * HL7 v2.7 BAR_P05 Message
 *
 * HL7 v2.7 BAR_P05 message definition
...
export const barP05ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 BAR_P05.PROCEDURE group",
    type: "Group"
  });
...
export const barP05InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 BAR_P05.INSURANCE group",
    type: "Group"
  });
...
export const barP05VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "BAR_P05.VISIT",
    version: "2.7",
    description: "HL7 v2.7 BAR_P05.VISIT group",
    type: "Group"
  });
...
export const bar_p05Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "BAR_P05",
    version: "2.7",
    description: "HL7 v2.7 BAR_P05 message",
    type: "Message"
  });
