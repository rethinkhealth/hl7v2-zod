...
/**
 * HL7 v2.7 EHC_E02 Message
 *
 * HL7 v2.7 EHC_E02 message definition
 ...
 */
export const ehcE02PsgSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E02.PSG",
    version: "2.7",
    description: "HL7 v2.7 EHC_E02.PSG group",
    type: "Group"
  });
 ...
 */
export const ehcE02ProductServiceSectionSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E02.PRODUCT_SERVICE_SECTION group",
    type: "Group"
  });
...
/**
 * EHC_E02.INVOICE_INFORMATION group schema
 * Defines the structure and validation rules for the EHC_E02.INVOICE_INFORMATION group
 */
export const ehcE02InvoiceInformationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E02.INVOICE_INFORMATION",
    version: "2.7",
    description: "HL7 v2.7 EHC_E02.INVOICE_INFORMATION group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the EHC_E02.INVOICE_INFORMATION schema
 */
export type EHC_E02_INVOICE_INFORMATION = z.infer<typeof ehcE02InvoiceInformationSchema>;

/**
 * EHC_E02 message schema
 * Defines the structure and validation rules for the EHC_E02 message
 */
export const ehc_e02Schema = z
  .object({
    MSH: segments.mshSchema,
    SFT: z.array(segments.sftSchema).optional(),
    UAC: z.array(segments.uacSchema).optional(),
    INVOICE_INFORMATION: ehcE02InvoiceInformationSchema
  })
  .register(hl7v2Metadata, {
    title: "EHC_E02",
    version: "2.7",
    description: "HL7 v2.7 EHC_E02 message",
    type: "Message"
  });
