...
/**
 * HL7 v2.7 EHC_E15 Message
 * 
 * HL7 v2.7 EHC_E15 message definition
...
export const ehcE15PaymentRemittanceHeaderInfoSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E15.PAYMENT_REMITTANCE_HEADER_INFO group",
  type: "Group"
});
...
export const ehcE15PslItemInfoSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E15.PSL_ITEM_INFO group",
  type: "Group"
});
...
export const ehcE15AdjustmentPayeeSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E15.ADJUSTMENT_PAYEE group",
  type: "Group"
});
...
export const ehcE15ProductServiceGroupSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E15.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
...
export const ehcE15ProductServiceSectionSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E15.PRODUCT_SERVICE_SECTION group",
  type: "Group"
});
...
export const ehcE15PaymentRemittanceDetailInfoSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E15.PAYMENT_REMITTANCE_DETAIL_INFO group",
  type: "Group"
});
...
export const ehc_e15Schema = z.object({
  ...
  title: "EHC_E15",
  version: "2.7",
  description: "HL7 v2.7 EHC_E15 message",
  type: "Message"
});
