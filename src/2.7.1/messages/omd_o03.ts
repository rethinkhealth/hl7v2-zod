...
/**
 * HL7 v2.7 OMD_O03 Message
 *
 * HL7 v2.7 OMD_O03 message definition
 ...
 */
export const omdO03PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const omdO03InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const omdO03TimingDietSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.TIMING_DIET group",
    type: "Group"
  });
 ...
 */
export const omdO03ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const omdO03TimingTraySchema = z
  .object({
    TQ1: segments.tq1Schema,
    TQ2: z.array(segments.tq2Schema).optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.TIMING_TRAY group",
    type: "Group"
  });
 ...
 */
export const omdO03PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.PATIENT group",
    type: "Group"
  });
 ...
 */
export const omdO03DietSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "OMD_O03.DIET",
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.DIET group",
    type: "Group"
  });
 ...
 */
export const omdO03OrderTraySchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.ORDER_TRAY group",
    type: "Group"
  });
 ...
 */
export const omdO03OrderDietSchema = z
  .object({
    ORC: segments.orcSchema,
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMD_O03.ORDER_DIET group",
    type: "Group"
  });
...
export const omd_o03Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OMD_O03",
    version: "2.7",
    description: "HL7 v2.7 OMD_O03 message",
    type: "Message"
  });
