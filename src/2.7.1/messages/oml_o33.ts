...
/**
 * HL7 v2.7 OML_O33 Message
 *
 * HL7 v2.7 OML_O33 message definition
 ...
 */
export const omlO33PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const omlO33InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const omlO33SpecimenObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.SPECIMEN_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const omlO33TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.TIMING group",
    type: "Group"
  });
 ...
 */
export const omlO33ObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const omlO33PatientPriorSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.PATIENT_PRIOR group",
    type: "Group"
  });
 ...
 */
export const omlO33PatientVisitPriorSchema = z
  .object({
    PV1: segments.pv1Schema,
    PV2: segments.pv2Schema.optional(),
    PRT: z.array(segments.prtSchema).optional()
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.PATIENT_VISIT_PRIOR group",
    type: "Group"
  });
 ...
 */
export const omlO33TimingPriorSchema = z
  .object({
    TQ1: segments.tq1Schema,
    TQ2: z.array(segments.tq2Schema).optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.TIMING_PRIOR group",
    type: "Group"
  });
 ...
 */
export const omlO33ObservationPriorSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
    NTE: z.array(segments.nteSchema).optional()
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.OBSERVATION_PRIOR group",
    type: "Group"
  });
 ...
 */
export const omlO33PatientSchema = z
  .object({
    PID: segments.pidSchema,
    PD1: segments.pd1Schema.optional(),
    PRT: z.array(segments.prtSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.PATIENT group",
    type: "Group"
  });
 ...
 */
export const omlO33OrderPriorSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.ORDER_PRIOR group",
    type: "Group"
  });
 ...
 */
export const omlO33PriorResultSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.PRIOR_RESULT group",
    type: "Group"
  });
 ...
 */
export const omlO33ObservationRequestSchema = z
  .object({
    OBR: segments.obrSchema,
    TCD: segments.tcdSchema.optional(),
    NTE: z.array(segments.nteSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.OBSERVATION_REQUEST group",
    type: "Group"
  });
 ...
 */
export const omlO33OrderSchema = z
  .object({
    ORC: segments.orcSchema,
    PRT: z.array(segments.prtSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    title: "OML_O33.ORDER",
    version: "2.7",
    description: "HL7 v2.7 OML_O33.ORDER group",
    type: "Group"
  });
 ...
 */
export const omlO33SpecimenSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OML_O33.SPECIMEN group",
    type: "Group"
  });
...
export const oml_o33Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OML_O33",
    version: "2.7",
    description: "HL7 v2.7 OML_O33 message",
    type: "Message"
  });
