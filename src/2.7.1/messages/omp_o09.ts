...
/**
 * HL7 v2.7 OMP_O09 Message
 *
 * HL7 v2.7 OMP_O09 message definition
...
export const ompO09AdditionalDemographicsSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.ADDITIONAL_DEMOGRAPHICS group",
    type: "Group"
  });
...
export const ompO09PatientVisitSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.PATIENT_VISIT group",
    type: "Group"
  });
...
export const ompO09InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.INSURANCE group",
    type: "Group"
  });
...
export const ompO09TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.TIMING group",
    type: "Group"
  });
...
export const ompO09ComponentSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.COMPONENT group",
    type: "Group"
  });
...
export const ompO09ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.OBSERVATION group",
    type: "Group"
  });
...
export const ompO09PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.PATIENT group",
    type: "Group"
  });
...
export const ompO09OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "OMP_O09.ORDER",
    version: "2.7",
    description: "HL7 v2.7 OMP_O09.ORDER group",
    type: "Group"
  });
...
export const omp_o09Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OMP_O09",
    version: "2.7",
    description: "HL7 v2.7 OMP_O09 message",
    type: "Message"
  });
