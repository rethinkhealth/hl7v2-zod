...
/**
 * OPL_O37.OBSERVATION_RESULT group schema
 * Defines the structure and validation rules for the OPL_O37.OBSERVATION_RESULT group
 */
export const oplO37ObservationResultSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    title: "OPL_O37.OBSERVATION_RESULT",
    version: "2.7",
    description: "HL7 v2.7 OPL_O37.OBSERVATION_RESULT group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the OPL_O37.OBSERVATION_RESULT schema
 */
export type OPL_O37_OBSERVATION_RESULT = z.infer<typeof oplO37ObservationResultSchema>;
...
export const oplO37OrderPriorSchema = z
  .object({
    ...
    OBSERVATION_RESULT: z.array(oplO37ObservationResultSchema)
  })
  .register(hl7v2Metadata, {
