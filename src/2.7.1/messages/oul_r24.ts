...
/**
 * HL7 v2.7 OUL_R24 Message
 *
 * HL7 v2.7 OUL_R24 message definition
 ...
 */
export const oulR24PatientObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.PATIENT_OBSERVATION group",
    type: "Group"
  });
...
export const oulR24VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "OUL_R24.VISIT",
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.VISIT group",
    type: "Group"
  });
...
export const oulR24TimingQtySchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.TIMING_QTY group",
    type: "Group"
  });
 ...
 */
export const oulR24SpecimenObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.SPECIMEN_OBSERVATION group",
    type: "Group"
  });
...
export const oulR24ContainerSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.CONTAINER group",
    type: "Group"
  });
...
export const oulR24ResultSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.RESULT group",
    type: "Group"
  });
...
export const oulR24PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.PATIENT group",
    type: "Group"
  });
...
export const oulR24SpecimenSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.SPECIMEN group",
    type: "Group"
  });
...
export const oulR24OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "OUL_R24.ORDER",
    version: "2.7",
    description: "HL7 v2.7 OUL_R24.ORDER group",
    type: "Group"
  });
...
export const oul_r24Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OUL_R24",
    version: "2.7",
    description: "HL7 v2.7 OUL_R24 message",
    type: "Message"
  });
