...
/**
 * HL7 v2.7 QBP_E03 Message
 * 
 * HL7 v2.7 QBP_E03 message definition
 ...
 */
export const qbpE03QueryInformationSchema = z.object({
  "QPD": segments.qpdSchema,
  "RCP": segments.rcpSchema
}).register(hl7v2Metadata, {
  title: "QBP_E03.QUERY_INFORMATION",
  version: "2.7",
  description: "HL7 v2.7 QBP_E03.QUERY_INFORMATION group",
  type: "Group"
});
 ...
 */
export const qbp_e03Schema = z.object({
  ...
  title: "QBP_E03",
  version: "2.7",
  description: "HL7 v2.7 QBP_E03 message",
  type: "Message"
});
