...
/**
 * HL7 v2.7 RCI_I05 Message
 * 
 * HL7 v2.7 RCI_I05 message definition
 ...
 */
export const rciI05ResultsSchema = z.object({
  "OBX": segments.obxSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RCI_I05.RESULTS",
  version: "2.7",
  description: "HL7 v2.7 RCI_I05.RESULTS group",
  type: "Group"
});
 ...
 */
export const rciI05ObservationSchema = z.object({
  "OBR": segments.obrSchema,
  "NTE": z.array(segments.nteSchema).optional(),
  "RESULTS": rciI05ResultsSchema.optional()
}).register(hl7v2Metadata, {
  title: "RCI_I05.OBSERVATION",
  version: "2.7",
  description: "HL7 v2.7 RCI_I05.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rci_i05Schema = z.object({
  ...
  "OBSERVATION": rciI05ObservationSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RCI_I05",
  version: "2.7",
  description: "HL7 v2.7 RCI_I05 message",
  type: "Message"
});
