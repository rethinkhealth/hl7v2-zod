...
/**
 * HL7 v2.7 RDS_O13 Message
 * 
 * HL7 v2.7 RDS_O13 message definition
 ...
 */
export const rdsO13AdditionalDemographicsSchema = z.object({
  "PD1": segments.pd1Schema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "RDS_O13.ADDITIONAL_DEMOGRAPHICS",
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.ADDITIONAL_DEMOGRAPHICS group",
  type: "Group"
});
...
export const rdsO13PatientVisitSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.PATIENT_VISIT group",
  type: "Group"
});
...
export const rdsO13TimingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.TIMING group",
  type: "Group"
});
...
export const rdsO13ComponentSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.COMPONENT group",
  type: "Group"
});
...
export const rdsO13TimingEncodedSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.TIMING_ENCODED group",
  type: "Group"
});
...
export const rdsO13ObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.OBSERVATION group",
  type: "Group"
});
...
export const rdsO13PatientSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.PATIENT group",
  type: "Group"
});
...
export const rdsO13OrderDetailSupplementSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.ORDER_DETAIL_SUPPLEMENT group",
  type: "Group"
});
...
export const rdsO13EncodingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.ENCODING group",
  type: "Group"
});
...
export const rdsO13OrderDetailSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.ORDER_DETAIL group",
  type: "Group"
});
...
export const rdsO13OrderSchema = z.object({
  ...
  title: "RDS_O13.ORDER",
  version: "2.7",
  description: "HL7 v2.7 RDS_O13.ORDER group",
  type: "Group"
});
...
export const rds_o13Schema = z.object({
  ...
  title: "RDS_O13",
  version: "2.7",
  description: "HL7 v2.7 RDS_O13 message",
  type: "Message"
});
