...
/**
 * HL7 v2.7 RGV_O15 Message
 * 
 * HL7 v2.7 RGV_O15 message definition
 ...
 */
export const rgvO15PatientVisitSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const rgvO15TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RGV_O15.TIMING",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.TIMING group",
  type: "Group"
});
 ...
 */
export const rgvO15ComponentsSchema = z.object({
  "RXC": segments.rxcSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RGV_O15.COMPONENTS",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.COMPONENTS group",
  type: "Group"
});
 ...
 */
export const rgvO15TimingEncodedSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RGV_O15.TIMING_ENCODED",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.TIMING_ENCODED group",
  type: "Group"
});
 ...
 */
export const rgvO15TimingGiveSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RGV_O15.TIMING_GIVE",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.TIMING_GIVE group",
  type: "Group"
});
 ...
 */
export const rgvO15ObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rgvO15PatientSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.PATIENT group",
  type: "Group"
});
 ...
 */
export const rgvO15OrderDetailSupplementSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.ORDER_DETAIL_SUPPLEMENT group",
  type: "Group"
});
 ...
 */
export const rgvO15EncodingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.ENCODING group",
  type: "Group"
});
 ...
 */
export const rgvO15GiveSchema = z.object({
  "RXG": segments.rxgSchema,
  "TIMING_GIVE": z.array(rgvO15TimingGiveSchema),
  "RXR": z.array(segments.rxrSchema),
  "RXC": z.array(segments.rxcSchema).optional(),
  "OBSERVATION": z.array(rgvO15ObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "RGV_O15.GIVE",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.GIVE group",
  type: "Group"
});
 ...
 */
export const rgvO15OrderSchema = z.object({
  ...
  title: "RGV_O15.ORDER",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15.ORDER group",
  type: "Group"
});
 ...
 */
export const rgv_o15Schema = z.object({
  ...
  title: "RGV_O15",
  version: "2.7",
  description: "HL7 v2.7 RGV_O15 message",
  type: "Message"
});
