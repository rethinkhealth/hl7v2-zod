...
/**
 * HL7 v2.7 RPI_I04 Message
 *
 * HL7 v2.7 RPI_I04 message definition
...
export const rpiI04ProviderSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RPI_I04.PROVIDER group",
    type: "Group"
  });
...
export const rpiI04InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RPI_I04.INSURANCE group",
    type: "Group"
  });
...
export const rpiI04GuarantorInsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RPI_I04.GUARANTOR_INSURANCE group",
    type: "Group"
  });
...
export const rpi_i04Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RPI_I04",
    version: "2.7",
    description: "HL7 v2.7 RPI_I04 message",
    type: "Message"
  });
