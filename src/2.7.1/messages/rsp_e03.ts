...
/**
 * HL7 v2.7 RSP_E03 Message
 *
 * HL7 v2.7 RSP_E03 message definition
 ...
 */
export const rspE03InvoiceProcessingResultsInfoSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_E03.INVOICE_PROCESSING_RESULTS_INFO group",
    type: "Group"
  });
 ...
 */
export type RSP_E03_INVOICE_PROCESSING_RESULTS_INFO = z.infer<
  typeof rspE03InvoiceProcessingResultsInfoSchema
>;
 ...
 */
export const rspE03QueryAckSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_E03.QUERY_ACK group",
    type: "Group"
  });
...
export const rsp_e03Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_E03",
    version: "2.7",
    description: "HL7 v2.7 RSP_E03 message",
    type: "Message"
  });
