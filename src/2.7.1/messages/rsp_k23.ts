...
/**
 * HL7 v2.7 RSP_K23 Message
 *
 * HL7 v2.7 RSP_K23 message definition
 ...
 */
export const rspK23QueryResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K23.QUERY_RESPONSE group",
    type: "Group"
  });
...
export const rsp_k23Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_K23",
    version: "2.7",
    description: "HL7 v2.7 RSP_K23 message",
    type: "Message"
  });
