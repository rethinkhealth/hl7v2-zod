...
/**
 * HL7 v2.7 RSP_K31 Message
 *
 * HL7 v2.7 RSP_K31 message definition
...
/**
 * RSP_K31.ADDITIONAL_DEMOGRAPHICS group schema
 * Defines the structure and validation rules for the RSP_K31.ADDITIONAL_DEMOGRAPHICS group
 */
export const rspK31AdditionalDemographicsSchema = z
  .object({
    PD1: segments.pd1Schema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    title: "RSP_K31.ADDITIONAL_DEMOGRAPHICS",
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.ADDITIONAL_DEMOGRAPHICS group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the RSP_K31.ADDITIONAL_DEMOGRAPHICS schema
 */
export type RSP_K31_ADDITIONAL_DEMOGRAPHICS = z.infer<typeof rspK31AdditionalDemographicsSchema>;

/**
 * RSP_K31.PATIENT_VISIT group schema
 * Defines the structure and validation rules for the RSP_K31.PATIENT_VISIT group
 */
export const rspK31PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const rspK31TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.TIMING group",
    type: "Group"
  });
 ...
 */
export const rspK31ComponentsSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.COMPONENTS group",
    type: "Group"
  });
 ...
 */
export const rspK31TimingEncodedSchema = z
  .object({
    TQ1: segments.tq1Schema,
    TQ2: z.array(segments.tq2Schema).optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.TIMING_ENCODED group",
    type: "Group"
  });
 ...
 */
export const rspK31ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const rspK31PatientSchema = z
  .object({
    PID: segments.pidSchema,
    ADDITIONAL_DEMOGRAPHICS: rspK31AdditionalDemographicsSchema.optional(),
    NTE: z.array(segments.nteSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.PATIENT group",
    type: "Group"
  });
 ...
 */
export const rspK31OrderDetailSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.ORDER_DETAIL group",
    type: "Group"
  });
 ...
 */
export const rspK31EncodingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.ENCODING group",
    type: "Group"
  });
 ...
 */
export const rspK31OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "RSP_K31.ORDER",
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.ORDER group",
    type: "Group"
  });
 ...
 */
export const rspK31ResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RSP_K31.RESPONSE group",
    type: "Group"
  });
...
export const rsp_k31Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_K31",
    version: "2.7",
    description: "HL7 v2.7 RSP_K31 message",
    type: "Message"
  });
