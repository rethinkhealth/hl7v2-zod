...
/**
 * HL7 v2.7 SDR_S32 Message
 * 
 * HL7 v2.7 SDR_S32 message definition
...
export const sdrS32Anti-microbialDeviceCycleDataSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 SDR_S32.ANTI-MICROBIAL_DEVICE_CYCLE_DATA group",
  type: "Group"
});
...
export const sdr_s32Schema = z.object({
  ...
  title: "SDR_S32",
  version: "2.7",
  description: "HL7 v2.7 SDR_S32 message",
  type: "Message"
});
