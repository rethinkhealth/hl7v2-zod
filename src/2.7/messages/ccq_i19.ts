...
/**
 * HL7 v2.7 CCQ_I19 Message
 * 
 * HL7 v2.7 CCQ_I19 message definition
 ...
 */
export const ccqI19ProviderContactSchema = z.object({
  "PRD": segments.prdSchema,
  "CTD": z.array(segments.ctdSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCQ_I19.PROVIDER_CONTACT",
  version: "2.7",
  description: "HL7 v2.7 CCQ_I19.PROVIDER_CONTACT group",
  type: "Group"
});
 ...
 */
export const ccq_i19Schema = z.object({
  ...
  title: "CCQ_I19",
  version: "2.7",
  description: "HL7 v2.7 CCQ_I19 message",
  type: "Message"
});
