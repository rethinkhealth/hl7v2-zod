...
/**
 * HL7 v2.7 CRM_C01 Message
 *
 * HL7 v2.7 CRM_C01 message definition
 ...
 */
export const crmC01PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CRM_C01.PATIENT_VISIT group",
    type: "Group"
  });
...
export const crmC01PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CRM_C01.PATIENT group",
    type: "Group"
  });
...
export const crm_c01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "CRM_C01",
    version: "2.7",
    description: "HL7 v2.7 CRM_C01 message",
    type: "Message"
  });
