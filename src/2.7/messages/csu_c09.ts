...
/**
 * HL7 v2.7 CSU_C09 Message
 *
 * HL7 v2.7 CSU_C09 message definition
...
export const csuC09VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "CSU_C09.VISIT",
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.VISIT group",
    type: "Group"
  });
...
export const csuC09TimingQtySchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.TIMING_QTY group",
    type: "Group"
  });
...
export const csuC09CommonOrderSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.COMMON_ORDER group",
    type: "Group"
  });
...
export const csuC09RxAdminSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.RX_ADMIN group",
    type: "Group"
  });
...
export const csuC09StudyObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.STUDY_OBSERVATION group",
    type: "Group"
  });
...
export const csuC09StudyPharmSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.STUDY_PHARM group",
    type: "Group"
  });
...
export const csuC09StudyScheduleSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.STUDY_SCHEDULE group",
    type: "Group"
  });
...
export const csuC09StudyPhaseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.STUDY_PHASE group",
    type: "Group"
  });
...
export const csuC09PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 CSU_C09.PATIENT group",
    type: "Group"
  });
...
export const csu_c09Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "CSU_C09",
    version: "2.7",
    description: "HL7 v2.7 CSU_C09 message",
    type: "Message"
  });
