...
/**
 * HL7 v2.7 DFT_P11 Message
 * 
 * HL7 v2.7 DFT_P11 message definition
...
export const dftP11VisitSchema = z.object({
  ...
  title: "DFT_P11.VISIT",
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.VISIT group",
  type: "Group"
});
...
export const dftP11TimingQuantitySchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.TIMING_QUANTITY group",
  type: "Group"
});
...
export const dftP11OrderSchema = z.object({
  ...
  title: "DFT_P11.ORDER",
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.ORDER group",
  type: "Group"
});
...
export const dftP11ObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.OBSERVATION group",
  type: "Group"
});
...
export const dftP11InsuranceSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.INSURANCE group",
  type: "Group"
});
...
export const dftP11FinancialProcedureSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL_PROCEDURE group",
  type: "Group"
});
...
export const dftP11FinancialTimingQuantitySchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL_TIMING_QUANTITY group",
  type: "Group"
});
...
export const dftP11FinancialOrderSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL_ORDER group",
  type: "Group"
});
...
export const dftP11FinancialObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL_OBSERVATION group",
  type: "Group"
});
...
export const dftP11FinancialInsuranceSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL_INSURANCE group",
  type: "Group"
});
...
export const dftP11CommonOrderSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.COMMON_ORDER group",
  type: "Group"
});
...
export const dftP11FinancialCommonOrderSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL_COMMON_ORDER group",
  type: "Group"
});
...
export const dftP11FinancialSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 DFT_P11.FINANCIAL group",
  type: "Group"
});
...
export const dft_p11Schema = z.object({
  ...
  title: "DFT_P11",
  version: "2.7",
  description: "HL7 v2.7 DFT_P11 message",
  type: "Message"
});
