...
/**
 * HL7 v2.7 EHC_E04 Message
 * 
 * HL7 v2.7 EHC_E04 message definition
...
export const ehcE04ProductServiceGroupSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E04.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
...
export const ehcE04ProductServiceSectionSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E04.PRODUCT_SERVICE_SECTION group",
  type: "Group"
});
...
export const ehcE04ReassessmentRequestInfoSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 EHC_E04.REASSESSMENT_REQUEST_INFO group",
  type: "Group"
});
...
export const ehc_e04Schema = z.object({
  ...
  title: "EHC_E04",
  version: "2.7",
  description: "HL7 v2.7 EHC_E04 message",
  type: "Message"
});
