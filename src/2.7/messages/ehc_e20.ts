...
/**
 * HL7 v2.7 EHC_E20 Message
 *
 * HL7 v2.7 EHC_E20 message definition
...
export const ehcE20InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E20.INSURANCE group",
    type: "Group"
  });
...
export const ehcE20DiagnosisSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E20.DIAGNOSIS group",
    type: "Group"
  });
...
export const ehcE20PslItemInfoSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E20.PSL_ITEM_INFO group",
    type: "Group"
  });
...
export const ehcE20PatInfoSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E20.PAT_INFO group",
    type: "Group"
  });
...
export const ehcE20AuthorizationRequestSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E20.AUTHORIZATION_REQUEST group",
    type: "Group"
  });
...
export const ehc_e20Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E20",
    version: "2.7",
    description: "HL7 v2.7 EHC_E20 message",
    type: "Message"
  });
