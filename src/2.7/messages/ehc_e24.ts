...
/**
 * HL7 v2.7 EHC_E24 Message
 *
 * HL7 v2.7 EHC_E24 message definition
...
export const ehcE24PayerAdjustmentSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E24.PAYER_ADJUSTMENT group",
    type: "Group"
  });
...
export const ehcE24PslItemInfoSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E24.PSL_ITEM_INFO group",
    type: "Group"
  });
...
export const ehcE24AuthorizationResponseInfoSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 EHC_E24.AUTHORIZATION_RESPONSE_INFO group",
    type: "Group"
  });
...
export const ehc_e24Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E24",
    version: "2.7",
    description: "HL7 v2.7 EHC_E24 message",
    type: "Message"
  });
