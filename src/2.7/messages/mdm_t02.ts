...
/**
 * HL7 v2.7 MDM_T02 Message
 * 
 * HL7 v2.7 MDM_T02 message definition
 ...
 */
export const mdmT02TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "MDM_T02.TIMING",
  version: "2.7",
  description: "HL7 v2.7 MDM_T02.TIMING group",
  type: "Group"
});
 ...
 */
export const mdmT02ObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "MDM_T02.OBSERVATION",
  version: "2.7",
  description: "HL7 v2.7 MDM_T02.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const mdmT02CommonOrderSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 MDM_T02.COMMON_ORDER group",
  type: "Group"
});
 ...
 */
export const mdm_t02Schema = z.object({
  ...
  "CON": z.array(segments.conSchema).optional(),
  "OBSERVATION": z.array(mdmT02ObservationSchema)
}).register(hl7v2Metadata, {
  title: "MDM_T02",
  version: "2.7",
  description: "HL7 v2.7 MDM_T02 message",
  type: "Message"
});
