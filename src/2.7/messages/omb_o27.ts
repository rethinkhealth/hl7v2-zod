...
/**
 * HL7 v2.7 OMB_O27 Message
 * 
 * HL7 v2.7 OMB_O27 message definition
...
export const ombO27PatientVisitSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 OMB_O27.PATIENT_VISIT group",
  type: "Group"
});
...
export const ombO27InsuranceSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 OMB_O27.INSURANCE group",
  type: "Group"
});
...
export const ombO27TimingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 OMB_O27.TIMING group",
  type: "Group"
});
...
export const ombO27ObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 OMB_O27.OBSERVATION group",
  type: "Group"
});
...
export const ombO27PatientSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 OMB_O27.PATIENT group",
  type: "Group"
});
...
export const ombO27OrderSchema = z.object({
  ...
  title: "OMB_O27.ORDER",
  version: "2.7",
  description: "HL7 v2.7 OMB_O27.ORDER group",
  type: "Group"
});
...
export const omb_o27Schema = z.object({
  ...
  title: "OMB_O27",
  version: "2.7",
  description: "HL7 v2.7 OMB_O27 message",
  type: "Message"
});
