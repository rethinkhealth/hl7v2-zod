...
/**
 * HL7 v2.7 ORI_O24 Message
 *
 * HL7 v2.7 ORI_O24 message definition
...
export const oriO24PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORI_O24.PATIENT group",
    type: "Group"
  });
...
export const oriO24TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORI_O24.TIMING group",
    type: "Group"
  });
...
export const oriO24OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORI_O24.ORDER",
    version: "2.7",
    description: "HL7 v2.7 ORI_O24.ORDER group",
    type: "Group"
  });
...
export const oriO24ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORI_O24.RESPONSE group",
    type: "Group"
  });
...
export const ori_o24Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORI_O24",
    version: "2.7",
    description: "HL7 v2.7 ORI_O24 message",
    type: "Message"
  });
