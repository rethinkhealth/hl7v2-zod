...
/**
 * HL7 v2.7 ORL_O22 Message
 * 
 * HL7 v2.7 ORL_O22 message definition
...
export const orlO22TimingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O22.TIMING group",
  type: "Group"
});
...
export const orlO22SpecimenSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O22.SPECIMEN group",
  type: "Group"
});
...
export const orlO22ObservationRequestSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O22.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const orlO22OrderSchema = z.object({
  ...
  title: "ORL_O22.ORDER",
  version: "2.7",
  description: "HL7 v2.7 ORL_O22.ORDER group",
  type: "Group"
});
...
export const orlO22ResponseSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O22.RESPONSE group",
  type: "Group"
});
...
export const orl_o22Schema = z.object({
  ...
  title: "ORL_O22",
  version: "2.7",
  description: "HL7 v2.7 ORL_O22 message",
  type: "Message"
});
