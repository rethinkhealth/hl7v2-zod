...
/**
 * HL7 v2.7 ORL_O34 Message
 * 
 * HL7 v2.7 ORL_O34 message definition
...
export const orlO34SpecimenObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O34.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const orlO34TimingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O34.TIMING group",
  type: "Group"
});
...
export const orlO34ObservationRequestSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O34.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const orlO34OrderSchema = z.object({
  ...
  title: "ORL_O34.ORDER",
  version: "2.7",
  description: "HL7 v2.7 ORL_O34.ORDER group",
  type: "Group"
});
...
export const orlO34SpecimenSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O34.SPECIMEN group",
  type: "Group"
});
...
export const orlO34ResponseSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O34.RESPONSE group",
  type: "Group"
});
...
export const orl_o34Schema = z.object({
  ...
  title: "ORL_O34",
  version: "2.7",
  description: "HL7 v2.7 ORL_O34 message",
  type: "Message"
});
