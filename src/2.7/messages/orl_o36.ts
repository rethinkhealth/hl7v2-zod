...
/**
 * HL7 v2.7 ORL_O36 Message
 *
 * HL7 v2.7 ORL_O36 message definition
...
export const orlO36SpecimenObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.SPECIMEN_OBSERVATION group",
    type: "Group"
  });
...
export const orlO36TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.TIMING group",
    type: "Group"
  });
...
export const orlO36ObservationRequestSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.OBSERVATION_REQUEST group",
    type: "Group"
  });
...
export const orlO36OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O36.ORDER",
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.ORDER group",
    type: "Group"
  });
...
export const orlO36SpecimenContainerSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.SPECIMEN_CONTAINER group",
    type: "Group"
  });
...
export const orlO36SpecimenSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.SPECIMEN group",
    type: "Group"
  });
...
export const orlO36ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 ORL_O36.RESPONSE group",
    type: "Group"
  });
...
export const orl_o36Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O36",
    version: "2.7",
    description: "HL7 v2.7 ORL_O36 message",
    type: "Message"
  });
