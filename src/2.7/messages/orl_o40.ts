...
/**
 * HL7 v2.7 ORL_O40 Message
 * 
 * HL7 v2.7 ORL_O40 message definition
...
export const orlO40TimingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.TIMING group",
  type: "Group"
});
...
export const orlO40SpecimenContainerInPackageSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.SPECIMEN_CONTAINER_IN_PACKAGE group",
  type: "Group"
});
...
export const orlO40SpecimenInPackageSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.SPECIMEN_IN_PACKAGE group",
  type: "Group"
});
...
export const orlO40PackageSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.PACKAGE group",
  type: "Group"
});
...
export const orlO40SpecimenShipmentSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.SPECIMEN_SHIPMENT group",
  type: "Group"
});
...
export const orlO40ObservationRequestSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const orlO40OrderSchema = z.object({
  ...
  title: "ORL_O40.ORDER",
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.ORDER group",
  type: "Group"
});
...
export const orlO40PatientSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.PATIENT group",
  type: "Group"
});
...
export const orlO40ResponseSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 ORL_O40.RESPONSE group",
  type: "Group"
});
...
export const orl_o40Schema = z.object({
  ...
  title: "ORL_O40",
  version: "2.7",
  description: "HL7 v2.7 ORL_O40 message",
  type: "Message"
});
