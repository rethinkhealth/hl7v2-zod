 ...
 */
export const osmR26SubjectPersonAnimalIdentificationSchema = z.object({
  "PID": segments.pidSchema,
  "PRT": z.array(segments.prtSchema).optional(),
 ...
 */
export type OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION = z.infer<typeof osmR26SubjectPersonAnimalIdentificationSchema>;
 ...
 */
export const osmR26SubjectPopulationLocationIdentificationSchema = z.object({
 ...
 */
export type OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION = z.infer<typeof osmR26SubjectPopulationLocationIdentificationSchema>;
...
export const osmR26SpecimenSchema = z.object({
  ...
  "SUBJECT_POPULATION_LOCATION_IDENTIFICATION": osmR26SubjectPopulationLocationIdentificationSchema.optional()
}).register(hl7v2Metadata, {
