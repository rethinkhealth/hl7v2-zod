...
/**
 * HL7 v2.7 OUL_R23 Message
 *
 * HL7 v2.7 OUL_R23 message definition
 ...
 */
export const oulR23PatientObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.PATIENT_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const oulR23VisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "OUL_R23.VISIT",
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.VISIT group",
    type: "Group"
  });
 ...
 */
export const oulR23SpecimenObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.SPECIMEN_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const oulR23TimingQtySchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.TIMING_QTY group",
    type: "Group"
  });
 ...
 */
export const oulR23ResultSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.RESULT group",
    type: "Group"
  });
 ...
 */
export const oulR23PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.PATIENT group",
    type: "Group"
  });
 ...
 */
export const oulR23OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "OUL_R23.ORDER",
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.ORDER group",
    type: "Group"
  });
 ...
 */
export const oulR23ContainerSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.CONTAINER group",
    type: "Group"
  });
 ...
 */
export const oulR23SpecimenSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 OUL_R23.SPECIMEN group",
    type: "Group"
  });
...
export const oul_r23Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OUL_R23",
    version: "2.7",
    description: "HL7 v2.7 OUL_R23 message",
    type: "Message"
  });
