...
/**
 * HL7 v2.7 RAS_O17 Message
 * 
 * HL7 v2.7 RAS_O17 message definition
...
/**
 * RAS_O17.ADDITIONAL_DEMOGRAPHICS group schema
 * Defines the structure and validation rules for the RAS_O17.ADDITIONAL_DEMOGRAPHICS group
 */
export const rasO17AdditionalDemographicsSchema = z.object({
  "PD1": segments.pd1Schema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "RAS_O17.ADDITIONAL_DEMOGRAPHICS",
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.ADDITIONAL_DEMOGRAPHICS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the RAS_O17.ADDITIONAL_DEMOGRAPHICS schema
 */
export type RAS_O17_ADDITIONAL_DEMOGRAPHICS = z.infer<typeof rasO17AdditionalDemographicsSchema>;

/**
 * RAS_O17.PATIENT_VISIT group schema
 * Defines the structure and validation rules for the RAS_O17.PATIENT_VISIT group
 */
export const rasO17PatientVisitSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const rasO17TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RAS_O17.TIMING",
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.TIMING group",
  type: "Group"
});
 ...
 */
export const rasO17ComponentsSchema = z.object({
  "RXC": segments.rxcSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RAS_O17.COMPONENTS",
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.COMPONENTS group",
  type: "Group"
});
 ...
 */
export const rasO17TimingEncodedSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RAS_O17.TIMING_ENCODED",
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.TIMING_ENCODED group",
  type: "Group"
});
 ...
 */
export const rasO17ObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rasO17PatientSchema = z.object({
  "PID": segments.pidSchema,
  "ADDITIONAL_DEMOGRAPHICS": rasO17AdditionalDemographicsSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  ...
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.PATIENT group",
  type: "Group"
});
 ...
 */
export const rasO17OrderDetailSupplementSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.ORDER_DETAIL_SUPPLEMENT group",
  type: "Group"
});
 ...
 */
export const rasO17EncodingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.ENCODING group",
  type: "Group"
});
 ...
 */
export const rasO17AdministrationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.ADMINISTRATION group",
  type: "Group"
});
 ...
 */
export const rasO17OrderSchema = z.object({
  ...
  title: "RAS_O17.ORDER",
  version: "2.7",
  description: "HL7 v2.7 RAS_O17.ORDER group",
  type: "Group"
});
 ...
 */
export const ras_o17Schema = z.object({
  ...
  title: "RAS_O17",
  version: "2.7",
  description: "HL7 v2.7 RAS_O17 message",
  type: "Message"
});
