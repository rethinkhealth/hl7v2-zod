...
/**
 * HL7 v2.7 REF_I12 Message
 *
 * HL7 v2.7 REF_I12 message definition
...
/**
 * REF_I12.AUTHORIZATION_CONTACT group schema
 * Defines the structure and validation rules for the REF_I12.AUTHORIZATION_CONTACT group
 */
export const refI12AuthorizationContactSchema = z
  .object({
    AUT: segments.autSchema,
    CTD: segments.ctdSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "REF_I12.AUTHORIZATION_CONTACT",
    version: "2.7",
    description: "HL7 v2.7 REF_I12.AUTHORIZATION_CONTACT group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the REF_I12.AUTHORIZATION_CONTACT schema
 */
export type REF_I12_AUTHORIZATION_CONTACT = z.infer<typeof refI12AuthorizationContactSchema>;
...
export const refI12ProviderContactSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.PROVIDER_CONTACT group",
    type: "Group"
  });
...
export const refI12InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.INSURANCE group",
    type: "Group"
  });
...
export const refI12AuthorizationContact2Schema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.AUTHORIZATION_CONTACT2 group",
    type: "Group"
  });
...
export const refI12ResultsNotesSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.RESULTS_NOTES group",
    type: "Group"
  });
...
export const refI12PatientVisitSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.PATIENT_VISIT group",
    type: "Group"
  });
...
export const refI12ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.PROCEDURE group",
    type: "Group"
  });
...
export const refI12ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 REF_I12.OBSERVATION group",
    type: "Group"
  });
...
export const ref_i12Schema = z
  .object({
    ...
    AUTHORIZATION_CONTACT: refI12AuthorizationContactSchema.optional(),
  ...
  .register(hl7v2Metadata, {
    title: "REF_I12",
    version: "2.7",
    description: "HL7 v2.7 REF_I12 message",
    type: "Message"
  });
