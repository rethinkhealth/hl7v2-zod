...
/**
 * HL7 v2.7 RPA_I08 Message
 * 
 * HL7 v2.7 RPA_I08 message definition
 ...
 */
export const rpaI08AuthorizationSchema = z.object({
  "AUT": segments.autSchema,
  "CTD": segments.ctdSchema.optional()
}).register(hl7v2Metadata, {
  title: "RPA_I08.AUTHORIZATION",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.AUTHORIZATION group",
  type: "Group"
});
 ...
 */
export const rpaI08ProviderSchema = z.object({
  "PRD": segments.prdSchema,
  "CTD": z.array(segments.ctdSchema).optional()
}).register(hl7v2Metadata, {
  title: "RPA_I08.PROVIDER",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.PROVIDER group",
  type: "Group"
});
 ...
 */
export const rpaI08InsuranceSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.INSURANCE group",
  type: "Group"
});
...
/**
 * RPA_I08.AUTHORIZATION2 group schema
 * Defines the structure and validation rules for the RPA_I08.AUTHORIZATION2 group
 */
export const rpaI08Authorization2Schema = z.object({
  "AUT": segments.autSchema,
  "CTD": segments.ctdSchema.optional()
}).register(hl7v2Metadata, {
  title: "RPA_I08.AUTHORIZATION2",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.AUTHORIZATION2 group",
  type: "Group"
});

/**
 * TypeScript type inferred from the RPA_I08.AUTHORIZATION2 schema
 */
export type RPA_I08_AUTHORIZATION2 = z.infer<typeof rpaI08Authorization2Schema>;

/**
 * RPA_I08.RESULTS group schema
 * Defines the structure and validation rules for the RPA_I08.RESULTS group
 */
export const rpaI08ResultsSchema = z.object({
  "OBX": segments.obxSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RPA_I08.RESULTS",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.RESULTS group",
  type: "Group"
});
 ...
 */
export const rpaI08VisitSchema = z.object({
  "PV1": segments.pv1Schema,
  "PV2": segments.pv2Schema.optional()
}).register(hl7v2Metadata, {
  title: "RPA_I08.VISIT",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.VISIT group",
  type: "Group"
});
 ...
 */
export const rpaI08ProcedureSchema = z.object({
  "PR1": segments.pr1Schema,
  "AUTHORIZATION2": rpaI08Authorization2Schema.optional()
}).register(hl7v2Metadata, {
  title: "RPA_I08.PROCEDURE",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.PROCEDURE group",
  type: "Group"
});
 ...
 */
export const rpaI08ObservationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RPA_I08.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rpa_i08Schema = z.object({
  ...
  title: "RPA_I08",
  version: "2.7",
  description: "HL7 v2.7 RPA_I08 message",
  type: "Message"
});
