...
/**
 * HL7 v2.7 RQA_I08 Message
 *
 * HL7 v2.7 RQA_I08 message definition
 ...
 */
export const rqaI08AuthorizationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.AUTHORIZATION group",
    type: "Group"
  });
 ...
 */
export const rqaI08ProviderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.PROVIDER group",
    type: "Group"
  });
 ...
 */
export const rqaI08InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.INSURANCE group",
    type: "Group"
  });
...
/**
 * RQA_I08.AUTHORIZATION2 group schema
 * Defines the structure and validation rules for the RQA_I08.AUTHORIZATION2 group
 */
export const rqaI08Authorization2Schema = z
  .object({
    AUT: segments.autSchema,
    CTD: segments.ctdSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "RQA_I08.AUTHORIZATION2",
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.AUTHORIZATION2 group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the RQA_I08.AUTHORIZATION2 schema
 */
export type RQA_I08_AUTHORIZATION2 = z.infer<typeof rqaI08Authorization2Schema>;

/**
 * RQA_I08.RESULTS group schema
 * Defines the structure and validation rules for the RQA_I08.RESULTS group
 */
export const rqaI08ResultsSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.RESULTS group",
    type: "Group"
  });
 ...
 */
export const rqaI08VisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "RQA_I08.VISIT",
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.VISIT group",
    type: "Group"
  });
 ...
 */
export const rqaI08GuarantorInsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.GUARANTOR_INSURANCE group",
    type: "Group"
  });
 ...
 */
export const rqaI08ProcedureSchema = z
  .object({
    PR1: segments.pr1Schema,
    AUTHORIZATION2: rqaI08Authorization2Schema.optional()
  })
  .register(hl7v2Metadata, {
    title: "RQA_I08.PROCEDURE",
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.PROCEDURE group",
    type: "Group"
  });
 ...
 */
export const rqaI08ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 RQA_I08.OBSERVATION group",
    type: "Group"
  });
...
export const rqa_i08Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RQA_I08",
    version: "2.7",
    description: "HL7 v2.7 RQA_I08 message",
    type: "Message"
  });
