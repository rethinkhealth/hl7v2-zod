...
/**
 * HL7 v2.7 RRA_O18 Message
 * 
 * HL7 v2.7 RRA_O18 message definition
...
export const rraO18PatientSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RRA_O18.PATIENT group",
  type: "Group"
});
...
export const rraO18TimingSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RRA_O18.TIMING group",
  type: "Group"
});
...
export const rraO18TreatmentSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RRA_O18.TREATMENT group",
  type: "Group"
});
...
export const rraO18AdministrationSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RRA_O18.ADMINISTRATION group",
  type: "Group"
});
...
export const rraO18OrderSchema = z.object({
  ...
  title: "RRA_O18.ORDER",
  version: "2.7",
  description: "HL7 v2.7 RRA_O18.ORDER group",
  type: "Group"
});
...
export const rraO18ResponseSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 RRA_O18.RESPONSE group",
  type: "Group"
});
...
export const rra_o18Schema = z.object({
  ...
  title: "RRA_O18",
  version: "2.7",
  description: "HL7 v2.7 RRA_O18 message",
  type: "Message"
});
