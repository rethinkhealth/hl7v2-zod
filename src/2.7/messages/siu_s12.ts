...
/**
 * HL7 v2.7 SIU_S12 Message
 * 
 * HL7 v2.7 SIU_S12 message definition
 ...
 */
export const siuS12PatientSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 SIU_S12.PATIENT group",
  type: "Group"
});
 ...
 */
export const siuS12ServiceSchema = z.object({
  "AIS": segments.aisSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SIU_S12.SERVICE",
  version: "2.7",
  description: "HL7 v2.7 SIU_S12.SERVICE group",
  type: "Group"
});
 ...
 */
export const siuS12GeneralResourceSchema = z.object({
  "AIG": segments.aigSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SIU_S12.GENERAL_RESOURCE",
  version: "2.7",
  description: "HL7 v2.7 SIU_S12.GENERAL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const siuS12LocationResourceSchema = z.object({
  "AIL": segments.ailSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SIU_S12.LOCATION_RESOURCE",
  version: "2.7",
  description: "HL7 v2.7 SIU_S12.LOCATION_RESOURCE group",
  type: "Group"
});
 ...
 */
export const siuS12PersonnelResourceSchema = z.object({
  "AIP": segments.aipSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "SIU_S12.PERSONNEL_RESOURCE",
  version: "2.7",
  description: "HL7 v2.7 SIU_S12.PERSONNEL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const siuS12ResourcesSchema = z.object({
  ...
  version: "2.7",
  description: "HL7 v2.7 SIU_S12.RESOURCES group",
  type: "Group"
});
 ...
 */
export const siu_s12Schema = z.object({
  ...
  title: "SIU_S12",
  version: "2.7",
  description: "HL7 v2.7 SIU_S12 message",
  type: "Message"
});
