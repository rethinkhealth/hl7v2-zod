...
/**
 * HL7 v2.7 VXU_V04 Message
 *
 * HL7 v2.7 VXU_V04 message definition
...
export const vxuV04PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 VXU_V04.PATIENT group",
    type: "Group"
  });
...
export const vxuV04InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 VXU_V04.INSURANCE group",
    type: "Group"
  });
...
export const vxuV04TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 VXU_V04.TIMING group",
    type: "Group"
  });
...
export const vxuV04ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.7",
    description: "HL7 v2.7 VXU_V04.OBSERVATION group",
    type: "Group"
  });
...
export const vxuV04OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "VXU_V04.ORDER",
    version: "2.7",
    description: "HL7 v2.7 VXU_V04.ORDER group",
    type: "Group"
  });
...
export const vxu_v04Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "VXU_V04",
    version: "2.7",
    description: "HL7 v2.7 VXU_V04 message",
    type: "Message"
  });
