...
/**
 * HL7 v2.8 RPT Composite Data Type
 * 
 * HL7 v2.8 RPT composite data type
 ...
 * RPT.8 - Event
 */
export const RPT_8 = SimpleTypes.ID.max(3).optional().register(hl7v2Metadata, {
  "title": "RPT.8",
  "version": "2.8",
  "description": "Event",
  "type": "DataType",
...
/**
 * RPT - HL7 v2.8 RPT composite data type
 * 
 * Components:
...
export const RPT = z.object({
  ...
  title: 'RPT',
  version: '2.8',
  description: 'HL7 v2.8 RPT composite data type'
});
