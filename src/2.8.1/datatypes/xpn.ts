...
/**
 * HL7 v2.8 XPN Composite Data Type
 *
 * HL7 v2.8 XPN composite data type
 ...
 */
export const XPN_7 = SimpleTypes.ID.max(5).optional().register(hl7v2Metadata, {
  title: "XPN.7",
  version: "2.8",
...
/**
 * XPN - HL7 v2.8 XPN composite data type
 *
 * Components:
...
export const XPN = z
  ...
  .register(hl7v2Metadata, {
    title: "XPN",
    version: "2.8",
    description: "HL7 v2.8 XPN composite data type"
  });
