...
/**
 * HL7 v2.8 ADT_A06 Message
 *
 * HL7 v2.8 ADT_A06 message definition
...
export const adtA06ProcedureSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ADT_A06.PROCEDURE group",
    type: "Group"
  });
...
export const adtA06InsuranceSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ADT_A06.INSURANCE group",
    type: "Group"
  });
...
export const adt_a06Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ADT_A06",
    version: "2.8",
    description: "HL7 v2.8 ADT_A06 message",
    type: "Message"
  });
