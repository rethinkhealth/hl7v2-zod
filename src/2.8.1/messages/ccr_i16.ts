...
/**
 * HL7 v2.8 CCR_I16 Message
 * 
 * HL7 v2.8 CCR_I16 message definition
...
export const ccrI16ProviderContactSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.PROVIDER_CONTACT group",
  type: "Group"
});
...
export const ccrI16ClinicalOrderTimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_ORDER_TIMING group",
  type: "Group"
});
...
export const ccrI16ClinicalOrderObjectSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_ORDER_OBJECT group",
  type: "Group"
});
...
export const ccrI16ClinicalOrderObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_ORDER_OBSERVATION group",
  type: "Group"
});
...
export const ccrI16PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.PATIENT group",
  type: "Group"
});
...
export const ccrI16InsuranceSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.INSURANCE group",
  type: "Group"
});
...
export const ccrI16ResourceObjectSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.RESOURCE_OBJECT group",
  type: "Group"
});
...
export const ccrI16ResourceObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.RESOURCE_OBSERVATION group",
  type: "Group"
});
...
export const ccrI16ClinicalHistoryObjectSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});
...
export const ccrI16ClinicalHistoryObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_HISTORY_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccrI16RoleClinicalHistoryObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_CLINICAL_HISTORY_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});
 ...
 */
export type CCR_I16_ROLE_CLINICAL_HISTORY_OBJECT = z.infer<typeof ccrI16RoleClinicalHistoryObjectSchema>;
...
export const ccrI16PatientVisitsSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.PATIENT_VISITS group",
  type: "Group"
});
...
export const ccrI16MedicationOrderObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_ORDER_OBSERVATION group",
  type: "Group"
});
...
export const ccrI16MedicationEncodingObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_ENCODING_OBSERVATION group",
  type: "Group"
});
...
export const ccrI16MedicationAdministrationObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_ADMINISTRATION_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccrI16RoleProblemObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_PROBLEM_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_PROBLEM_OBJECT group",
  type: "Group"
});
...
/**
 * CCR_I16.ROLE_OBSERVATION group schema
 * Defines the structure and validation rules for the CCR_I16.ROLE_OBSERVATION group
 */
export const ccrI16RoleObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCR_I16.ROLE_OBSERVATION schema
 */
export type CCR_I16_ROLE_OBSERVATION = z.infer<typeof ccrI16RoleObservationSchema>;

/**
 * CCR_I16.ROLE_GOAL_OBJECT group schema
 * Defines the structure and validation rules for the CCR_I16.ROLE_GOAL_OBJECT group
 */
export const ccrI16RoleGoalObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_GOAL_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_GOAL_OBJECT group",
  type: "Group"
});
...
export const ccrI16GoalObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.GOAL_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccrI16RolePathwayObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_PATHWAY_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_PATHWAY_OBJECT group",
  type: "Group"
});
...
export const ccrI16PathwayObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.PATHWAY_OBSERVATION group",
  type: "Group"
});
...
export const ccrI16ClinicalOrderDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_ORDER_DETAIL group",
  type: "Group"
});
...
export const ccrI16ResourceDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.RESOURCE_DETAIL group",
  type: "Group"
});
...
export const ccrI16ClinicalHistoryDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_HISTORY_DETAIL group",
  type: "Group"
});
 ...
 */
export const ccrI16RoleClinicalHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_CLINICAL_HISTORY group",
  type: "Group"
});
...
export const ccrI16MedicationOrderDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_ORDER_DETAIL group",
  type: "Group"
});
...
export const ccrI16MedicationEncodingDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_ENCODING_DETAIL group",
  type: "Group"
});
...
export const ccrI16MedicationAdministrationDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_ADMINISTRATION_DETAIL group",
  type: "Group"
});
 ...
 */
export const ccrI16RoleProblemSchema = z.object({
  "ROLE_PROBLEM_OBJECT": ccrI16RoleProblemObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_PROBLEM",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_PROBLEM group",
  type: "Group"
});
 ...
 */
export const ccrI16RoleGoalSchema = z.object({
  "ROLE_GOAL_OBJECT": ccrI16RoleGoalObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_GOAL",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_GOAL group",
  type: "Group"
});
 ...
 */
export const ccrI16RolePathwaySchema = z.object({
  "ROLE_PATHWAY_OBJECT": ccrI16RolePathwayObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCR_I16.ROLE_PATHWAY",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.ROLE_PATHWAY group",
  type: "Group"
});
...
export const ccrI16ClinicalOrderSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_ORDER group",
  type: "Group"
});
...
export const ccrI16ResourcesSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.RESOURCES group",
  type: "Group"
});
...
export const ccrI16ClinicalHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.CLINICAL_HISTORY group",
  type: "Group"
});
...
export const ccrI16MedicationHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.MEDICATION_HISTORY group",
  type: "Group"
});
...
export const ccrI16ProblemSchema = z.object({
  ...
  "ROLE_OBSERVATION": z.array(ccrI16RoleObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCR_I16.PROBLEM",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.PROBLEM group",
  type: "Group"
});
...
export const ccrI16GoalSchema = z.object({
  ...
  title: "CCR_I16.GOAL",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.GOAL group",
  type: "Group"
});
...
export const ccrI16PathwaySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.PATHWAY group",
  type: "Group"
});
...
export const ccrI16AppointmentHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCR_I16.APPOINTMENT_HISTORY group",
  type: "Group"
});
...
export const ccr_i16Schema = z.object({
  ...
  title: "CCR_I16",
  version: "2.8",
  description: "HL7 v2.8 CCR_I16 message",
  type: "Message"
});
