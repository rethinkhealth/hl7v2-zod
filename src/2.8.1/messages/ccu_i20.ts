 ...
 */
export const ccuI20ResourceObservationSchema = z
  .object({
 ...
 */
export const ccuI20ClinicalHistoryObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCU_I20_CLINICAL_HISTORY_OBSERVATION = z.infer<
  typeof ccuI20ClinicalHistoryObservationSchema
>;
 ...
 */
export const ccuI20MedicationOrderObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCU_I20_MEDICATION_ORDER_OBSERVATION = z.infer<
  typeof ccuI20MedicationOrderObservationSchema
>;
 ...
 */
export const ccuI20MedicationEncodingObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCU_I20_MEDICATION_ENCODING_OBSERVATION = z.infer<
  typeof ccuI20MedicationEncodingObservationSchema
>;
 ...
 */
export const ccuI20MedicationAdministrationObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCU_I20_MEDICATION_ADMINISTRATION_OBSERVATION = z.infer<
  typeof ccuI20MedicationAdministrationObservationSchema
>;
 ...
 */
export const ccuI20ProblemObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const ccuI20GoalObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const ccuI20PathwayObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
...
export const ccuI20MedicationAdministrationDetailSchema = z
  .object({
    ...
    MEDICATION_ADMINISTRATION_OBSERVATION: z
      .array(ccuI20MedicationAdministrationObservationSchema)
      .optional()
  })
  .register(hl7v2Metadata, {
