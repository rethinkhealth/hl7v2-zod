 ...
 */
export const cquI19ResourceObservationSchema = z
  .object({
 ...
 */
export const cquI19ClinicalHistoryObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CQU_I19_CLINICAL_HISTORY_OBSERVATION = z.infer<
  typeof cquI19ClinicalHistoryObservationSchema
>;
 ...
 */
export const cquI19MedicationOrderObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CQU_I19_MEDICATION_ORDER_OBSERVATION = z.infer<
  typeof cquI19MedicationOrderObservationSchema
>;
 ...
 */
export const cquI19MedicationEncodingObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CQU_I19_MEDICATION_ENCODING_OBSERVATION = z.infer<
  typeof cquI19MedicationEncodingObservationSchema
>;
 ...
 */
export const cquI19MedicationAdministrationObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CQU_I19_MEDICATION_ADMINISTRATION_OBSERVATION = z.infer<
  typeof cquI19MedicationAdministrationObservationSchema
>;
 ...
 */
export const cquI19ProblemObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const cquI19GoalObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const cquI19PathwayObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
...
export const cquI19MedicationAdministrationDetailSchema = z
  .object({
    ...
    MEDICATION_ADMINISTRATION_OBSERVATION: z
      .array(cquI19MedicationAdministrationObservationSchema)
      .optional()
  })
  .register(hl7v2Metadata, {
