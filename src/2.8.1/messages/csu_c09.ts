...
/**
 * HL7 v2.8 CSU_C09 Message
 *
 * HL7 v2.8 CSU_C09 message definition
 ...
 */
export const csuC09VisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "CSU_C09.VISIT",
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.VISIT group",
    type: "Group"
  });
...
/**
 * CSU_C09.STUDY_OBSERVATION_ORDER group schema
 * Defines the structure and validation rules for the CSU_C09.STUDY_OBSERVATION_ORDER group
 */
export const csuC09StudyObservationOrderSchema = z
  .object({
    ORC: segments.orcSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    title: "CSU_C09.STUDY_OBSERVATION_ORDER",
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.STUDY_OBSERVATION_ORDER group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the CSU_C09.STUDY_OBSERVATION_ORDER schema
 */
export type CSU_C09_STUDY_OBSERVATION_ORDER = z.infer<typeof csuC09StudyObservationOrderSchema>;

/**
 * CSU_C09.TIMING_QTY group schema
 * Defines the structure and validation rules for the CSU_C09.TIMING_QTY group
 */
export const csuC09TimingQtySchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.TIMING_QTY group",
    type: "Group"
  });
...
/**
 * CSU_C09.COMMON_ORDER group schema
 * Defines the structure and validation rules for the CSU_C09.COMMON_ORDER group
 */
export const csuC09CommonOrderSchema = z
  .object({
    ORC: segments.orcSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    title: "CSU_C09.COMMON_ORDER",
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.COMMON_ORDER group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the CSU_C09.COMMON_ORDER schema
 */
export type CSU_C09_COMMON_ORDER = z.infer<typeof csuC09CommonOrderSchema>;

/**
 * CSU_C09.RX_ADMIN group schema
 * Defines the structure and validation rules for the CSU_C09.RX_ADMIN group
 */
export const csuC09RxAdminSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.RX_ADMIN group",
    type: "Group"
  });
 ...
 */
export const csuC09StudyObservationSchema = z
  .object({
    STUDY_OBSERVATION_ORDER: csuC09StudyObservationOrderSchema.optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.STUDY_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const csuC09StudyPharmSchema = z
  .object({
    COMMON_ORDER: csuC09CommonOrderSchema.optional(),
    RX_ADMIN: z.array(csuC09RxAdminSchema)
  })
  .register(hl7v2Metadata, {
    title: "CSU_C09.STUDY_PHARM",
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.STUDY_PHARM group",
    type: "Group"
  });
 ...
 */
export const csuC09StudyScheduleSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.STUDY_SCHEDULE group",
    type: "Group"
  });
 ...
 */
export const csuC09StudyPhaseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.STUDY_PHASE group",
    type: "Group"
  });
 ...
 */
export const csuC09PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 CSU_C09.PATIENT group",
    type: "Group"
  });
...
export const csu_c09Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "CSU_C09",
    version: "2.8",
    description: "HL7 v2.8 CSU_C09 message",
    type: "Message"
  });
