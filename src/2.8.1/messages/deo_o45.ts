 ...
 */
export const deoO45DonorRegistrationSchema = z
  .object({
 ...
 */
export const deoO45DonationObservationSchema = z
  .object({
 ...
 */
export const deoO45DonorSchema = z
  .object({
 ...
 */
export const deoO45DonationOrderSchema = z
  .object({
