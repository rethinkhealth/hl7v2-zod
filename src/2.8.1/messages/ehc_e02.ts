...
/**
 * HL7 v2.8 EHC_E02 Message
 *
 * HL7 v2.8 EHC_E02 message definition
...
export const ehcE02PsgSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E02.PSG",
    version: "2.8",
    description: "HL7 v2.8 EHC_E02.PSG group",
    type: "Group"
  });
...
export const ehcE02ProductServiceSectionSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 EHC_E02.PRODUCT_SERVICE_SECTION group",
    type: "Group"
  });
 ...
 */
export const ehcE02InvoiceInformationCancelSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 EHC_E02.INVOICE_INFORMATION_CANCEL group",
    type: "Group"
  });
 ...
 */
export type EHC_E02_INVOICE_INFORMATION_CANCEL = z.infer<
  typeof ehcE02InvoiceInformationCancelSchema
>;
...
export const ehc_e02Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "EHC_E02",
    version: "2.8",
    description: "HL7 v2.8 EHC_E02 message",
    type: "Message"
  });
