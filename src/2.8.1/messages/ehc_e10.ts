...
/**
 * HL7 v2.8 EHC_E10 Message
 * 
 * HL7 v2.8 EHC_E10 message definition
...
export const ehcE10ProductServiceLineInfoSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E10.PRODUCT_SERVICE_LINE_INFO group",
  type: "Group"
});
...
export const ehcE10ProductServiceGroupSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E10.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
...
export const ehcE10ProductServiceSectionSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E10.PRODUCT_SERVICE_SECTION group",
  type: "Group"
});
...
export const ehcE10InvoiceProcessingResultsInfoSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E10.INVOICE_PROCESSING_RESULTS_INFO group",
  type: "Group"
});
...
export const ehc_e10Schema = z.object({
  ...
  title: "EHC_E10",
  version: "2.8",
  description: "HL7 v2.8 EHC_E10 message",
  type: "Message"
});
