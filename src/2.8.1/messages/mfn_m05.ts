...
/**
 * HL7 v2.8 MFN_M05 Message
 *
 * HL7 v2.8 MFN_M05 message definition
 ...
 */
export const mfnM05MfLocDeptSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 MFN_M05.MF_LOC_DEPT group",
    type: "Group"
  });
 ...
 */
export const mfnM05MfLocationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 MFN_M05.MF_LOCATION group",
    type: "Group"
  });
...
export const mfn_m05Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "MFN_M05",
    version: "2.8",
    description: "HL7 v2.8 MFN_M05 message",
    type: "Message"
  });
