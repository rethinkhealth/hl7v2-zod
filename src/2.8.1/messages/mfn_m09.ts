...
/**
 * HL7 v2.8 MFN_M09 Message
 *
 * HL7 v2.8 MFN_M09 message definition
...
export const mfnM09MfTestCatDetailSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 MFN_M09.MF_TEST_CAT_DETAIL group",
    type: "Group"
  });
...
export const mfnM09MfTestCategoricalSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 MFN_M09.MF_TEST_CATEGORICAL group",
    type: "Group"
  });
...
export const mfn_m09Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "MFN_M09",
    version: "2.8",
    description: "HL7 v2.8 MFN_M09 message",
    type: "Message"
  });
