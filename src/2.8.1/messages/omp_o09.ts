...
/**
 * HL7 v2.8 OMP_O09 Message
 *
 * HL7 v2.8 OMP_O09 message definition
 ...
 */
export const ompO09AdditionalDemographicsSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.ADDITIONAL_DEMOGRAPHICS group",
    type: "Group"
  });
 ...
 */
export const ompO09PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const ompO09InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const ompO09TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.TIMING group",
    type: "Group"
  });
 ...
 */
export const ompO09ComponentSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.COMPONENT group",
    type: "Group"
  });
 ...
 */
export const ompO09ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const ompO09PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.PATIENT group",
    type: "Group"
  });
 ...
 */
export const ompO09OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "OMP_O09.ORDER",
    version: "2.8",
    description: "HL7 v2.8 OMP_O09.ORDER group",
    type: "Group"
  });
...
export const omp_o09Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "OMP_O09",
    version: "2.8",
    description: "HL7 v2.8 OMP_O09 message",
    type: "Message"
  });
