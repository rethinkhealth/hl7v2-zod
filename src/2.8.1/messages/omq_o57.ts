 ...
 */
export const omqO57PatientVisitSchema = z
  .object({
 ...
 */
export const omqO57InsuranceSchema = z
  .object({
...
/**
 * OMQ_O57.ORDER_DOCUMENT group schema
 * Defines the structure and validation rules for the OMQ_O57.ORDER_DOCUMENT group
 */
export const omqO57OrderDocumentSchema = z
  .object({
    SGH: segments.sghSchema,
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
    TXA: segments.txaSchema.optional(),
    NTE: z.array(segments.nteSchema).optional(),
    SGT: segments.sgtSchema
  })
  .register(hl7v2Metadata, {
    title: "OMQ_O57.ORDER_DOCUMENT",
    version: "2.8",
    description: "HL7 v2.8 OMQ_O57.ORDER_DOCUMENT group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the OMQ_O57.ORDER_DOCUMENT schema
 */
export type OMQ_O57_ORDER_DOCUMENT = z.infer<typeof omqO57OrderDocumentSchema>;

/**
 * OMQ_O57.OBSERVATION group schema
 * Defines the structure and validation rules for the OMQ_O57.OBSERVATION group
 */
export const omqO57ObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
    NTE: z.array(segments.nteSchema).optional()
 ...
 */
export const omqO57PatientPriorSchema = z
  .object({
 ...
 */
export const omqO57PatientVisitPriorSchema = z
  .object({
    PV1: segments.pv1Schema,
    PV2: segments.pv2Schema.optional(),
    PRT: z.array(segments.prtSchema).optional()
 ...
 */
export const omqO57TimingPriorSchema = z
  .object({
 ...
 */
export const omqO57ObservationPriorSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
    NTE: z.array(segments.nteSchema).optional()
 ...
 */
export const omqO57PatientSchema = z
  .object({
    PID: segments.pidSchema,
    PD1: segments.pd1Schema.optional(),
    PRT: z.array(segments.prtSchema).optional(),
 ...
 */
export const omqO57OrderPriorSchema = z
  .object({
 ...
 */
export const omqO57PriorResultSchema = z
  .object({
 ...
 */
export const omqO57OrderSchema = z
  .object({
    ORC: segments.orcSchema,
    PRT: z.array(segments.prtSchema).optional(),
    OBX: segments.obxSchema,
    ...
    ORDER_DOCUMENT: z.array(omqO57OrderDocumentSchema).optional(),
