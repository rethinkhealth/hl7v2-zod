 ...
 */
export const orlO41PatientSchema = z
  .object({
 ...
 */
export const orlO41TimingSchema = z
  .object({
 ...
 */
export const orlO41SpecimenSchema = z
  .object({
 ...
 */
export const orlO41ObservationRequestSchema = z
  .object({
 ...
 */
export const orlO41OrderSchema = z
  .object({
 ...
 */
export const orlO41ResponseSchema = z
  .object({
