 ...
 */
export const orlO42PatientSchema = z
  .object({
 ...
 */
export const orlO42SpecimenObservationSchema = z
  .object({
 ...
 */
export const orlO42TimingSchema = z
  .object({
 ...
 */
export const orlO42ObservationRequestSchema = z
  .object({
 ...
 */
export const orlO42OrderSchema = z
  .object({
 ...
 */
export const orlO42SpecimenSchema = z
  .object({
 ...
 */
export const orlO42ResponseSchema = z
  .object({
