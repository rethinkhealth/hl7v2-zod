 ...
 */
export const orlO44PatientSchema = z.object({
 ...
 */
export const orlO44TimingSchema = z.object({
 ...
 */
export const orlO44SpecimenContainerInPackageSchema = z.object({
 ...
 */
export type ORL_O44_SPECIMEN_CONTAINER_IN_PACKAGE = z.infer<typeof orlO44SpecimenContainerInPackageSchema>;
 ...
 */
export const orlO44SpecimenInPackageSchema = z.object({
 ...
 */
export const orlO44PackageSchema = z.object({
 ...
 */
export const orlO44SpecimenShipmentSchema = z.object({
 ...
 */
export const orlO44ObservationRequestSchema = z.object({
 ...
 */
export const orlO44OrderSchema = z.object({
 ...
 */
export const orlO44ResponseSchema = z.object({
 ...
 */
export const orl_o44Schema = z.object({
