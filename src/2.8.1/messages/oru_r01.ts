...
/**
 * HL7 v2.8 ORU_R01 Message
 *
 * HL7 v2.8 ORU_R01 message definition
 ...
 */
export const oruR01PatientObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.PATIENT_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const oruR01VisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "ORU_R01.VISIT",
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.VISIT group",
    type: "Group"
  });
 ...
 */
export const oruR01OrderDocumentSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.ORDER_DOCUMENT group",
    type: "Group"
  });
 ...
 */
export const oruR01TimingQtySchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.TIMING_QTY group",
    type: "Group"
  });
 ...
 */
export const oruR01ObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const oruR01SpecimenObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.SPECIMEN_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const oruR01PatientSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.PATIENT group",
    type: "Group"
  });
 ...
 */
export const oruR01CommonOrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.COMMON_ORDER group",
    type: "Group"
  });
 ...
 */
export const oruR01SpecimenSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.SPECIMEN group",
    type: "Group"
  });
 ...
 */
export const oruR01OrderObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.ORDER_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const oruR01PatientResultSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORU_R01.PATIENT_RESULT group",
    type: "Group"
  });
...
export const oru_r01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORU_R01",
    version: "2.8",
    description: "HL7 v2.8 ORU_R01 message",
    type: "Message"
  });
