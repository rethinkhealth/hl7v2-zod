...
/**
 * HL7 v2.8 ORU_R30 Message
 * 
 * HL7 v2.8 ORU_R30 message definition
...
export const oruR30PatientObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORU_R30.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const oruR30VisitSchema = z.object({
  ...
  title: "ORU_R30.VISIT",
  version: "2.8",
  description: "HL7 v2.8 ORU_R30.VISIT group",
  type: "Group"
});
...
export const oruR30TimingQtySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORU_R30.TIMING_QTY group",
  type: "Group"
});
...
export const oruR30ObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORU_R30.OBSERVATION group",
  type: "Group"
});
...
export const oru_r30Schema = z.object({
  ...
  title: "ORU_R30",
  version: "2.8",
  description: "HL7 v2.8 ORU_R30 message",
  type: "Message"
});
