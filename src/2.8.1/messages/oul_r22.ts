...
/**
 * HL7 v2.8 OUL_R22 Message
 * 
 * HL7 v2.8 OUL_R22 message definition
...
export const oulR22PatientObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const oulR22VisitSchema = z.object({
  ...
  title: "OUL_R22.VISIT",
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.VISIT group",
  type: "Group"
});
...
export const oulR22SpecimenObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const oulR22ContainerSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.CONTAINER group",
  type: "Group"
});
...
export const oulR22OrderDocumentSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.ORDER_DOCUMENT group",
  type: "Group"
});
...
export const oulR22TimingQtySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.TIMING_QTY group",
  type: "Group"
});
...
export const oulR22ResultSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.RESULT group",
  type: "Group"
});
...
export const oulR22PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.PATIENT group",
  type: "Group"
});
...
export const oulR22CommonOrderSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.COMMON_ORDER group",
  type: "Group"
});
...
export const oulR22OrderSchema = z.object({
  ...
  title: "OUL_R22.ORDER",
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.ORDER group",
  type: "Group"
});
...
export const oulR22SpecimenSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OUL_R22.SPECIMEN group",
  type: "Group"
});
...
export const oul_r22Schema = z.object({
  ...
  title: "OUL_R22",
  version: "2.8",
  description: "HL7 v2.8 OUL_R22 message",
  type: "Message"
});
