...
/**
 * HL7 v2.8 RQI_I01 Message
 *
 * HL7 v2.8 RQI_I01 message definition
 ...
 */
export const rqiI01ProviderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RQI_I01.PROVIDER group",
    type: "Group"
  });
 ...
 */
export const rqiI01InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RQI_I01.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const rqiI01GuarantorInsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RQI_I01.GUARANTOR_INSURANCE group",
    type: "Group"
  });
...
export const rqi_i01Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RQI_I01",
    version: "2.8",
    description: "HL7 v2.8 RQI_I01 message",
    type: "Message"
  });
