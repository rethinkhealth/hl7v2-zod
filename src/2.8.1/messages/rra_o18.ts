...
/**
 * HL7 v2.8 RRA_O18 Message
 * 
 * HL7 v2.8 RRA_O18 message definition
 ...
 */
export const rraO18PatientSchema = z.object({
  "PID": segments.pidSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RRA_O18.PATIENT",
  version: "2.8",
  description: "HL7 v2.8 RRA_O18.PATIENT group",
  type: "Group"
});
 ...
 */
export const rraO18TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RRA_O18.TIMING",
  version: "2.8",
  description: "HL7 v2.8 RRA_O18.TIMING group",
  type: "Group"
});
...
/**
 * RRA_O18.TREATMENT group schema
 * Defines the structure and validation rules for the RRA_O18.TREATMENT group
 */
export const rraO18TreatmentSchema = z.object({
  "RXA": segments.rxaSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "RRA_O18.TREATMENT",
  version: "2.8",
  description: "HL7 v2.8 RRA_O18.TREATMENT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the RRA_O18.TREATMENT schema
 */
export type RRA_O18_TREATMENT = z.infer<typeof rraO18TreatmentSchema>;

/**
 * RRA_O18.ADMINISTRATION group schema
 * Defines the structure and validation rules for the RRA_O18.ADMINISTRATION group
 */
export const rraO18AdministrationSchema = z.object({
  "TREATMENT": z.array(rraO18TreatmentSchema),
  "RXR": segments.rxrSchema
}).register(hl7v2Metadata, {
  title: "RRA_O18.ADMINISTRATION",
  version: "2.8",
  description: "HL7 v2.8 RRA_O18.ADMINISTRATION group",
  type: "Group"
});
 ...
 */
export const rraO18OrderSchema = z.object({
  ...
  title: "RRA_O18.ORDER",
  version: "2.8",
  description: "HL7 v2.8 RRA_O18.ORDER group",
  type: "Group"
});
 ...
 */
export const rra_o18Schema = z.object({
  ...
  title: "RRA_O18",
  version: "2.8",
  description: "HL7 v2.8 RRA_O18 message",
  type: "Message"
});
