...
/**
 * HL7 v2.8 RRI_I12 Message
 * 
 * HL7 v2.8 RRI_I12 message definition
...
/**
 * RRI_I12.AUTHORIZATION_CONTACT2 group schema
 * Defines the structure and validation rules for the RRI_I12.AUTHORIZATION_CONTACT2 group
 */
export const rriI12AuthorizationContact2Schema = z.object({
  "AUT": segments.autSchema,
  "CTD": segments.ctdSchema.optional()
}).register(hl7v2Metadata, {
  title: "RRI_I12.AUTHORIZATION_CONTACT2",
  version: "2.8",
  description: "HL7 v2.8 RRI_I12.AUTHORIZATION_CONTACT2 group",
  type: "Group"
});

/**
 * TypeScript type inferred from the RRI_I12.AUTHORIZATION_CONTACT2 schema
 */
export type RRI_I12_AUTHORIZATION_CONTACT2 = z.infer<typeof rriI12AuthorizationContact2Schema>;

/**
 * RRI_I12.PROVIDER_CONTACT group schema
 * Defines the structure and validation rules for the RRI_I12.PROVIDER_CONTACT group
 */
export const rriI12ProviderContactSchema = z.object({
  "PRD": segments.prdSchema,
  "CTD": z.array(segments.ctdSchema).optional()
}).register(hl7v2Metadata, {
  title: "RRI_I12.PROVIDER_CONTACT",
  version: "2.8",
  description: "HL7 v2.8 RRI_I12.PROVIDER_CONTACT group",
  type: "Group"
});
 ...
 */
export const rriI12ResultsNotesSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RRI_I12.RESULTS_NOTES group",
  type: "Group"
});
 ...
 */
export const rriI12PatientVisitSchema = z.object({
  "PV1": segments.pv1Schema,
  "PV2": segments.pv2Schema.optional()
}).register(hl7v2Metadata, {
  title: "RRI_I12.PATIENT_VISIT",
  version: "2.8",
  description: "HL7 v2.8 RRI_I12.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const rriI12ProcedureSchema = z.object({
  "PR1": segments.pr1Schema,
  "AUTHORIZATION_CONTACT2": rriI12AuthorizationContact2Schema.optional()
}).register(hl7v2Metadata, {
  title: "RRI_I12.PROCEDURE",
  version: "2.8",
  description: "HL7 v2.8 RRI_I12.PROCEDURE group",
  type: "Group"
});
 ...
 */
export const rriI12ObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RRI_I12.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rri_i12Schema = z.object({
  ...
  title: "RRI_I12",
  version: "2.8",
  description: "HL7 v2.8 RRI_I12 message",
  type: "Message"
});
