...
/**
 * HL7 v2.8 RSP_K11 Message
 * 
 * HL7 v2.8 RSP_K11 message definition
 ...
 */
export const rspK11SegmentPatternSchema = z.object({

}).register(hl7v2Metadata, {
  title: "RSP_K11.SEGMENT_PATTERN",
  version: "2.8",
  description: "HL7 v2.8 RSP_K11.SEGMENT_PATTERN group",
  type: "Group"
});
...
export const rsp_k11Schema = z.object({
  ...
  title: "RSP_K11",
  version: "2.8",
  description: "HL7 v2.8 RSP_K11 message",
  type: "Message"
});
