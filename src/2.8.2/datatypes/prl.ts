...
/**
 * HL7 v2.8 PRL Composite Data Type
 * 
 * HL7 v2.8 PRL composite data type
 ...
 */
export const PRL_2 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "PRL.2",
  "version": "2.8",
...
/**
 * PRL - HL7 v2.8 PRL composite data type
 * 
 * Components:
 * - PRL.1: Parent Observation Identifier (CWE)
 * - PRL.2: Parent Observation Sub-identifier (OG)
...
export const PRL = z.object({
  ...
  title: 'PRL',
  version: '2.8',
  description: 'HL7 v2.8 PRL composite data type'
});
