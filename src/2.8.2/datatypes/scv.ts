...
/**
 * HL7 v2.8 SCV Composite Data Type
 * 
 * HL7 v2.8 SCV composite data type
 ...
 */
export const SCV_2 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "SCV.2",
  "version": "2.8",
...
/**
 * SCV - HL7 v2.8 SCV composite data type
 * 
 * Components:
...
export const SCV = z.object({
  ...
  title: 'SCV',
  version: '2.8',
  description: 'HL7 v2.8 SCV composite data type'
});
