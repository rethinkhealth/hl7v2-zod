...
/**
 * HL7 v2.8 ADT_A60 Message
 * 
 * HL7 v2.8 ADT_A60 message definition
...
export const adtA60VisitSchema = z.object({
  ...
  title: "ADT_A60.VISIT",
  version: "2.8",
  description: "HL7 v2.8 ADT_A60.VISIT group",
  type: "Group"
});
...
export const adtA60AdverseReactionGroupSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ADT_A60.ADVERSE_REACTION_GROUP group",
  type: "Group"
});
...
export const adt_a60Schema = z.object({
  ...
  title: "ADT_A60",
  version: "2.8",
  description: "HL7 v2.8 ADT_A60 message",
  type: "Message"
});
