...
/**
 * HL7 v2.8 BRP_O30 Message
 * 
 * HL7 v2.8 BRP_O30 message definition
...
export const brpO30TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BRP_O30.TIMING group",
  type: "Group"
});
...
export const brpO30OrderSchema = z.object({
  ...
  title: "BRP_O30.ORDER",
  version: "2.8",
  description: "HL7 v2.8 BRP_O30.ORDER group",
  type: "Group"
});
...
export const brpO30PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BRP_O30.PATIENT group",
  type: "Group"
});
...
export const brpO30ResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BRP_O30.RESPONSE group",
  type: "Group"
});
...
export const brp_o30Schema = z.object({
  ...
  title: "BRP_O30",
  version: "2.8",
  description: "HL7 v2.8 BRP_O30 message",
  type: "Message"
});
