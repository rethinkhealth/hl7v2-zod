...
/**
 * HL7 v2.8 MFN_M06 Message
 * 
 * HL7 v2.8 MFN_M06 message definition
...
export const mfnM06MfPhaseSchedDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M06.MF_PHASE_SCHED_DETAIL group",
  type: "Group"
});
...
export const mfnM06MfClinStudySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M06.MF_CLIN_STUDY group",
  type: "Group"
});
...
export const mfn_m06Schema = z.object({
  ...
  title: "MFN_M06",
  version: "2.8",
  description: "HL7 v2.8 MFN_M06 message",
  type: "Message"
});
