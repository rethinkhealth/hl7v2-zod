...
/**
 * HL7 v2.8 MFN_M10 Message
 * 
 * HL7 v2.8 MFN_M10 message definition
...
export const mfnM10MfTestBattDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M10.MF_TEST_BATT_DETAIL group",
  type: "Group"
});
...
export const mfnM10MfTestBatteriesSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M10.MF_TEST_BATTERIES group",
  type: "Group"
});
...
export const mfn_m10Schema = z.object({
  ...
  title: "MFN_M10",
  version: "2.8",
  description: "HL7 v2.8 MFN_M10 message",
  type: "Message"
});
