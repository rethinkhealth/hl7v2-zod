...
/**
 * HL7 v2.8 MFN_M18 Message
 * 
 * HL7 v2.8 MFN_M18 message definition
...
export const mfnM18PayerMfCoverageSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M18.PAYER_MF_COVERAGE group",
  type: "Group"
});
...
export const mfnM18PayerMfEntrySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M18.PAYER_MF_ENTRY group",
  type: "Group"
});
...
export const mfnM18MfPayerSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MFN_M18.MF_PAYER group",
  type: "Group"
});
...
export const mfn_m18Schema = z.object({
  ...
  title: "MFN_M18",
  version: "2.8",
  description: "HL7 v2.8 MFN_M18 message",
  type: "Message"
});
