...
/**
 * HL7 v2.8 OML_O21 Message
 * 
 * HL7 v2.8 OML_O21 message definition
...
export const omlO21PatientVisitSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.PATIENT_VISIT group",
  type: "Group"
});
...
export const omlO21InsuranceSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.INSURANCE group",
  type: "Group"
});
...
export const omlO21TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.TIMING group",
  type: "Group"
});
...
export const omlO21ObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.OBSERVATION group",
  type: "Group"
});
...
export const omlO21SpecimenObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const omlO21ContainerObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.CONTAINER_OBSERVATION group",
  type: "Group"
});
...
export const omlO21PatientPriorSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.PATIENT_PRIOR group",
  type: "Group"
});
...
export const omlO21PatientVisitPriorSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.PATIENT_VISIT_PRIOR group",
  type: "Group"
});
...
export const omlO21TimingPriorSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.TIMING_PRIOR group",
  type: "Group"
});
...
export const omlO21ObservationPriorSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.OBSERVATION_PRIOR group",
  type: "Group"
});
...
export const omlO21PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.PATIENT group",
  type: "Group"
});
...
export const omlO21ContainerSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.CONTAINER group",
  type: "Group"
});
...
export const omlO21OrderPriorSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.ORDER_PRIOR group",
  type: "Group"
});
...
export const omlO21SpecimenSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.SPECIMEN group",
  type: "Group"
});
...
export const omlO21PriorResultSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.PRIOR_RESULT group",
  type: "Group"
});
...
export const omlO21ObservationRequestSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OML_O21.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const omlO21OrderSchema = z.object({
  ...
  title: "OML_O21.ORDER",
  version: "2.8",
  description: "HL7 v2.8 OML_O21.ORDER group",
  type: "Group"
});
...
export const oml_o21Schema = z.object({
  ...
  title: "OML_O21",
  version: "2.8",
  description: "HL7 v2.8 OML_O21 message",
  type: "Message"
});
