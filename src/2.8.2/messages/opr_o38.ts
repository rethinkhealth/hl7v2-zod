...
/**
 * HL7 v2.8 OPR_O38 Message
 * 
 * HL7 v2.8 OPR_O38 message definition
...
export const oprO38SpecimenObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPR_O38.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const oprO38ObservationRequestSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPR_O38.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const oprO38TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPR_O38.TIMING group",
  type: "Group"
});
...
export const oprO38SpecimenSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPR_O38.SPECIMEN group",
  type: "Group"
});
...
export const oprO38OrderSchema = z.object({
  ...
  title: "OPR_O38.ORDER",
  version: "2.8",
  description: "HL7 v2.8 OPR_O38.ORDER group",
  type: "Group"
});
...
export const oprO38ResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPR_O38.RESPONSE group",
  type: "Group"
});
...
export const opr_o38Schema = z.object({
  ...
  title: "OPR_O38",
  version: "2.8",
  description: "HL7 v2.8 OPR_O38 message",
  type: "Message"
});
