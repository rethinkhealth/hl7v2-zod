...
/**
 * HL7 v2.8 ORB_O28 Message
 * 
 * HL7 v2.8 ORB_O28 message definition
...
export const orbO28TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORB_O28.TIMING group",
  type: "Group"
});
...
export const orbO28OrderSchema = z.object({
  ...
  title: "ORB_O28.ORDER",
  version: "2.8",
  description: "HL7 v2.8 ORB_O28.ORDER group",
  type: "Group"
});
...
export const orbO28PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORB_O28.PATIENT group",
  type: "Group"
});
...
export const orbO28ResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORB_O28.RESPONSE group",
  type: "Group"
});
...
export const orb_o28Schema = z.object({
  ...
  title: "ORB_O28",
  version: "2.8",
  description: "HL7 v2.8 ORB_O28 message",
  type: "Message"
});
