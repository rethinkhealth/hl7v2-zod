...
/**
 * HL7 v2.8 OSM_R26 Message
 * 
 * HL7 v2.8 OSM_R26 message definition
 ...
 */
export const osmR26ShippingObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.SHIPPING_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.SHIPPING_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const osmR26SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.SPECIMEN_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.SPECIMEN_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const osmR26ContainerObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.CONTAINER_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.CONTAINER_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const osmR26PatientObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.PATIENT_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.PATIENT_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const osmR26PatientVisitObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.PATIENT_VISIT_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.PATIENT_VISIT_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const osmR26PatientInformationSchema = z.object({
  "PID": segments.pidSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.PATIENT_INFORMATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.PATIENT_INFORMATION group",
  type: "Group"
});
...
/**
 * OSM_R26.SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION group schema
 * Defines the structure and validation rules for the OSM_R26.SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION group
 */
export const osmR26SubjectPersonOrAnimalIdentificationSchema = z.object({
  "PID": segments.pidSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  ...
  title: "OSM_R26.SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OSM_R26.SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION schema
 */
export type OSM_R26_SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION = z.infer<typeof osmR26SubjectPersonOrAnimalIdentificationSchema>;

/**
 * OSM_R26.SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION group schema
 * Defines the structure and validation rules for the OSM_R26.SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION group
 */
export const osmR26SubjectPopulationOrLocationIdentificationSchema = z.object({
  ...
  title: "OSM_R26.SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OSM_R26.SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION schema
 */
export type OSM_R26_SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION = z.infer<typeof osmR26SubjectPopulationOrLocationIdentificationSchema>;

/**
 * OSM_R26.SPECIMEN group schema
 * Defines the structure and validation rules for the OSM_R26.SPECIMEN group
 */
export const osmR26SpecimenSchema = z.object({
  ...
  "SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION": osmR26SubjectPersonOrAnimalIdentificationSchema.optional(),
  "SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION": osmR26SubjectPopulationOrLocationIdentificationSchema.optional()
}).register(hl7v2Metadata, {
  title: "OSM_R26.SPECIMEN",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.SPECIMEN group",
  type: "Group"
});
 ...
 */
export const osmR26PackageSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.PACKAGE group",
  type: "Group"
});
 ...
 */
export const osmR26ShipmentSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OSM_R26.SHIPMENT group",
  type: "Group"
});
 ...
 */
export const osm_r26Schema = z.object({
  ...
  title: "OSM_R26",
  version: "2.8",
  description: "HL7 v2.8 OSM_R26 message",
  type: "Message"
});
