...
/**
 * HL7 v2.8 CF Composite Data Type
 *
 * HL7 v2.8 CF composite data type
 ...
 */
export const CF_3 = SimpleTypes.ID.max(12).optional().register(hl7v2Metadata, {
  title: "CF.3",
  version: "2.8",
 ...
 */
export const CF_6 = SimpleTypes.ID.max(12).optional().register(hl7v2Metadata, {
  title: "CF.6",
  version: "2.8",
 ...
 */
export const CF_12 = SimpleTypes.ID.max(12).optional().register(hl7v2Metadata, {
  title: "CF.12",
  version: "2.8",
...
/**
 * CF - HL7 v2.8 CF composite data type
 *
 * Components:
 * - CF.1: Identifier (ST)
...
export const CF = z
  ...
  .register(hl7v2Metadata, {
    title: "CF",
    version: "2.8",
    description: "HL7 v2.8 CF composite data type"
  });
