...
/**
 * HL7 v2.8 RCD Composite Data Type
 *
 * HL7 v2.8 RCD composite data type
 ...
 */
export const RCD_3 = SimpleTypes.NM.max(5).optional().register(hl7v2Metadata, {
  title: "RCD.3",
  version: "2.8",
...
/**
 * RCD - HL7 v2.8 RCD composite data type
 *
 * Components:
...
export const RCD = z
  ...
  .register(hl7v2Metadata, {
    title: "RCD",
    version: "2.8",
    description: "HL7 v2.8 RCD composite data type"
  });
