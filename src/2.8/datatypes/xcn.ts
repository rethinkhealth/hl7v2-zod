...
/**
 * HL7 v2.8 XCN Composite Data Type
 * 
 * HL7 v2.8 XCN composite data type
 ...
 */
export const XCN_10 = SimpleTypes.ID.max(5).optional().register(hl7v2Metadata, {
  "title": "XCN.10",
  "version": "2.8",
 ...
 */
export const XCN_25 = SimpleTypes.ID.max(3).optional().register(hl7v2Metadata, {
  "title": "XCN.25",
  "version": "2.8",
...
/**
 * XCN - HL7 v2.8 XCN composite data type
 * 
 * Components:
...
export const XCN = z.object({
  ...
  title: 'XCN',
  version: '2.8',
  description: 'HL7 v2.8 XCN composite data type'
});
