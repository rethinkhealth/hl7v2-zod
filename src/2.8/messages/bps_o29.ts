...
/**
 * HL7 v2.8 BPS_O29 Message
 * 
 * HL7 v2.8 BPS_O29 message definition
 ...
 */
export const bpsO29PatientVisitSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BPS_O29.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const bpsO29TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "BPS_O29.TIMING",
  version: "2.8",
  description: "HL7 v2.8 BPS_O29.TIMING group",
  type: "Group"
});
 ...
 */
export const bpsO29ProductSchema = z.object({
  "BPX": segments.bpxSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "BPS_O29.PRODUCT",
  version: "2.8",
  description: "HL7 v2.8 BPS_O29.PRODUCT group",
  type: "Group"
});
 ...
 */
export const bpsO29PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BPS_O29.PATIENT group",
  type: "Group"
});
 ...
 */
export const bpsO29OrderSchema = z.object({
  ...
  title: "BPS_O29.ORDER",
  version: "2.8",
  description: "HL7 v2.8 BPS_O29.ORDER group",
  type: "Group"
});
 ...
 */
export const bps_o29Schema = z.object({
  ...
  title: "BPS_O29",
  version: "2.8",
  description: "HL7 v2.8 BPS_O29 message",
  type: "Message"
});
