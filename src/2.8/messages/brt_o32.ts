...
/**
 * HL7 v2.8 BRT_O32 Message
 * 
 * HL7 v2.8 BRT_O32 message definition
...
export const brtO32TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BRT_O32.TIMING group",
  type: "Group"
});
...
export const brtO32OrderSchema = z.object({
  ...
  title: "BRT_O32.ORDER",
  version: "2.8",
  description: "HL7 v2.8 BRT_O32.ORDER group",
  type: "Group"
});
...
export const brtO32ResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BRT_O32.RESPONSE group",
  type: "Group"
});
...
export const brt_o32Schema = z.object({
  ...
  title: "BRT_O32",
  version: "2.8",
  description: "HL7 v2.8 BRT_O32 message",
  type: "Message"
});
