...
/**
 * HL7 v2.8 BTS_O31 Message
 * 
 * HL7 v2.8 BTS_O31 message definition
...
export const btsO31PatientVisitSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BTS_O31.PATIENT_VISIT group",
  type: "Group"
});
...
export const btsO31TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BTS_O31.TIMING group",
  type: "Group"
});
...
export const btsO31ProductStatusSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BTS_O31.PRODUCT_STATUS group",
  type: "Group"
});
...
export const btsO31PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 BTS_O31.PATIENT group",
  type: "Group"
});
...
export const btsO31OrderSchema = z.object({
  ...
  title: "BTS_O31.ORDER",
  version: "2.8",
  description: "HL7 v2.8 BTS_O31.ORDER group",
  type: "Group"
});
...
export const bts_o31Schema = z.object({
  ...
  title: "BTS_O31",
  version: "2.8",
  description: "HL7 v2.8 BTS_O31 message",
  type: "Message"
});
