 ...
 */
export const cciI22ResourceObservationSchema = z
  .object({
 ...
 */
export const cciI22ClinicalHistoryObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCI_I22_CLINICAL_HISTORY_OBSERVATION = z.infer<
  typeof cciI22ClinicalHistoryObservationSchema
>;
 ...
 */
export const cciI22MedicationOrderObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCI_I22_MEDICATION_ORDER_OBSERVATION = z.infer<
  typeof cciI22MedicationOrderObservationSchema
>;
 ...
 */
export const cciI22MedicationEncodingObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCI_I22_MEDICATION_ENCODING_OBSERVATION = z.infer<
  typeof cciI22MedicationEncodingObservationSchema
>;
 ...
 */
export const cciI22MedicationAdministrationObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION = z.infer<
  typeof cciI22MedicationAdministrationObservationSchema
>;
 ...
 */
export const cciI22ProblemObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const cciI22GoalObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const cciI22PathwayObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
...
export const cciI22MedicationAdministrationDetailSchema = z
  .object({
    ...
    MEDICATION_ADMINISTRATION_OBSERVATION: z
      .array(cciI22MedicationAdministrationObservationSchema)
      .optional()
  })
  .register(hl7v2Metadata, {
