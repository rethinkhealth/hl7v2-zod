 ...
 */
export const ccrI16ClinicalOrderObservationSchema = z
  .object({
 ...
 */
export type CCR_I16_CLINICAL_ORDER_OBSERVATION = z.infer<
  typeof ccrI16ClinicalOrderObservationSchema
>;
 ...
 */
export const ccrI16ResourceObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const ccrI16ClinicalHistoryObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCR_I16_CLINICAL_HISTORY_OBSERVATION = z.infer<
  typeof ccrI16ClinicalHistoryObservationSchema
>;
 ...
 */
export const ccrI16MedicationOrderObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCR_I16_MEDICATION_ORDER_OBSERVATION = z.infer<
  typeof ccrI16MedicationOrderObservationSchema
>;
 ...
 */
export const ccrI16MedicationEncodingObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCR_I16_MEDICATION_ENCODING_OBSERVATION = z.infer<
  typeof ccrI16MedicationEncodingObservationSchema
>;
 ...
 */
export const ccrI16MedicationAdministrationObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export type CCR_I16_MEDICATION_ADMINISTRATION_OBSERVATION = z.infer<
  typeof ccrI16MedicationAdministrationObservationSchema
>;
 ...
 */
export const ccrI16RoleObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const ccrI16GoalObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
 ...
 */
export const ccrI16PathwayObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
...
export const ccrI16MedicationAdministrationDetailSchema = z
  .object({
    ...
    MEDICATION_ADMINISTRATION_OBSERVATION: z
      .array(ccrI16MedicationAdministrationObservationSchema)
      .optional()
  })
  .register(hl7v2Metadata, {
