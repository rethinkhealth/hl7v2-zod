...
/**
 * HL7 v2.8 CCU_I20 Message
 * 
 * HL7 v2.8 CCU_I20 message definition
...
export const ccuI20ProviderContactSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PROVIDER_CONTACT group",
  type: "Group"
});
...
export const ccuI20PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PATIENT group",
  type: "Group"
});
...
export const ccuI20InsuranceSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.INSURANCE group",
  type: "Group"
});
...
export const ccuI20ResourceObjectSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.RESOURCE_OBJECT group",
  type: "Group"
});
...
export const ccuI20ResourceObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.RESOURCE_OBSERVATION group",
  type: "Group"
});
...
export const ccuI20ClinicalHistoryObjectSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});
...
export const ccuI20ClinicalHistoryObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.CLINICAL_HISTORY_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccuI20RoleClinicalHistoryObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_CLINICAL_HISTORY_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});
 ...
 */
export type CCU_I20_ROLE_CLINICAL_HISTORY_OBJECT = z.infer<typeof ccuI20RoleClinicalHistoryObjectSchema>;
...
export const ccuI20PatientVisitsSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PATIENT_VISITS group",
  type: "Group"
});
...
export const ccuI20MedicationOrderObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_ORDER_OBSERVATION group",
  type: "Group"
});
...
export const ccuI20MedicationEncodingObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_ENCODING_OBSERVATION group",
  type: "Group"
});
...
export const ccuI20MedicationAdministrationObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_ADMINISTRATION_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccuI20RoleProblemObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_PROBLEM_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_PROBLEM_OBJECT group",
  type: "Group"
});
...
export const ccuI20ProblemObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PROBLEM_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccuI20RoleGoalObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_GOAL_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_GOAL_OBJECT group",
  type: "Group"
});
...
export const ccuI20GoalObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.GOAL_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const ccuI20RolePathwayObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_PATHWAY_OBJECT",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_PATHWAY_OBJECT group",
  type: "Group"
});
...
export const ccuI20PathwayObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PATHWAY_OBSERVATION group",
  type: "Group"
});
...
export const ccuI20ResourceDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.RESOURCE_DETAIL group",
  type: "Group"
});
...
export const ccuI20ClinicalHistoryDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.CLINICAL_HISTORY_DETAIL group",
  type: "Group"
});
 ...
 */
export const ccuI20RoleClinicalHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_CLINICAL_HISTORY group",
  type: "Group"
});
...
export const ccuI20MedicationOrderDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_ORDER_DETAIL group",
  type: "Group"
});
...
export const ccuI20MedicationEncodingDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_ENCODING_DETAIL group",
  type: "Group"
});
...
export const ccuI20MedicationAdministrationDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_ADMINISTRATION_DETAIL group",
  type: "Group"
});
 ...
 */
export const ccuI20RoleProblemSchema = z.object({
  "ROLE_PROBLEM_OBJECT": ccuI20RoleProblemObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_PROBLEM",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_PROBLEM group",
  type: "Group"
});
 ...
 */
export const ccuI20RoleGoalSchema = z.object({
  "ROLE_GOAL_OBJECT": ccuI20RoleGoalObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_GOAL",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_GOAL group",
  type: "Group"
});
 ...
 */
export const ccuI20RolePathwaySchema = z.object({
  "ROLE_PATHWAY_OBJECT": ccuI20RolePathwayObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCU_I20.ROLE_PATHWAY",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.ROLE_PATHWAY group",
  type: "Group"
});
...
export const ccuI20ResourcesSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.RESOURCES group",
  type: "Group"
});
...
export const ccuI20ClinicalHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.CLINICAL_HISTORY group",
  type: "Group"
});
...
export const ccuI20MedicationHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.MEDICATION_HISTORY group",
  type: "Group"
});
...
export const ccuI20ProblemSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PROBLEM group",
  type: "Group"
});
...
export const ccuI20GoalSchema = z.object({
  ...
  title: "CCU_I20.GOAL",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.GOAL group",
  type: "Group"
});
...
export const ccuI20PathwaySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.PATHWAY group",
  type: "Group"
});
...
export const ccuI20AppointmentHistorySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 CCU_I20.APPOINTMENT_HISTORY group",
  type: "Group"
});
...
export const ccu_i20Schema = z.object({
  ...
  title: "CCU_I20",
  version: "2.8",
  description: "HL7 v2.8 CCU_I20 message",
  type: "Message"
});
