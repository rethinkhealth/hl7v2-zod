...
/**
 * HL7 v2.8 DEL_O46 Message
 *
 * HL7 v2.8 DEL_O46 message definition
 ...
 */
export const delO46DonorRegistrationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 DEL_O46.DONOR_REGISTRATION group",
    type: "Group"
  });
 ...
 */
export const delO46DonorSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "DEL_O46.DONOR",
    version: "2.8",
    description: "HL7 v2.8 DEL_O46.DONOR group",
    type: "Group"
  });
...
export const del_o46Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "DEL_O46",
    version: "2.8",
    description: "HL7 v2.8 DEL_O46 message",
    type: "Message"
  });
