 ...
 */
export const derO44DonorRegistrationSchema = z
  .object({
 ...
 */
export const derO44DonorOrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 DER_O44.DONOR_ORDER group",
    type: "Group"
  });
 ...
 */
export const derO44DonorSchema = z
  .object({
