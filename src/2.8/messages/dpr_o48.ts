...
/**
 * HL7 v2.8 DPR_O48 Message
 *
 * HL7 v2.8 DPR_O48 message definition
 ...
 */
export const dprO48DonorRegistrationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 DPR_O48.DONOR_REGISTRATION group",
    type: "Group"
  });
 ...
 */
export const dprO48DonationOrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 DPR_O48.DONATION_ORDER group",
    type: "Group"
  });
 ...
 */
export const dprO48BloodUnitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 DPR_O48.BLOOD_UNIT group",
    type: "Group"
  });
 ...
 */
export const dprO48DonorSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "DPR_O48.DONOR",
    version: "2.8",
    description: "HL7 v2.8 DPR_O48.DONOR group",
    type: "Group"
  });
 ...
 */
export const dprO48DonationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 DPR_O48.DONATION group",
    type: "Group"
  });
...
export const dpr_o48Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "DPR_O48",
    version: "2.8",
    description: "HL7 v2.8 DPR_O48 message",
    type: "Message"
  });
