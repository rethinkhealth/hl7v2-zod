...
/**
 * HL7 v2.8 EAC_U07 Message
 * 
 * HL7 v2.8 EAC_U07 message definition
...
export const eacU07SpecimenContainerSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EAC_U07.SPECIMEN_CONTAINER group",
  type: "Group"
});
...
export const eacU07CommandSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EAC_U07.COMMAND group",
  type: "Group"
});
...
export const eac_u07Schema = z.object({
  ...
  title: "EAC_U07",
  version: "2.8",
  description: "HL7 v2.8 EAC_U07 message",
  type: "Message"
});
