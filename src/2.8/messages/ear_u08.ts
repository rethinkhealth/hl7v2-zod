...
/**
 * HL7 v2.8 EAR_U08 Message
 *
 * HL7 v2.8 EAR_U08 message definition
 ...
 */
export const earU08SpecimenContainerSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 EAR_U08.SPECIMEN_CONTAINER group",
    type: "Group"
  });
 ...
 */
export const earU08CommandResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 EAR_U08.COMMAND_RESPONSE group",
    type: "Group"
  });
...
export const ear_u08Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "EAR_U08",
    version: "2.8",
    description: "HL7 v2.8 EAR_U08 message",
    type: "Message"
  });
