...
/**
 * HL7 v2.8 EHC_E01 Message
 * 
 * HL7 v2.8 EHC_E01 message definition
 ...
 */
export const ehcE01InsuranceSchema = z.object({
  "IN1": segments.in1Schema,
  "IN2": segments.in2Schema.optional()
}).register(hl7v2Metadata, {
  title: "EHC_E01.INSURANCE",
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.INSURANCE group",
  type: "Group"
});
 ...
 */
export const ehcE01DiagnosisSchema = z.object({
  "DG1": segments.dg1Schema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "EHC_E01.DIAGNOSIS",
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.DIAGNOSIS group",
  type: "Group"
});
 ...
 */
export const ehcE01ProductServiceLineItemSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.PRODUCT_SERVICE_LINE_ITEM group",
  type: "Group"
});
 ...
 */
export const ehcE01ProcedureSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.PROCEDURE group",
  type: "Group"
});
 ...
 */
export const ehcE01PatientInfoSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.PATIENT_INFO group",
  type: "Group"
});
 ...
 */
export const ehcE01ProductServiceGroupSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
...
/**
 * EHC_E01.INVOICE_INFORMATION_SUBMIT group schema
 * Defines the structure and validation rules for the EHC_E01.INVOICE_INFORMATION_SUBMIT group
 */
export const ehcE01InvoiceInformationSubmitSchema = z.object({
  ...
  title: "EHC_E01.INVOICE_INFORMATION_SUBMIT",
  version: "2.8",
  description: "HL7 v2.8 EHC_E01.INVOICE_INFORMATION_SUBMIT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the EHC_E01.INVOICE_INFORMATION_SUBMIT schema
 */
export type EHC_E01_INVOICE_INFORMATION_SUBMIT = z.infer<typeof ehcE01InvoiceInformationSubmitSchema>;

/**
 * EHC_E01 message schema
 * Defines the structure and validation rules for the EHC_E01 message
 */
export const ehc_e01Schema = z.object({
  "MSH": segments.mshSchema,
  "SFT": z.array(segments.sftSchema).optional(),
  "UAC": z.array(segments.uacSchema).optional(),
  "INVOICE_INFORMATION_SUBMIT": ehcE01InvoiceInformationSubmitSchema
}).register(hl7v2Metadata, {
  title: "EHC_E01",
  version: "2.8",
  description: "HL7 v2.8 EHC_E01 message",
  type: "Message"
});
