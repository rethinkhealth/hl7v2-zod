...
/**
 * HL7 v2.8 EHC_E13 Message
 * 
 * HL7 v2.8 EHC_E13 message definition
...
export const ehcE13ResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E13.RESPONSE group",
  type: "Group"
});
...
export const ehcE13RequestSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 EHC_E13.REQUEST group",
  type: "Group"
});
...
export const ehc_e13Schema = z.object({
  ...
  title: "EHC_E13",
  version: "2.8",
  description: "HL7 v2.8 EHC_E13 message",
  type: "Message"
});
