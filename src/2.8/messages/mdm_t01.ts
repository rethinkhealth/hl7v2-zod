...
/**
 * HL7 v2.8 MDM_T01 Message
 * 
 * HL7 v2.8 MDM_T01 message definition
 ...
 */
export const mdmT01TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "MDM_T01.TIMING",
  version: "2.8",
  description: "HL7 v2.8 MDM_T01.TIMING group",
  type: "Group"
});
 ...
 */
export const mdmT01CommonOrderSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 MDM_T01.COMMON_ORDER group",
  type: "Group"
});
 ...
 */
export const mdm_t01Schema = z.object({
  ...
  title: "MDM_T01",
  version: "2.8",
  description: "HL7 v2.8 MDM_T01 message",
  type: "Message"
});
