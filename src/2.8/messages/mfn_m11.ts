...
/**
 * HL7 v2.8 MFN_M11 Message
 *
 * HL7 v2.8 MFN_M11 message definition
...
export const mfnM11MfTestCalcDetailSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 MFN_M11.MF_TEST_CALC_DETAIL group",
    type: "Group"
  });
...
export const mfnM11MfTestCalculatedSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 MFN_M11.MF_TEST_CALCULATED group",
    type: "Group"
  });
...
export const mfn_m11Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "MFN_M11",
    version: "2.8",
    description: "HL7 v2.8 MFN_M11 message",
    type: "Message"
  });
