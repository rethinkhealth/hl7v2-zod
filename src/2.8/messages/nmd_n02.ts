...
/**
 * HL7 v2.8 NMD_N02 Message
 *
 * HL7 v2.8 NMD_N02 message definition
...
export const nmdN02ClockSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "NMD_N02.CLOCK",
    version: "2.8",
    description: "HL7 v2.8 NMD_N02.CLOCK group",
    type: "Group"
  });
...
export const nmdN02AppStatsSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 NMD_N02.APP_STATS group",
    type: "Group"
  });
...
export const nmdN02AppStatusSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 NMD_N02.APP_STATUS group",
    type: "Group"
  });
...
export const nmdN02ClockAndStatsWithNotesSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 NMD_N02.CLOCK_AND_STATS_WITH_NOTES group",
    type: "Group"
  });
...
export const nmd_n02Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "NMD_N02",
    version: "2.8",
    description: "HL7 v2.8 NMD_N02 message",
    type: "Message"
  });
