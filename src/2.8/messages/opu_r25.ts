...
/**
 * HL7 v2.8 OPU_R25 Message
 * 
 * HL7 v2.8 OPU_R25 message definition
 ...
 */
export const opuR25PatientVisitObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.PATIENT_VISIT_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const opuR25PatientObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.PATIENT_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const opuR25SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.SPECIMEN_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const opuR25ContainerSchema = z.object({
  "SAC": segments.sacSchema,
  "INV": segments.invSchema.optional()
}).register(hl7v2Metadata, {
  title: "OPU_R25.CONTAINER",
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.CONTAINER group",
  type: "Group"
});
...
/**
 * OPU_R25.COMMON_ORDER group schema
 * Defines the structure and validation rules for the OPU_R25.COMMON_ORDER group
 */
export const opuR25CommonOrderSchema = z.object({
  "ORC": segments.orcSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OPU_R25.COMMON_ORDER",
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.COMMON_ORDER group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OPU_R25.COMMON_ORDER schema
 */
export type OPU_R25_COMMON_ORDER = z.infer<typeof opuR25CommonOrderSchema>;

/**
 * OPU_R25.TIMING_QTY group schema
 * Defines the structure and validation rules for the OPU_R25.TIMING_QTY group
 */
export const opuR25TimingQtySchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "OPU_R25.TIMING_QTY",
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.TIMING_QTY group",
  type: "Group"
});
 ...
 */
export const opuR25ResultSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.RESULT group",
  type: "Group"
});
 ...
 */
export const opuR25PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.PATIENT group",
  type: "Group"
});
 ...
 */
export const opuR25OrderSchema = z.object({
  "OBR": segments.obrSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "COMMON_ORDER": opuR25CommonOrderSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  ...
  title: "OPU_R25.ORDER",
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.ORDER group",
  type: "Group"
});
 ...
 */
export const opuR25SpecimenSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.SPECIMEN group",
  type: "Group"
});
 ...
 */
export const opuR25AccessionDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 OPU_R25.ACCESSION_DETAIL group",
  type: "Group"
});
 ...
 */
export const opu_r25Schema = z.object({
  ...
  title: "OPU_R25",
  version: "2.8",
  description: "HL7 v2.8 OPU_R25 message",
  type: "Message"
});
