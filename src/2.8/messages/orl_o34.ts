...
/**
 * HL7 v2.8 ORL_O34 Message
 * 
 * HL7 v2.8 ORL_O34 message definition
...
/**
 * ORL_O34.SPECIMEN_OBSERVATION group schema
 * Defines the structure and validation rules for the ORL_O34.SPECIMEN_OBSERVATION group
 */
export const orlO34SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORL_O34.SPECIMEN_OBSERVATION",
  version: "2.8",
  description: "HL7 v2.8 ORL_O34.SPECIMEN_OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORL_O34.SPECIMEN_OBSERVATION schema
 */
export type ORL_O34_SPECIMEN_OBSERVATION = z.infer<typeof orlO34SpecimenObservationSchema>;
...
export const orlO34TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORL_O34.TIMING group",
  type: "Group"
});
...
export const orlO34ObservationRequestSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORL_O34.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const orlO34OrderSchema = z.object({
  ...
  title: "ORL_O34.ORDER",
  version: "2.8",
  description: "HL7 v2.8 ORL_O34.ORDER group",
  type: "Group"
});
...
export const orlO34SpecimenSchema = z.object({
  ...
  "SPECIMEN_OBSERVATION": z.array(orlO34SpecimenObservationSchema).optional(),
  "SAC": z.array(segments.sacSchema).optional(),
  "ORDER": z.array(orlO34OrderSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORL_O34.SPECIMEN",
  version: "2.8",
  description: "HL7 v2.8 ORL_O34.SPECIMEN group",
  type: "Group"
});
...
export const orlO34ResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 ORL_O34.RESPONSE group",
  type: "Group"
});
...
export const orl_o34Schema = z.object({
  ...
  title: "ORL_O34",
  version: "2.8",
  description: "HL7 v2.8 ORL_O34 message",
  type: "Message"
});
