...
/**
 * HL7 v2.8 ORL_O36 Message
 *
 * HL7 v2.8 ORL_O36 message definition
...
/**
 * ORL_O36.SPECIMEN_OBSERVATION group schema
 * Defines the structure and validation rules for the ORL_O36.SPECIMEN_OBSERVATION group
 */
export const orlO36SpecimenObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional()
  })
  .register(hl7v2Metadata, {
    title: "ORL_O36.SPECIMEN_OBSERVATION",
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.SPECIMEN_OBSERVATION group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the ORL_O36.SPECIMEN_OBSERVATION schema
 */
export type ORL_O36_SPECIMEN_OBSERVATION = z.infer<typeof orlO36SpecimenObservationSchema>;

/**
 * ORL_O36.TIMING group schema
 * Defines the structure and validation rules for the ORL_O36.TIMING group
 */
export const orlO36TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.TIMING group",
    type: "Group"
  });
 ...
 */
export const orlO36ObservationRequestSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.OBSERVATION_REQUEST group",
    type: "Group"
  });
 ...
 */
export const orlO36OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O36.ORDER",
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.ORDER group",
    type: "Group"
  });
 ...
 */
export const orlO36SpecimenContainerSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.SPECIMEN_CONTAINER group",
    type: "Group"
  });
 ...
 */
export const orlO36SpecimenSchema = z
  .object({
    SPM: segments.spmSchema,
    SPECIMEN_OBSERVATION: z.array(orlO36SpecimenObservationSchema).optional(),
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.SPECIMEN group",
    type: "Group"
  });
 ...
 */
export const orlO36ResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 ORL_O36.RESPONSE group",
    type: "Group"
  });
...
export const orl_o36Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "ORL_O36",
    version: "2.8",
    description: "HL7 v2.8 ORL_O36 message",
    type: "Message"
  });
