 ...
 */
export const osmR26SubjectPersonOrAnimalIdentificationSchema = z
  .object({
    PID: segments.pidSchema,
    PRT: z.array(segments.prtSchema).optional(),
 ...
 */
export type OSM_R26_SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION = z.infer<
  typeof osmR26SubjectPersonOrAnimalIdentificationSchema
>;
 ...
 */
export const osmR26SubjectPopulationOrLocationIdentificationSchema = z
  .object({
 ...
 */
export type OSM_R26_SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION = z.infer<
  typeof osmR26SubjectPopulationOrLocationIdentificationSchema
>;
...
export const osmR26SpecimenSchema = z
  .object({
    ...
    SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION:
      osmR26SubjectPersonOrAnimalIdentificationSchema.optional(),
    SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION:
      osmR26SubjectPopulationOrLocationIdentificationSchema.optional()
  })
  .register(hl7v2Metadata, {
