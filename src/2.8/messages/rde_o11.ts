...
/**
 * RDE_O11.COMPONENTS group schema
 * Defines the structure and validation rules for the RDE_O11.COMPONENTS group
 */
export const rdeO11ComponentsSchema = z.object({
  "RXC": segments.rxcSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RDE_O11.COMPONENTS",
  version: "2.8",
  description: "HL7 v2.8 RDE_O11.COMPONENTS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the RDE_O11.COMPONENTS schema
 */
export type RDE_O11_COMPONENTS = z.infer<typeof rdeO11ComponentsSchema>;
...
export const rdeO11OrderDetailSchema = z.object({
  ...
  "COMPONENTS": z.array(rdeO11ComponentsSchema).optional()
}).register(hl7v2Metadata, {
