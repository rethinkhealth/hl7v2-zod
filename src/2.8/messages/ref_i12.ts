...
/**
 * HL7 v2.8 REF_I12 Message
 *
 * HL7 v2.8 REF_I12 message definition
...
/**
 * REF_I12.AUTHORIZATION_CONTACT1 group schema
 * Defines the structure and validation rules for the REF_I12.AUTHORIZATION_CONTACT1 group
 */
export const refI12AuthorizationContact1Schema = z
  .object({
    AUT: segments.autSchema,
    CTD: segments.ctdSchema.optional()
  })
  .register(hl7v2Metadata, {
    title: "REF_I12.AUTHORIZATION_CONTACT1",
    version: "2.8",
    description: "HL7 v2.8 REF_I12.AUTHORIZATION_CONTACT1 group",
    type: "Group"
  });

/**
 * TypeScript type inferred from the REF_I12.AUTHORIZATION_CONTACT1 schema
 */
export type REF_I12_AUTHORIZATION_CONTACT1 = z.infer<typeof refI12AuthorizationContact1Schema>;

/**
 * REF_I12.PROVIDER_CONTACT group schema
 * Defines the structure and validation rules for the REF_I12.PROVIDER_CONTACT group
 */
export const refI12ProviderContactSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.PROVIDER_CONTACT group",
    type: "Group"
  });
 ...
 */
export const refI12InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const refI12AuthorizationContact2Schema = z
  .object({
    AUT: segments.autSchema,
    CTD: segments.ctdSchema.optional()
  })
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.AUTHORIZATION_CONTACT2 group",
    type: "Group"
  });
 ...
 */
export const refI12ResultsNotesSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.RESULTS_NOTES group",
    type: "Group"
  });
 ...
 */
export const refI12PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const refI12ProcedureSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.PROCEDURE group",
    type: "Group"
  });
 ...
 */
export const refI12ObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 REF_I12.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const ref_i12Schema = z
  .object({
    MSH: segments.mshSchema,
    SFT: z.array(segments.sftSchema).optional(),
    UAC: segments.uacSchema.optional(),
    RF1: segments.rf1Schema.optional(),
    AUTHORIZATION_CONTACT1: refI12AuthorizationContact1Schema.optional(),
  ...
  .register(hl7v2Metadata, {
    title: "REF_I12",
    version: "2.8",
    description: "HL7 v2.8 REF_I12 message",
    type: "Message"
  });
