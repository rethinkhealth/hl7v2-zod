...
/**
 * HL7 v2.8 RRG_O16 Message
 *
 * HL7 v2.8 RRG_O16 message definition
...
export const rrgO16PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RRG_O16.PATIENT group",
    type: "Group"
  });
...
export const rrgO16TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RRG_O16.TIMING group",
    type: "Group"
  });
...
export const rrgO16TimingGiveSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RRG_O16.TIMING_GIVE group",
    type: "Group"
  });
...
export const rrgO16GiveSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "RRG_O16.GIVE",
    version: "2.8",
    description: "HL7 v2.8 RRG_O16.GIVE group",
    type: "Group"
  });
...
export const rrgO16OrderSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "RRG_O16.ORDER",
    version: "2.8",
    description: "HL7 v2.8 RRG_O16.ORDER group",
    type: "Group"
  });
...
export const rrgO16ResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RRG_O16.RESPONSE group",
    type: "Group"
  });
...
export const rrg_o16Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RRG_O16",
    version: "2.8",
    description: "HL7 v2.8 RRG_O16 message",
    type: "Message"
  });
