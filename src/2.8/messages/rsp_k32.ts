...
/**
 * HL7 v2.8 RSP_K32 Message
 *
 * HL7 v2.8 RSP_K32 message definition
 ...
 */
export const rspK32QueryResponseSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_K32.QUERY_RESPONSE group",
    type: "Group"
  });
...
export const rsp_k32Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_K32",
    version: "2.8",
    description: "HL7 v2.8 RSP_K32 message",
    type: "Message"
  });
