...
/**
 * HL7 v2.8 RSP_Z82 Message
 *
 * HL7 v2.8 RSP_Z82 message definition
...
export const rspZ82VisitSchema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_Z82.VISIT",
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.VISIT group",
    type: "Group"
  });
...
export const rspZ82TimingSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.TIMING group",
    type: "Group"
  });
...
export const rspZ82TreatmentSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.TREATMENT group",
    type: "Group"
  });
...
export const rspZ82TimingEncodedSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.TIMING_ENCODED group",
    type: "Group"
  });
...
export const rspZ82ObservationSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.OBSERVATION group",
    type: "Group"
  });
...
export const rspZ82PatientSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.PATIENT group",
    type: "Group"
  });
...
export const rspZ82OrderDetailSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.ORDER_DETAIL group",
    type: "Group"
  });
...
export const rspZ82EncodedOrderSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.ENCODED_ORDER group",
    type: "Group"
  });
...
export const rspZ82CommonOrderSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.COMMON_ORDER group",
    type: "Group"
  });
...
export const rspZ82QueryResponseSchema = z
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82.QUERY_RESPONSE group",
    type: "Group"
  });
...
export const rsp_z82Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "RSP_Z82",
    version: "2.8",
    description: "HL7 v2.8 RSP_Z82 message",
    type: "Message"
  });
