...
/**
 * HL7 v2.8 RSP_Z88 Message
 * 
 * HL7 v2.8 RSP_Z88 message definition
...
export const rspZ88VisitSchema = z.object({
  ...
  title: "RSP_Z88.VISIT",
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.VISIT group",
  type: "Group"
});
...
export const rspZ88TimingSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.TIMING group",
  type: "Group"
});
...
export const rspZ88ComponentSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.COMPONENT group",
  type: "Group"
});
...
export const rspZ88TimingEncodedSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.TIMING_ENCODED group",
  type: "Group"
});
...
export const rspZ88ObservationSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.OBSERVATION group",
  type: "Group"
});
...
export const rspZ88AllergySchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.ALLERGY group",
  type: "Group"
});
...
export const rspZ88OrderDetailSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.ORDER_DETAIL group",
  type: "Group"
});
...
export const rspZ88OrderEncodedSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.ORDER_ENCODED group",
  type: "Group"
});
...
export const rspZ88PatientSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.PATIENT group",
  type: "Group"
});
...
export const rspZ88CommonOrderSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.COMMON_ORDER group",
  type: "Group"
});
...
export const rspZ88QueryResponseSchema = z.object({
  ...
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88.QUERY_RESPONSE group",
  type: "Group"
});
...
export const rsp_z88Schema = z.object({
  ...
  title: "RSP_Z88",
  version: "2.8",
  description: "HL7 v2.8 RSP_Z88 message",
  type: "Message"
});
