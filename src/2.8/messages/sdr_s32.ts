 ...
 */
export const sdrS32AntiMicrobialDeviceCycleDataSchema = z.object({
 ...
 */
export type SDR_S32_ANTI_MICROBIAL_DEVICE_CYCLE_DATA = z.infer<typeof sdrS32AntiMicrobialDeviceCycleDataSchema>;
