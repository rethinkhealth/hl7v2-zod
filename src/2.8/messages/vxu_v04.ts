...
/**
 * HL7 v2.8 VXU_V04 Message
 *
 * HL7 v2.8 VXU_V04 message definition
 ...
 */
export const vxuV04PatientVisitSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 VXU_V04.PATIENT_VISIT group",
    type: "Group"
  });
 ...
 */
export const vxuV04InsuranceSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 VXU_V04.INSURANCE group",
    type: "Group"
  });
 ...
 */
export const vxuV04PersonObservationSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 VXU_V04.PERSON_OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const vxuV04TimingSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 VXU_V04.TIMING group",
    type: "Group"
  });
 ...
 */
export const vxuV04ObservationSchema = z
  .object({
    OBX: segments.obxSchema,
    PRT: z.array(segments.prtSchema).optional(),
    NTE: z.array(segments.nteSchema).optional()
  ...
  .register(hl7v2Metadata, {
    ...
    version: "2.8",
    description: "HL7 v2.8 VXU_V04.OBSERVATION group",
    type: "Group"
  });
 ...
 */
export const vxuV04OrderSchema = z
  .object({
  ...
  .register(hl7v2Metadata, {
    title: "VXU_V04.ORDER",
    version: "2.8",
    description: "HL7 v2.8 VXU_V04.ORDER group",
    type: "Group"
  });
...
export const vxu_v04Schema = z
  ...
  .register(hl7v2Metadata, {
    title: "VXU_V04",
    version: "2.8",
    description: "HL7 v2.8 VXU_V04 message",
    type: "Message"
  });
