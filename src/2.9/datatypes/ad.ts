...
/**
 * HL7 v2.9 AD Composite Data Type
 * 
 * HL7 v2.9 AD composite data type
 ...
 * AD.6 - Country
 */
export const AD_6 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "AD.6",
  "version": "2.9",
  "description": "Country",
  "type": "DataType",
 ...
 * AD.7 - Address Type
 */
export const AD_7 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "AD.7",
  "version": "2.9",
...
/**
 * AD - HL7 v2.9 AD composite data type
 * 
 * Components:
...
export const AD = z.object({
  ...
  title: 'AD',
  version: '2.9',
  description: 'HL7 v2.9 AD composite data type'
});
