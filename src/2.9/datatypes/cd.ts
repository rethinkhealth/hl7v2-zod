...
/**
 * HL7 v2.9 CD Composite Data Type
 * 
 * HL7 v2.9 CD composite data type
 ...
 */
export const CD_5 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "CD.5",
  "version": "2.9",
...
export const CD_6 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "CD.6",
  "version": "2.9",
  "description": "Minimum and Maximum Data Values",
  "type": "DataType",
  "optionality": "O"
});

/**
 * CD - HL7 v2.9 CD composite data type
 * 
 * Components:
...
export const CD = z.object({
  ...
  title: 'CD',
  version: '2.9',
  description: 'HL7 v2.9 CD composite data type'
});
