...
/**
 * HL7 v2.9 CNN Composite Data Type
 * 
 * HL7 v2.9 CNN composite data type
 ...
 */
export const CNN_11 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CNN.11",
  "version": "2.9",
...
/**
 * CNN - HL7 v2.9 CNN composite data type
 * 
 * Components:
 * - CNN.1: ID Number (ST)
...
export const CNN = z.object({
  ...
  title: 'CNN',
  version: '2.9',
  description: 'HL7 v2.9 CNN composite data type'
});
