...
/**
 * HL7 v2.9 CSU Composite Data Type
 * 
 * HL7 v2.9 CSU composite data type
 ...
 */
export const CSU_4 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CSU.4",
  "version": "2.9",
 ...
 */
export const CSU_7 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CSU.7",
  "version": "2.9",
 ...
 */
export const CSU_10 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "CSU.10",
  "version": "2.9",
 ...
 */
export const CSU_13 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CSU.13",
  "version": "2.9",
...
/**
 * CSU.21 - Second Alternate Unit of Measure Coding System OID
 */
export const CSU_21 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "CSU.21",
  "version": "2.9",
  "description": "Second Alternate Unit of Measure Coding System OID",
  "type": "DataType",
  "optionality": "O"
});

/**
 * CSU.22 - Second Alternate Unit of Measure Value Set OID
 */
export const CSU_22 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "CSU.22",
  "version": "2.9",
  "description": "Second Alternate Unit of Measure Value Set OID",
  "type": "DataType",
  "optionality": "O"
});

/**
 * CSU.23 - Second Alternate Unit of Measure Value Set Vers.ID
 */
export const CSU_23 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "CSU.23",
  "version": "2.9",
  "description": "Second Alternate Unit of Measure Value Set Vers.ID",
  "type": "DataType",
  "optionality": "O"
});

/**
 * CSU - HL7 v2.9 CSU composite data type
 * 
 * Components:
 ...
 * - CSU.21: Second Alternate Unit of Measure Coding System OID (ST)
 * - CSU.22: Second Alternate Unit of Measure Value Set OID (ST)
 * - CSU.23: Second Alternate Unit of Measure Value Set Vers.ID (ST)
 */
export const CSU = z.object({
  ...
  title: 'CSU',
  version: '2.9',
  description: 'HL7 v2.9 CSU composite data type'
});
