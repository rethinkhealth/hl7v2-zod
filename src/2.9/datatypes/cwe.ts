...
/**
 * HL7 v2.9 CWE Composite Data Type
 * 
 * HL7 v2.9 CWE composite data type
 ...
 */
export const CWE_3 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CWE.3",
  "version": "2.9",
 ...
 */
export const CWE_6 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CWE.6",
  "version": "2.9",
 ...
 */
export const CWE_12 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CWE.12",
  "version": "2.9",
...
/**
 * CWE - HL7 v2.9 CWE composite data type
 * 
 * Components:
 * - CWE.1: Identifier (ST)
 * - CWE.2: Text (ST)
...
export const CWE = z.object({
  ...
  title: 'CWE',
  version: '2.9',
  description: 'HL7 v2.9 CWE composite data type'
});
