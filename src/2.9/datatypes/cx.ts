...
/**
 * HL7 v2.9 CX Composite Data Type
 * 
 * HL7 v2.9 CX composite data type
 ...
 */
export const CX_3 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CX.3",
  "version": "2.9",
 ...
 */
export const CX_5 = SimpleTypes.ID.register(hl7v2Metadata, {
  "title": "CX.5",
  "version": "2.9",
 ...
 */
export const CX_12 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "CX.12",
  "version": "2.9",
...
/**
 * CX - HL7 v2.9 CX composite data type
 * 
 * Components:
 * - CX.1: ID Number (ST)
...
export const CX = z.object({
  ...
  title: 'CX',
  version: '2.9',
  description: 'HL7 v2.9 CX composite data type'
});
