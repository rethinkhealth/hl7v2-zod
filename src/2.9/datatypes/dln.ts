...
/**
 * HL7 v2.9 DLN Composite Data Type
 * 
 * HL7 v2.9 DLN composite data type
...
/**
 * DLN - HL7 v2.9 DLN composite data type
 * 
 * Components:
 * - DLN.1: Driver License Number (ST)
...
export const DLN = z.object({
  ...
  title: 'DLN',
  version: '2.9',
  description: 'HL7 v2.9 DLN composite data type'
});
