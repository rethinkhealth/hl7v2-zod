...
/**
 * HL7 v2.9 EI Composite Data Type
 * 
 * HL7 v2.9 EI composite data type
 ...
 */
export const EI_4 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "EI.4",
  "version": "2.9",
...
/**
 * EI - HL7 v2.9 EI composite data type
 * 
 * Components:
...
export const EI = z.object({
  ...
  title: 'EI',
  version: '2.9',
  description: 'HL7 v2.9 EI composite data type'
});
