...
/**
 * HL7 v2.9 HD Composite Data Type
 * 
 * HL7 v2.9 HD composite data type
 ...
 */
export const HD_3 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "HD.3",
  "version": "2.9",
...
/**
 * HD - HL7 v2.9 HD composite data type
 * 
 * Components:
...
export const HD = z.object({
  ...
  title: 'HD',
  version: '2.9',
  description: 'HL7 v2.9 HD composite data type'
});
