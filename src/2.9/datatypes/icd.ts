...
/**
 * HL7 v2.9 ICD Composite Data Type
 * 
 * HL7 v2.9 ICD composite data type
 ...
 */
export const ICD_2 = SimpleTypes.ID.register(hl7v2Metadata, {
  "title": "ICD.2",
  "version": "2.9",
...
/**
 * ICD - HL7 v2.9 ICD composite data type
 * 
 * Components:
...
export const ICD = z.object({
  ...
  title: 'ICD',
  version: '2.9',
  description: 'HL7 v2.9 ICD composite data type'
});
