...
/**
 * HL7 v2.9 MA Composite Data Type
 * 
 * HL7 v2.9 MA composite data type
 ...
 * MA.5 - xx
 */
export const MA_5 = SimpleTypes.ST.optional().register(hl7v2Metadata, {
  "title": "MA.5",
  "version": "2.9",
  "description": "xx",
  "type": "DataType",
...
/**
 * MA - HL7 v2.9 MA composite data type
 * 
 * Components:
...
export const MA = z.object({
  ...
  title: 'MA',
  version: '2.9',
  description: 'HL7 v2.9 MA composite data type'
});
