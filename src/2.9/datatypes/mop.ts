...
/**
 * HL7 v2.9 MOP Composite Data Type
 * 
 * HL7 v2.9 MOP composite data type
 ...
 */
export const MOP_3 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "MOP.3",
  "version": "2.9",
...
/**
 * MOP - HL7 v2.9 MOP composite data type
 * 
 * Components:
...
export const MOP = z.object({
  ...
  title: 'MOP',
  version: '2.9',
  description: 'HL7 v2.9 MOP composite data type'
});
