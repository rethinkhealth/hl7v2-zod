...
/**
 * HL7 v2.9 PPN Composite Data Type
 * 
 * HL7 v2.9 PPN composite data type
 ...
 */
export const PPN_10 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "PPN.10",
  "version": "2.9",
 ...
 */
export const PPN_12 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "PPN.12",
  "version": "2.9",
 ...
 */
export const PPN_13 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "PPN.13",
  "version": "2.9",
 ...
 */
export const PPN_16 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "PPN.16",
  "version": "2.9",
 ...
 */
export const PPN_19 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "PPN.19",
  "version": "2.9",
 ...
 */
export const PPN_26 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "PPN.26",
  "version": "2.9",
...
/**
 * PPN - HL7 v2.9 PPN composite data type
 * 
 * Components:
...
export const PPN = z.object({
  ...
  title: 'PPN',
  version: '2.9',
  description: 'HL7 v2.9 PPN composite data type'
});
