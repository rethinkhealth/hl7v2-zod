...
/**
 * HL7 v2.9 RP Composite Data Type
 * 
 * HL7 v2.9 RP composite data type
 ...
 * RP.3 - Type of Data
 */
export const RP_3 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "RP.3",
  "version": "2.9",
...
/**
 * RP - HL7 v2.9 RP composite data type
 * 
 * Components:
 * - RP.1: Pointer (ST)
...
export const RP = z.object({
  ...
  title: 'RP',
  version: '2.9',
  description: 'HL7 v2.9 RP composite data type'
});
