...
/**
 * HL7 v2.9 RPT Composite Data Type
 * 
 * HL7 v2.9 RPT composite data type
 ...
 */
export const RPT_2 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "RPT.2",
  "version": "2.9",
 ...
 */
export const RPT_3 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "RPT.3",
  "version": "2.9",
 ...
 */
export const RPT_4 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "RPT.4",
  "version": "2.9",
 ...
 */
export const RPT_5 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "RPT.5",
  "version": "2.9",
 ...
 * RPT.6 - Period Units
 */
export const RPT_6 = CWE.optional().register(hl7v2Metadata, {
  "title": "RPT.6",
  "version": "2.9",
 ...
 */
export const RPT_7 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "RPT.7",
  "version": "2.9",
 ...
 * RPT.8 - Event
 */
export const RPT_8 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "RPT.8",
  "version": "2.9",
  "description": "Event",
  "type": "DataType",
 ...
 */
export const RPT_9 = SimpleTypes.NM.optional().register(hl7v2Metadata, {
  "title": "RPT.9",
  "version": "2.9",
 ...
 */
export const RPT_10 = CWE.optional().register(hl7v2Metadata, {
  "title": "RPT.10",
  "version": "2.9",
 ...
 */
export const RPT_11 = SimpleTypes.GTS.optional().register(hl7v2Metadata, {
  "title": "RPT.11",
  "version": "2.9",
...
/**
 * RPT - HL7 v2.9 RPT composite data type
 * 
 * Components:
...
export const RPT = z.object({
  ...
  title: 'RPT',
  version: '2.9',
  description: 'HL7 v2.9 RPT composite data type'
});
