...
/**
 * HL7 v2.9 Simple Data Types
 * 
 * These are the basic data types used in HL7 v2.9 messages.
...
/**
 * SNM - HL7 SNM data type
 */
export const SNM = z.string().register(hl7v2Metadata, {
  title: 'SNM',
  version: '2.9',
  description: 'HL7 SNM data type',
  length: undefined,
});
...
export type SNM = z.infer<typeof SNM>;
