...
/**
 * HL7 v2.9 SPD Composite Data Type
 * 
 * HL7 v2.9 SPD composite data type
 ...
 */
export const SPD_3 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "SPD.3",
  "version": "2.9",
...
/**
 * SPD - HL7 v2.9 SPD composite data type
 * 
 * Components:
...
export const SPD = z.object({
  ...
  title: 'SPD',
  version: '2.9',
  description: 'HL7 v2.9 SPD composite data type'
});
