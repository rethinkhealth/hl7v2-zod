...
/**
 * HL7 v2.9 VH Composite Data Type
 * 
 * HL7 v2.9 VH composite data type
 ...
 */
export const VH_1 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "VH.1",
  "version": "2.9",
 ...
 * VH.2 - End Day Range
 */
export const VH_2 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "VH.2",
  "version": "2.9",
...
/**
 * VH - HL7 v2.9 VH composite data type
 * 
 * Components:
...
export const VH = z.object({
  ...
  title: 'VH',
  version: '2.9',
  description: 'HL7 v2.9 VH composite data type'
});
