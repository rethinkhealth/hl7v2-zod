...
/**
 * HL7 v2.9 VID Composite Data Type
 * 
 * HL7 v2.9 VID composite data type
 ...
 * VID.1 - Version ID
 */
export const VID_1 = SimpleTypes.ID.register(hl7v2Metadata, {
  "title": "VID.1",
  "version": "2.9",
...
/**
 * VID - HL7 v2.9 VID composite data type
 * 
 * Components:
 * - VID.1: Version ID (ID)
...
export const VID = z.object({
  ...
  title: 'VID',
  version: '2.9',
  description: 'HL7 v2.9 VID composite data type'
});
