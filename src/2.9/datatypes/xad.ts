...
/**
 * HL7 v2.9 XAD Composite Data Type
 * 
 * HL7 v2.9 XAD composite data type
 ...
 * XAD.6 - Country
 */
export const XAD_6 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XAD.6",
  "version": "2.9",
  "description": "Country",
  "type": "DataType",
 ...
 * XAD.7 - Address Type
 */
export const XAD_7 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XAD.7",
  "version": "2.9",
 ...
 */
export const XAD_11 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XAD.11",
  "version": "2.9",
 ...
 */
export const XAD_16 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XAD.16",
  "version": "2.9",
 ...
 */
export const XAD_17 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XAD.17",
  "version": "2.9",
 ...
 */
export const XAD_18 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XAD.18",
  "version": "2.9",
...
/**
 * XAD - HL7 v2.9 XAD composite data type
 * 
 * Components:
...
export const XAD = z.object({
  ...
  title: 'XAD',
  version: '2.9',
  description: 'HL7 v2.9 XAD composite data type'
});
