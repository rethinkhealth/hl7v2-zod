...
/**
 * HL7 v2.9 XTN Composite Data Type
 * 
 * HL7 v2.9 XTN composite data type
 ...
 */
export const XTN_2 = SimpleTypes.ID.optional().register(hl7v2Metadata, {
  "title": "XTN.2",
  "version": "2.9",
 ...
 */
export const XTN_3 = SimpleTypes.ID.register(hl7v2Metadata, {
  "title": "XTN.3",
  "version": "2.9",
 ...
 * XTN.5 - Country Code
 */
export const XTN_5 = SNM.optional().register(hl7v2Metadata, {
  "title": "XTN.5",
  "version": "2.9",
 ...
 */
export const XTN_6 = SNM.optional().register(hl7v2Metadata, {
  "title": "XTN.6",
  "version": "2.9",
 ...
 * XTN.7 - Local Number
 */
export const XTN_7 = SNM.optional().register(hl7v2Metadata, {
  "title": "XTN.7",
  "version": "2.9",
 ...
 * XTN.8 - Extension
 */
export const XTN_8 = SNM.optional().register(hl7v2Metadata, {
  "title": "XTN.8",
  "version": "2.9",
...
/**
 * XTN - HL7 v2.9 XTN composite data type
 * 
 * Components:
...
export const XTN = z.object({
  ...
  title: 'XTN',
  version: '2.9',
  description: 'HL7 v2.9 XTN composite data type'
});
