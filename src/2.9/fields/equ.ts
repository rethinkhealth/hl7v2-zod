 ...
 * HL7 v2.9 EQU Fields
 * 
 * HL7 v2.9 EQU field definitions
 ...
 */
export const EQU_6 = datatypes.DTM.register(hl7v2Metadata, {
  "title": "EQU.6",
  "version": "2.9",
  "description": "Expected date/time of the next status change",
  "type": "Field",
  "item": 3487,
  "table": "",
  "longName": "HL7Expected date/time of the next status change"
});
