 ...
 * HL7 v2.9 INV Fields
 * 
 * HL7 v2.9 INV field definitions
 ...
 */
export const INV_21 = datatypes.CWE.register(hl7v2Metadata, {
  "title": "INV.21",
  "version": "2.9",
  "description": "Equipment State Indicator Type Code",
  "type": "Field",
  "item": 3488,
  "table": "HL70942",
  "longName": "HL7Equipment State Indicator Type Code"
});

/**
 * INV.22 - Equipment State Indicator Value
 */
export const INV_22 = datatypes.ST.register(hl7v2Metadata, {
  "title": "INV.22",
  "version": "2.9",
  "description": "Equipment State Indicator Value",
  "type": "Field",
  "item": 3489,
  "table": "",
  "longName": "HL7Equipment State Indicator Value"
});
