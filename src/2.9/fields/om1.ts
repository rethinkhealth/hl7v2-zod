 ...
 * HL7 v2.9 OM1 Fields
 * 
 * HL7 v2.9 OM1 field definitions
 ...
 */
export const OM1_52 = datatypes.CWE.register(hl7v2Metadata, {
  "title": "OM1.52",
  "version": "2.9",
  "description": "Replacement Producer's Service/Test/Observation ID",
  "type": "Field",
  "item": 3433,
  "table": "HL70646",
  "longName": "HL7Replacement Producer's Service/Test/Observation ID"
});

/**
 * OM1.53 - Prior Resuts Instructions
 */
export const OM1_53 = datatypes.TX.register(hl7v2Metadata, {
  "title": "OM1.53",
  "version": "2.9",
  "description": "Prior Resuts Instructions",
  "type": "Field",
  "item": 3434,
  "table": "",
  "longName": "HL7Prior Resuts Instructions"
});

/**
 * OM1.54 - Special Instructions
 */
export const OM1_54 = datatypes.TX.register(hl7v2Metadata, {
  "title": "OM1.54",
  "version": "2.9",
  ...
  "item": 3435,
  "table": "",
  "longName": "HL7Special Instructions"
});

/**
 * OM1.55 - Test Category
 */
export const OM1_55 = datatypes.CWE.register(hl7v2Metadata, {
  "title": "OM1.55",
  "version": "2.9",
  ...
  "item": 3436,
  "table": "",
  "longName": "HL7Test Category"
});

/**
 * OM1.56 - Observation/Identifier associated with Producer’s Service/Test/Observation ID
 */
export const OM1_56 = datatypes.CWE.register(hl7v2Metadata, {
  "title": "OM1.56",
  "version": "2.9",
  "description": "Observation/Identifier associated with Producer’s Service/Test/Observation ID",
  "type": "Field",
  "item": 3437,
  "table": "HL70647",
  "longName": "HL7Observation/Identifier associated with Producer’s Service/Test/Observation ID"
});

/**
 * OM1.57 - Typical Turn-Around Time
 */
export const OM1_57 = datatypes.ST.register(hl7v2Metadata, {
  "title": "OM1.57",
  "version": "2.9",
  "description": "Typical Turn-Around Time",
  "type": "Field",
 ...
 */
export const OM1_58 = datatypes.CWE.register(hl7v2Metadata, {
  "title": "OM1.58",
  "version": "2.9",
  ...
  "item": 3439,
  "table": "HL70001",
  "longName": "HL7Gender Restriction"
});

/**
 * OM1.59 - Age Restriction
 */
export const OM1_59 = datatypes.ST.register(hl7v2Metadata, {
  "title": "OM1.59",
  "version": "2.9",
