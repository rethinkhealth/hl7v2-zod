...
/**
 * HL7 v2.9 BAR_P01 Message
 * 
 * HL7 v2.9 BAR_P01 message definition
...
/**
 * BAR_P01.DIAGNOSIS group schema
 * Defines the structure and validation rules for the BAR_P01.DIAGNOSIS group
 */
export const barP01DiagnosisSchema = z.object({
  "DG1": segments.dg1Schema
}).register(hl7v2Metadata, {
  title: "BAR_P01.DIAGNOSIS",
  version: "2.9",
  description: "HL7 v2.9 BAR_P01.DIAGNOSIS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the BAR_P01.DIAGNOSIS schema
 */
export type BAR_P01_DIAGNOSIS = z.infer<typeof barP01DiagnosisSchema>;

/**
 * BAR_P01.PROCEDURE group schema
 * Defines the structure and validation rules for the BAR_P01.PROCEDURE group
 */
export const barP01ProcedureSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 BAR_P01.PROCEDURE group",
  type: "Group"
});
 ...
 */
export const barP01InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 BAR_P01.INSURANCE group",
  type: "Group"
});
 ...
 */
export const barP01VisitSchema = z.object({
  ...
  "DIAGNOSIS": z.array(barP01DiagnosisSchema).optional(),
  ...
  title: "BAR_P01.VISIT",
  version: "2.9",
  description: "HL7 v2.9 BAR_P01.VISIT group",
  type: "Group"
});
 ...
 */
export const bar_p01Schema = z.object({
  ...
  title: "BAR_P01",
  version: "2.9",
  description: "HL7 v2.9 BAR_P01 message",
  type: "Message"
});
