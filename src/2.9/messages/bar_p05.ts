...
/**
 * HL7 v2.9 BAR_P05 Message
 * 
 * HL7 v2.9 BAR_P05 message definition
...
/**
 * BAR_P05.DIAGNOSIS group schema
 * Defines the structure and validation rules for the BAR_P05.DIAGNOSIS group
 */
export const barP05DiagnosisSchema = z.object({
  "DG1": segments.dg1Schema
}).register(hl7v2Metadata, {
  title: "BAR_P05.DIAGNOSIS",
  version: "2.9",
  description: "HL7 v2.9 BAR_P05.DIAGNOSIS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the BAR_P05.DIAGNOSIS schema
 */
export type BAR_P05_DIAGNOSIS = z.infer<typeof barP05DiagnosisSchema>;
...
export const barP05ProcedureSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 BAR_P05.PROCEDURE group",
  type: "Group"
});
...
export const barP05InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 BAR_P05.INSURANCE group",
  type: "Group"
});
...
export const barP05VisitSchema = z.object({
  ...
  "DIAGNOSIS": z.array(barP05DiagnosisSchema).optional(),
  ...
  title: "BAR_P05.VISIT",
  version: "2.9",
  description: "HL7 v2.9 BAR_P05.VISIT group",
  type: "Group"
});
...
export const bar_p05Schema = z.object({
  ...
  title: "BAR_P05",
  version: "2.9",
  description: "HL7 v2.9 BAR_P05 message",
  type: "Message"
});
