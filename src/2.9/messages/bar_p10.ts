...
/**
 * HL7 v2.9 BAR_P10 Message
 * 
 * HL7 v2.9 BAR_P10 message definition
...
/**
 * BAR_P10.DIAGNOSIS group schema
 * Defines the structure and validation rules for the BAR_P10.DIAGNOSIS group
 */
export const barP10DiagnosisSchema = z.object({
  "DG1": segments.dg1Schema
}).register(hl7v2Metadata, {
  title: "BAR_P10.DIAGNOSIS",
  version: "2.9",
  description: "HL7 v2.9 BAR_P10.DIAGNOSIS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the BAR_P10.DIAGNOSIS schema
 */
export type BAR_P10_DIAGNOSIS = z.infer<typeof barP10DiagnosisSchema>;

/**
 * BAR_P10.PROCEDURE group schema
 * Defines the structure and validation rules for the BAR_P10.PROCEDURE group
 */
export const barP10ProcedureSchema = z.object({
  "PR1": segments.pr1Schema,
  "GP2": segments.gp2Schema.optional()
}).register(hl7v2Metadata, {
  title: "BAR_P10.PROCEDURE",
  version: "2.9",
  description: "HL7 v2.9 BAR_P10.PROCEDURE group",
  type: "Group"
});
 ...
 */
export const bar_p10Schema = z.object({
  ...
  "DIAGNOSIS": z.array(barP10DiagnosisSchema).optional(),
  "GP1": segments.gp1Schema,
  "PROCEDURE": z.array(barP10ProcedureSchema).optional()
}).register(hl7v2Metadata, {
  title: "BAR_P10",
  version: "2.9",
  description: "HL7 v2.9 BAR_P10 message",
  type: "Message"
});
