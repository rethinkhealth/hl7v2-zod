...
/**
 * HL7 v2.9 BAR_P12 Message
 * 
 * HL7 v2.9 BAR_P12 message definition
...
/**
 * BAR_P12.DIAGNOSIS group schema
 * Defines the structure and validation rules for the BAR_P12.DIAGNOSIS group
 */
export const barP12DiagnosisSchema = z.object({
  "DG1": segments.dg1Schema
}).register(hl7v2Metadata, {
  title: "BAR_P12.DIAGNOSIS",
  version: "2.9",
  description: "HL7 v2.9 BAR_P12.DIAGNOSIS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the BAR_P12.DIAGNOSIS schema
 */
export type BAR_P12_DIAGNOSIS = z.infer<typeof barP12DiagnosisSchema>;
...
export const barP12ProcedureSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 BAR_P12.PROCEDURE group",
  type: "Group"
});
...
export const bar_p12Schema = z.object({
  ...
  "DIAGNOSIS": z.array(barP12DiagnosisSchema).optional(),
  ...
  title: "BAR_P12",
  version: "2.9",
  description: "HL7 v2.9 BAR_P12 message",
  type: "Message"
});
