...
/**
 * HL7 v2.9 BRT_O32 Message
 * 
 * HL7 v2.9 BRT_O32 message definition
...
/**
 * BRT_O32.PATIENT group schema
 * Defines the structure and validation rules for the BRT_O32.PATIENT group
 */
export const brtO32PatientSchema = z.object({
  "PID": segments.pidSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "ARV": z.array(segments.arvSchema).optional()
}).register(hl7v2Metadata, {
  title: "BRT_O32.PATIENT",
  version: "2.9",
  description: "HL7 v2.9 BRT_O32.PATIENT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the BRT_O32.PATIENT schema
 */
export type BRT_O32_PATIENT = z.infer<typeof brtO32PatientSchema>;
...
export const brtO32TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 BRT_O32.TIMING group",
  type: "Group"
});
...
export const brtO32OrderSchema = z.object({
  ...
  title: "BRT_O32.ORDER",
  version: "2.9",
  description: "HL7 v2.9 BRT_O32.ORDER group",
  type: "Group"
});
...
export const brtO32ResponseSchema = z.object({
  "PATIENT": brtO32PatientSchema.optional(),
  "ORDER": z.array(brtO32OrderSchema).optional()
}).register(hl7v2Metadata, {
  title: "BRT_O32.RESPONSE",
  version: "2.9",
  description: "HL7 v2.9 BRT_O32.RESPONSE group",
  type: "Group"
});
...
export const brt_o32Schema = z.object({
  ...
  title: "BRT_O32",
  version: "2.9",
  description: "HL7 v2.9 BRT_O32 message",
  type: "Message"
});
