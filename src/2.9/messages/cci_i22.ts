...
/**
 * HL7 v2.9 CCI_I22 Message
 * 
 * HL7 v2.9 CCI_I22 message definition
...
export const cciI22InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.INSURANCE group",
  type: "Group"
});
...
export const cciI22ResourceObjectSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.RESOURCE_OBJECT group",
  type: "Group"
});
...
export const cciI22ResourceObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.RESOURCE_OBSERVATION group",
  type: "Group"
});
...
export const cciI22ClinicalHistoryObjectSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});
...
export const cciI22ClinicalHistoryObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.CLINICAL_HISTORY_OBSERVATION group",
  type: "Group"
});
...
/**
 * CCI_I22.PARTICIPATION_CLINICAL_HISTORY_OBJECT group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_CLINICAL_HISTORY_OBJECT group
 */
export const cciI22ParticipationClinicalHistoryObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_CLINICAL_HISTORY_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_CLINICAL_HISTORY_OBJECT schema
 */
export type CCI_I22_PARTICIPATION_CLINICAL_HISTORY_OBJECT = z.infer<typeof cciI22ParticipationClinicalHistoryObjectSchema>;
...
export const cciI22PatientVisitsSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PATIENT_VISITS group",
  type: "Group"
});
...
export const cciI22MedicationOrderObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_ORDER_OBSERVATION group",
  type: "Group"
});
...
export const cciI22MedicationEncodingObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_ENCODING_OBSERVATION group",
  type: "Group"
});
...
export const cciI22MedicationAdministrationObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_ADMINISTRATION_OBSERVATION group",
  type: "Group"
});
...
/**
 * CCI_I22.PARTICIPATION_PROBLEM_OBJECT group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_PROBLEM_OBJECT group
 */
export const cciI22ParticipationProblemObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_PROBLEM_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_PROBLEM_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_PROBLEM_OBJECT schema
 */
export type CCI_I22_PARTICIPATION_PROBLEM_OBJECT = z.infer<typeof cciI22ParticipationProblemObjectSchema>;
...
export const cciI22ProblemObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PROBLEM_OBSERVATION group",
  type: "Group"
});
...
/**
 * CCI_I22.PARTICIPATION_GOAL_OBJECT group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_GOAL_OBJECT group
 */
export const cciI22ParticipationGoalObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_GOAL_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_GOAL_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_GOAL_OBJECT schema
 */
export type CCI_I22_PARTICIPATION_GOAL_OBJECT = z.infer<typeof cciI22ParticipationGoalObjectSchema>;
...
export const cciI22GoalObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.GOAL_OBSERVATION group",
  type: "Group"
});
...
/**
 * CCI_I22.PARTICIPATION_PATHWAY_OBJECT group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_PATHWAY_OBJECT group
 */
export const cciI22ParticipationPathwayObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_PATHWAY_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_PATHWAY_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_PATHWAY_OBJECT schema
 */
export type CCI_I22_PARTICIPATION_PATHWAY_OBJECT = z.infer<typeof cciI22ParticipationPathwayObjectSchema>;
...
export const cciI22PathwayObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PATHWAY_OBSERVATION group",
  type: "Group"
});
...
export const cciI22ResourceDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.RESOURCE_DETAIL group",
  type: "Group"
});
...
export const cciI22ClinicalHistoryDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.CLINICAL_HISTORY_DETAIL group",
  type: "Group"
});
...
/**
 * CCI_I22.PARTICIPATION_CLINICAL_HISTORY group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_CLINICAL_HISTORY group
 */
export const cciI22ParticipationClinicalHistorySchema = z.object({
  "PARTICIPATION_CLINICAL_HISTORY_OBJECT": cciI22ParticipationClinicalHistoryObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_CLINICAL_HISTORY",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_CLINICAL_HISTORY group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_CLINICAL_HISTORY schema
 */
export type CCI_I22_PARTICIPATION_CLINICAL_HISTORY = z.infer<typeof cciI22ParticipationClinicalHistorySchema>;
...
export const cciI22MedicationOrderDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_ORDER_DETAIL group",
  type: "Group"
});
...
export const cciI22MedicationEncodingDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_ENCODING_DETAIL group",
  type: "Group"
});
...
export const cciI22MedicationAdministrationDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_ADMINISTRATION_DETAIL group",
  type: "Group"
});
...
/**
 * CCI_I22.PARTICIPATION_PROBLEM group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_PROBLEM group
 */
export const cciI22ParticipationProblemSchema = z.object({
  "PARTICIPATION_PROBLEM_OBJECT": cciI22ParticipationProblemObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_PROBLEM",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_PROBLEM group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_PROBLEM schema
 */
export type CCI_I22_PARTICIPATION_PROBLEM = z.infer<typeof cciI22ParticipationProblemSchema>;

/**
 * CCI_I22.PARTICIPATION_GOAL group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_GOAL group
 */
export const cciI22ParticipationGoalSchema = z.object({
  "PARTICIPATION_GOAL_OBJECT": cciI22ParticipationGoalObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_GOAL",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_GOAL group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_GOAL schema
 */
export type CCI_I22_PARTICIPATION_GOAL = z.infer<typeof cciI22ParticipationGoalSchema>;

/**
 * CCI_I22.PARTICIPATION_PATHWAY group schema
 * Defines the structure and validation rules for the CCI_I22.PARTICIPATION_PATHWAY group
 */
export const cciI22ParticipationPathwaySchema = z.object({
  "PARTICIPATION_PATHWAY_OBJECT": cciI22ParticipationPathwayObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.PARTICIPATION_PATHWAY",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PARTICIPATION_PATHWAY group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCI_I22.PARTICIPATION_PATHWAY schema
 */
export type CCI_I22_PARTICIPATION_PATHWAY = z.infer<typeof cciI22ParticipationPathwaySchema>;
...
export const cciI22ResourcesSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.RESOURCES group",
  type: "Group"
});
...
export const cciI22ClinicalHistorySchema = z.object({
  ...
  "PARTICIPATION_CLINICAL_HISTORY": z.array(cciI22ParticipationClinicalHistorySchema).optional(),
  "CTI": z.array(segments.ctiSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.CLINICAL_HISTORY",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.CLINICAL_HISTORY group",
  type: "Group"
});
...
export const cciI22MedicationHistorySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.MEDICATION_HISTORY group",
  type: "Group"
});
...
export const cciI22ProblemSchema = z.object({
  ...
  "VAR": z.array(segments.varSchema).optional(),
  "PARTICIPATION_PROBLEM": z.array(cciI22ParticipationProblemSchema).optional(),
  "PROBLEM_OBSERVATION": z.array(cciI22ProblemObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.PROBLEM",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PROBLEM group",
  type: "Group"
});
...
export const cciI22GoalSchema = z.object({
  ...
  "VAR": z.array(segments.varSchema).optional(),
  "PARTICIPATION_GOAL": z.array(cciI22ParticipationGoalSchema).optional(),
  "GOAL_OBSERVATION": z.array(cciI22GoalObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.GOAL",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.GOAL group",
  type: "Group"
});
...
export const cciI22PathwaySchema = z.object({
  ...
  "VAR": z.array(segments.varSchema).optional(),
  "PARTICIPATION_PATHWAY": z.array(cciI22ParticipationPathwaySchema).optional(),
  "PATHWAY_OBSERVATION": z.array(cciI22PathwayObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCI_I22.PATHWAY",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.PATHWAY group",
  type: "Group"
});
...
export const cciI22AppointmentHistorySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCI_I22.APPOINTMENT_HISTORY group",
  type: "Group"
});
...
export const cci_i22Schema = z.object({
  ...
  title: "CCI_I22",
  version: "2.9",
  description: "HL7 v2.9 CCI_I22 message",
  type: "Message"
});
