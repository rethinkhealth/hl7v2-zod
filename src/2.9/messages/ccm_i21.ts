...
/**
 * HL7 v2.9 CCM_I21 Message
 * 
 * HL7 v2.9 CCM_I21 message definition
...
export const ccmI21InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.INSURANCE group",
  type: "Group"
});
...
export const ccmI21ResourceObjectSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.RESOURCE_OBJECT group",
  type: "Group"
});
 ...
 */
export const ccmI21ResourceObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.RESOURCE_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.RESOURCE_OBSERVATION group",
  type: "Group"
});
...
export const ccmI21ClinicalHistoryObjectSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});
 ...
 */
export const ccmI21ClinicalHistoryObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.CLINICAL_HISTORY_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.CLINICAL_HISTORY_OBSERVATION group",
  type: "Group"
});
 ...
 */
export type CCM_I21_CLINICAL_HISTORY_OBSERVATION = z.infer<typeof ccmI21ClinicalHistoryObservationSchema>;

/**
 * CCM_I21.PARTICIPATION_CLINICAL_HISTORY_OBJECT group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_CLINICAL_HISTORY_OBJECT group
 */
export const ccmI21ParticipationClinicalHistoryObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_CLINICAL_HISTORY_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_CLINICAL_HISTORY_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_CLINICAL_HISTORY_OBJECT schema
 */
export type CCM_I21_PARTICIPATION_CLINICAL_HISTORY_OBJECT = z.infer<typeof ccmI21ParticipationClinicalHistoryObjectSchema>;
...
export const ccmI21PatientVisitsSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PATIENT_VISITS group",
  type: "Group"
});
 ...
 */
export const ccmI21MedicationOrderObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.MEDICATION_ORDER_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_ORDER_OBSERVATION group",
  type: "Group"
});
 ...
 */
export type CCM_I21_MEDICATION_ORDER_OBSERVATION = z.infer<typeof ccmI21MedicationOrderObservationSchema>;
 ...
 */
export const ccmI21MedicationEncodingObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.MEDICATION_ENCODING_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_ENCODING_OBSERVATION group",
  type: "Group"
});
 ...
 */
export type CCM_I21_MEDICATION_ENCODING_OBSERVATION = z.infer<typeof ccmI21MedicationEncodingObservationSchema>;
 ...
 */
export const ccmI21MedicationAdministrationObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.MEDICATION_ADMINISTRATION_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_ADMINISTRATION_OBSERVATION group",
  type: "Group"
});
 ...
 */
export type CCM_I21_MEDICATION_ADMINISTRATION_OBSERVATION = z.infer<typeof ccmI21MedicationAdministrationObservationSchema>;

/**
 * CCM_I21.PARTICIPATION_PROBLEM_OBJECT group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_PROBLEM_OBJECT group
 */
export const ccmI21ParticipationProblemObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_PROBLEM_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_PROBLEM_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_PROBLEM_OBJECT schema
 */
export type CCM_I21_PARTICIPATION_PROBLEM_OBJECT = z.infer<typeof ccmI21ParticipationProblemObjectSchema>;
 ...
 */
export const ccmI21ProblemObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PROBLEM_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PROBLEM_OBSERVATION group",
  type: "Group"
});
...
/**
 * CCM_I21.PARTICIPATION_GOAL_OBJECT group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_GOAL_OBJECT group
 */
export const ccmI21ParticipationGoalObjectSchema = z.object({
  "ROL": segments.rolSchema,
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_GOAL_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_GOAL_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_GOAL_OBJECT schema
 */
export type CCM_I21_PARTICIPATION_GOAL_OBJECT = z.infer<typeof ccmI21ParticipationGoalObjectSchema>;

/**
 * CCM_I21.GOAL_OBSERVATION group schema
 * Defines the structure and validation rules for the CCM_I21.GOAL_OBSERVATION group
 */
export const ccmI21GoalObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.GOAL_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.GOAL_OBSERVATION group",
  type: "Group"
});
...
/**
 * CCM_I21.PARTICIPATION_PATHWAY_OBJECT group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_PATHWAY_OBJECT group
 */
export const ccmI21ParticipationPathwayObjectSchema = z.object({
  "PRT": segments.prtSchema,
  "PRD": segments.prdSchema
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_PATHWAY_OBJECT",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_PATHWAY_OBJECT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_PATHWAY_OBJECT schema
 */
export type CCM_I21_PARTICIPATION_PATHWAY_OBJECT = z.infer<typeof ccmI21ParticipationPathwayObjectSchema>;
 ...
 */
export const ccmI21PathwayObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PATHWAY_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PATHWAY_OBSERVATION group",
  type: "Group"
});
...
export const ccmI21ResourceDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.RESOURCE_DETAIL group",
  type: "Group"
});
...
export const ccmI21ClinicalHistoryDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.CLINICAL_HISTORY_DETAIL group",
  type: "Group"
});
...
/**
 * CCM_I21.PARTICIPATION_CLINICAL_HISTORY group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_CLINICAL_HISTORY group
 */
export const ccmI21ParticipationClinicalHistorySchema = z.object({
  "PARTICIPATION_CLINICAL_HISTORY_OBJECT": ccmI21ParticipationClinicalHistoryObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_CLINICAL_HISTORY",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_CLINICAL_HISTORY group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_CLINICAL_HISTORY schema
 */
export type CCM_I21_PARTICIPATION_CLINICAL_HISTORY = z.infer<typeof ccmI21ParticipationClinicalHistorySchema>;
...
export const ccmI21MedicationOrderDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_ORDER_DETAIL group",
  type: "Group"
});
...
export const ccmI21MedicationEncodingDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_ENCODING_DETAIL group",
  type: "Group"
});
...
export const ccmI21MedicationAdministrationDetailSchema = z.object({
  ...
  "MEDICATION_ADMINISTRATION_OBSERVATION": z.array(ccmI21MedicationAdministrationObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.MEDICATION_ADMINISTRATION_DETAIL",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_ADMINISTRATION_DETAIL group",
  type: "Group"
});
...
/**
 * CCM_I21.PARTICIPATION_PROBLEM group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_PROBLEM group
 */
export const ccmI21ParticipationProblemSchema = z.object({
  "PARTICIPATION_PROBLEM_OBJECT": ccmI21ParticipationProblemObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_PROBLEM",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_PROBLEM group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_PROBLEM schema
 */
export type CCM_I21_PARTICIPATION_PROBLEM = z.infer<typeof ccmI21ParticipationProblemSchema>;

/**
 * CCM_I21.PARTICIPATION_GOAL group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_GOAL group
 */
export const ccmI21ParticipationGoalSchema = z.object({
  "PARTICIPATION_GOAL_OBJECT": ccmI21ParticipationGoalObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_GOAL",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_GOAL group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_GOAL schema
 */
export type CCM_I21_PARTICIPATION_GOAL = z.infer<typeof ccmI21ParticipationGoalSchema>;

/**
 * CCM_I21.PARTICIPATION_PATHWAY group schema
 * Defines the structure and validation rules for the CCM_I21.PARTICIPATION_PATHWAY group
 */
export const ccmI21ParticipationPathwaySchema = z.object({
  "PARTICIPATION_PATHWAY_OBJECT": ccmI21ParticipationPathwayObjectSchema,
  "VAR": z.array(segments.varSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PARTICIPATION_PATHWAY",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PARTICIPATION_PATHWAY group",
  type: "Group"
});

/**
 * TypeScript type inferred from the CCM_I21.PARTICIPATION_PATHWAY schema
 */
export type CCM_I21_PARTICIPATION_PATHWAY = z.infer<typeof ccmI21ParticipationPathwaySchema>;
...
export const ccmI21ResourcesSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.RESOURCES group",
  type: "Group"
});
...
export const ccmI21ClinicalHistorySchema = z.object({
  ...
  "PARTICIPATION_CLINICAL_HISTORY": z.array(ccmI21ParticipationClinicalHistorySchema).optional(),
  "CTI": z.array(segments.ctiSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.CLINICAL_HISTORY",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.CLINICAL_HISTORY group",
  type: "Group"
});
...
export const ccmI21MedicationHistorySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.MEDICATION_HISTORY group",
  type: "Group"
});
...
export const ccmI21ProblemSchema = z.object({
  ...
  "VAR": z.array(segments.varSchema).optional(),
  "PARTICIPATION_PROBLEM": z.array(ccmI21ParticipationProblemSchema).optional(),
  "PROBLEM_OBSERVATION": z.array(ccmI21ProblemObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PROBLEM",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PROBLEM group",
  type: "Group"
});
...
export const ccmI21GoalSchema = z.object({
  ...
  "VAR": z.array(segments.varSchema).optional(),
  "PARTICIPATION_GOAL": z.array(ccmI21ParticipationGoalSchema).optional(),
  "GOAL_OBSERVATION": z.array(ccmI21GoalObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.GOAL",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.GOAL group",
  type: "Group"
});
...
export const ccmI21PathwaySchema = z.object({
  ...
  "VAR": z.array(segments.varSchema).optional(),
  "PARTICIPATION_PATHWAY": z.array(ccmI21ParticipationPathwaySchema).optional(),
  "PATHWAY_OBSERVATION": z.array(ccmI21PathwayObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "CCM_I21.PATHWAY",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.PATHWAY group",
  type: "Group"
});
...
export const ccmI21AppointmentHistorySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CCM_I21.APPOINTMENT_HISTORY group",
  type: "Group"
});
...
export const ccm_i21Schema = z.object({
  ...
  title: "CCM_I21",
  version: "2.9",
  description: "HL7 v2.9 CCM_I21 message",
  type: "Message"
});
