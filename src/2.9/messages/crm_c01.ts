...
/**
 * HL7 v2.9 CRM_C01 Message
 * 
 * HL7 v2.9 CRM_C01 message definition
...
export const crmC01PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CRM_C01.PATIENT_VISIT group",
  type: "Group"
});
...
export const crmC01PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CRM_C01.PATIENT group",
  type: "Group"
});
...
export const crm_c01Schema = z.object({
  ...
  title: "CRM_C01",
  version: "2.9",
  description: "HL7 v2.9 CRM_C01 message",
  type: "Message"
});
