...
/**
 * HL7 v2.9 CSU_C09 Message
 * 
 * HL7 v2.9 CSU_C09 message definition
...
export const csuC09VisitSchema = z.object({
  ...
  title: "CSU_C09.VISIT",
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.VISIT group",
  type: "Group"
});
...
export const csuC09StudyObservationOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.STUDY_OBSERVATION_ORDER group",
  type: "Group"
});
...
export const csuC09TimingQtySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.TIMING_QTY group",
  type: "Group"
});
...
export const csuC09CommonOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.COMMON_ORDER group",
  type: "Group"
});
...
export const csuC09RxAdminSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.RX_ADMIN group",
  type: "Group"
});
...
export const csuC09StudyObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.STUDY_OBSERVATION group",
  type: "Group"
});
...
export const csuC09StudyPharmSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.STUDY_PHARM group",
  type: "Group"
});
...
export const csuC09StudyScheduleSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.STUDY_SCHEDULE group",
  type: "Group"
});
...
export const csuC09StudyPhaseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.STUDY_PHASE group",
  type: "Group"
});
...
export const csuC09PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 CSU_C09.PATIENT group",
  type: "Group"
});
...
export const csu_c09Schema = z.object({
  ...
  title: "CSU_C09",
  version: "2.9",
  description: "HL7 v2.9 CSU_C09 message",
  type: "Message"
});
