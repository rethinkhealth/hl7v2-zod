...
/**
 * HL7 v2.9 DBC_O42 Message
 * 
 * HL7 v2.9 DBC_O42 message definition
...
/**
 * DBC_O42.DONOR_OBSERVATIONS group schema
 * Defines the structure and validation rules for the DBC_O42.DONOR_OBSERVATIONS group
 */
export const dbcO42DonorObservationsSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "DBC_O42.DONOR_OBSERVATIONS",
  version: "2.9",
  description: "HL7 v2.9 DBC_O42.DONOR_OBSERVATIONS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the DBC_O42.DONOR_OBSERVATIONS schema
 */
export type DBC_O42_DONOR_OBSERVATIONS = z.infer<typeof dbcO42DonorObservationsSchema>;
...
export const dbcO42DonorSchema = z.object({
  ...
  "PRT": z.array(segments.prtSchema).optional(),
  "DONOR_OBSERVATIONS": z.array(dbcO42DonorObservationsSchema).optional(),
  ...
  title: "DBC_O42.DONOR",
  version: "2.9",
  description: "HL7 v2.9 DBC_O42.DONOR group",
  type: "Group"
});
...
export const dbc_o42Schema = z.object({
  ...
  title: "DBC_O42",
  version: "2.9",
  description: "HL7 v2.9 DBC_O42 message",
  type: "Message"
});
