...
/**
 * HL7 v2.9 DRC_O47 Message
 * 
 * HL7 v2.9 DRC_O47 message definition
...
/**
 * DRC_O47.DONOR_OBSERVATIONS group schema
 * Defines the structure and validation rules for the DRC_O47.DONOR_OBSERVATIONS group
 */
export const drcO47DonorObservationsSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "DRC_O47.DONOR_OBSERVATIONS",
  version: "2.9",
  description: "HL7 v2.9 DRC_O47.DONOR_OBSERVATIONS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the DRC_O47.DONOR_OBSERVATIONS schema
 */
export type DRC_O47_DONOR_OBSERVATIONS = z.infer<typeof drcO47DonorObservationsSchema>;
 ...
 */
export const drcO47DonorRegistrationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 DRC_O47.DONOR_REGISTRATION group",
  type: "Group"
});
 ...
 */
export const drcO47DonationOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 DRC_O47.DONATION_ORDER group",
  type: "Group"
});
 ...
 */
export const drcO47DonorSchema = z.object({
  "PID": segments.pidSchema,
  "PD1": segments.pd1Schema.optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  "DONOR_OBSERVATIONS": z.array(drcO47DonorObservationsSchema).optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  ...
  title: "DRC_O47.DONOR",
  version: "2.9",
  description: "HL7 v2.9 DRC_O47.DONOR group",
  type: "Group"
});
 ...
 */
export const drc_o47Schema = z.object({
  ...
  title: "DRC_O47",
  version: "2.9",
  description: "HL7 v2.9 DRC_O47 message",
  type: "Message"
});
