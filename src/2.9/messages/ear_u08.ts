...
/**
 * HL7 v2.9 EAR_U08 Message
 * 
 * HL7 v2.9 EAR_U08 message definition
...
export const earU08SpecimenContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EAR_U08.SPECIMEN_CONTAINER group",
  type: "Group"
});
...
export const earU08CommandResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EAR_U08.COMMAND_RESPONSE group",
  type: "Group"
});
...
export const ear_u08Schema = z.object({
  ...
  title: "EAR_U08",
  version: "2.9",
  description: "HL7 v2.9 EAR_U08 message",
  type: "Message"
});
