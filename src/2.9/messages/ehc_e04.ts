...
/**
 * HL7 v2.9 EHC_E04 Message
 * 
 * HL7 v2.9 EHC_E04 message definition
 ...
 */
export const ehcE04ProductServiceGroupSchema = z.object({
  "PSG": segments.psgSchema,
  "PSL": z.array(segments.pslSchema).optional()
}).register(hl7v2Metadata, {
  title: "EHC_E04.PRODUCT_SERVICE_GROUP",
  version: "2.9",
  description: "HL7 v2.9 EHC_E04.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
 ...
 */
export const ehcE04ProductServiceSectionSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E04.PRODUCT_SERVICE_SECTION group",
  type: "Group"
});
 ...
 */
export const ehcE04ReassessmentRequestInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E04.REASSESSMENT_REQUEST_INFO group",
  type: "Group"
});
 ...
 */
export const ehc_e04Schema = z.object({
  ...
  title: "EHC_E04",
  version: "2.9",
  description: "HL7 v2.9 EHC_E04 message",
  type: "Message"
});
