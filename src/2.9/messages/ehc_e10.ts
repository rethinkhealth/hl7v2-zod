...
/**
 * HL7 v2.9 EHC_E10 Message
 * 
 * HL7 v2.9 EHC_E10 message definition
 ...
 */
export const ehcE10ProductServiceLineInfoSchema = z.object({
  "PSL": segments.pslSchema,
  "ADJ": z.array(segments.adjSchema).optional()
}).register(hl7v2Metadata, {
  title: "EHC_E10.PRODUCT_SERVICE_LINE_INFO",
  version: "2.9",
  description: "HL7 v2.9 EHC_E10.PRODUCT_SERVICE_LINE_INFO group",
  type: "Group"
});
 ...
 */
export const ehcE10ProductServiceGroupSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E10.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
 ...
 */
export const ehcE10InvoiceProcessingResultsInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E10.INVOICE_PROCESSING_RESULTS_INFO group",
  type: "Group"
});
 ...
 */
export type EHC_E10_INVOICE_PROCESSING_RESULTS_INFO = z.infer<typeof ehcE10InvoiceProcessingResultsInfoSchema>;

/**
 * EHC_E10 message schema
 * Defines the structure and validation rules for the EHC_E10 message
 */
export const ehc_e10Schema = z.object({
  ...
  title: "EHC_E10",
  version: "2.9",
  description: "HL7 v2.9 EHC_E10 message",
  type: "Message"
});
