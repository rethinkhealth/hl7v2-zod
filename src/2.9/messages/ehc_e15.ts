...
/**
 * HL7 v2.9 EHC_E15 Message
 * 
 * HL7 v2.9 EHC_E15 message definition
 ...
 */
export const ehcE15PaymentRemittanceHeaderInfoSchema = z.object({
  "PMT": segments.pmtSchema,
  "PYE": segments.pyeSchema
}).register(hl7v2Metadata, {
  title: "EHC_E15.PAYMENT_REMITTANCE_HEADER_INFO",
  version: "2.9",
  description: "HL7 v2.9 EHC_E15.PAYMENT_REMITTANCE_HEADER_INFO group",
  type: "Group"
});
 ...
 */
export const ehcE15AdjustmentPayeeSchema = z.object({
  "ADJ": segments.adjSchema,
  "PRT": segments.prtSchema.optional(),
  "ROL": segments.rolSchema.optional()
}).register(hl7v2Metadata, {
  title: "EHC_E15.ADJUSTMENT_PAYEE",
  version: "2.9",
  description: "HL7 v2.9 EHC_E15.ADJUSTMENT_PAYEE group",
  type: "Group"
});
 ...
 */
export const ehcE15ProductServiceGroupSchema = z.object({
  "PSG": segments.psgSchema,
  "PSL_ITEM_INFO": z.array(ehcE15PslItemInfoSchema)
}).register(hl7v2Metadata, {
  title: "EHC_E15.PRODUCT_SERVICE_GROUP",
  version: "2.9",
  description: "HL7 v2.9 EHC_E15.PRODUCT_SERVICE_GROUP group",
  type: "Group"
});
 ...
 */
export const ehcE15PaymentRemittanceDetailInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E15.PAYMENT_REMITTANCE_DETAIL_INFO group",
  type: "Group"
});
 ...
 */
export type EHC_E15_PAYMENT_REMITTANCE_DETAIL_INFO = z.infer<typeof ehcE15PaymentRemittanceDetailInfoSchema>;

/**
 * EHC_E15 message schema
 * Defines the structure and validation rules for the EHC_E15 message
 */
export const ehc_e15Schema = z.object({
  ...
  title: "EHC_E15",
  version: "2.9",
  description: "HL7 v2.9 EHC_E15 message",
  type: "Message"
});
