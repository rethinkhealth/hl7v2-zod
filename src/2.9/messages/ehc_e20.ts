...
/**
 * HL7 v2.9 EHC_E20 Message
 * 
 * HL7 v2.9 EHC_E20 message definition
...
export const ehcE20InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E20.INSURANCE group",
  type: "Group"
});
...
export const ehcE20DiagnosisSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E20.DIAGNOSIS group",
  type: "Group"
});
...
export const ehcE20PslItemInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E20.PSL_ITEM_INFO group",
  type: "Group"
});
...
export const ehcE20PatInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E20.PAT_INFO group",
  type: "Group"
});
...
export const ehcE20AuthorizationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E20.AUTHORIZATION_REQUEST group",
  type: "Group"
});
...
export const ehc_e20Schema = z.object({
  ...
  title: "EHC_E20",
  version: "2.9",
  description: "HL7 v2.9 EHC_E20 message",
  type: "Message"
});
