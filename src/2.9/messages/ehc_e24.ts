...
/**
 * HL7 v2.9 EHC_E24 Message
 * 
 * HL7 v2.9 EHC_E24 message definition
...
export const ehcE24PslItemInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E24.PSL_ITEM_INFO group",
  type: "Group"
});
...
export const ehcE24AuthorizationResponseInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 EHC_E24.AUTHORIZATION_RESPONSE_INFO group",
  type: "Group"
});
...
export const ehc_e24Schema = z.object({
  ...
  title: "EHC_E24",
  version: "2.9",
  description: "HL7 v2.9 EHC_E24 message",
  type: "Message"
});
