...
/**
 * HL7 v2.9 MFN_M09 Message
 * 
 * HL7 v2.9 MFN_M09 message definition
...
export const mfnM09MfTestCatDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 MFN_M09.MF_TEST_CAT_DETAIL group",
  type: "Group"
});
...
export const mfnM09MfTestCategoricalSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 MFN_M09.MF_TEST_CATEGORICAL group",
  type: "Group"
});
...
export const mfn_m09Schema = z.object({
  ...
  title: "MFN_M09",
  version: "2.9",
  description: "HL7 v2.9 MFN_M09 message",
  type: "Message"
});
