...
/**
 * HL7 v2.9 MFN_M10 Message
 * 
 * HL7 v2.9 MFN_M10 message definition
 ...
 */
export const mfnM10MfTestBattDetailSchema = z.object({
  "OM5": segments.om5Schema,
  "OM4": z.array(segments.om4Schema).optional()
}).register(hl7v2Metadata, {
  title: "MFN_M10.MF_TEST_BATT_DETAIL",
  version: "2.9",
  description: "HL7 v2.9 MFN_M10.MF_TEST_BATT_DETAIL group",
  type: "Group"
});
 ...
 */
export const mfnM10MfTestBatteriesSchema = z.object({
  "MFE": segments.mfeSchema,
  "OM1": segments.om1Schema,
  "OMC": z.array(segments.omcSchema).optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  "MF_TEST_BATT_DETAIL": mfnM10MfTestBattDetailSchema.optional()
}).register(hl7v2Metadata, {
  title: "MFN_M10.MF_TEST_BATTERIES",
  version: "2.9",
  description: "HL7 v2.9 MFN_M10.MF_TEST_BATTERIES group",
  type: "Group"
});
 ...
 */
export const mfn_m10Schema = z.object({
  ...
  title: "MFN_M10",
  version: "2.9",
  description: "HL7 v2.9 MFN_M10 message",
  type: "Message"
});
