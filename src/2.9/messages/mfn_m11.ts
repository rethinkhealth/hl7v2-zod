...
/**
 * HL7 v2.9 MFN_M11 Message
 * 
 * HL7 v2.9 MFN_M11 message definition
...
export const mfnM11MfTestCalcDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 MFN_M11.MF_TEST_CALC_DETAIL group",
  type: "Group"
});
...
export const mfnM11MfTestCalculatedSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 MFN_M11.MF_TEST_CALCULATED group",
  type: "Group"
});
...
export const mfn_m11Schema = z.object({
  ...
  title: "MFN_M11",
  version: "2.9",
  description: "HL7 v2.9 MFN_M11 message",
  type: "Message"
});
