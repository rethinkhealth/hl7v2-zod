...
/**
 * HL7 v2.9 MFN_M12 Message
 * 
 * HL7 v2.9 MFN_M12 message definition
 ...
 */
export const mfnM12MfObsOtherAttributesSchema = z.object({
  "OM7": segments.om7Schema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "MFN_M12.MF_OBS_OTHER_ATTRIBUTES",
  version: "2.9",
  description: "HL7 v2.9 MFN_M12.MF_OBS_OTHER_ATTRIBUTES group",
  type: "Group"
});
...
export const mfnM12MfObsAttributesSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 MFN_M12.MF_OBS_ATTRIBUTES group",
  type: "Group"
});
...
export const mfn_m12Schema = z.object({
  ...
  title: "MFN_M12",
  version: "2.9",
  description: "HL7 v2.9 MFN_M12 message",
  type: "Message"
});
