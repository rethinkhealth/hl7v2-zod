...
/**
 * HL7 v2.9 MFN_M15 Message
 * 
 * HL7 v2.9 MFN_M15 message definition
 ...
 */
export const mfnM15MfInvItemSchema = z.object({
  "MFE": segments.mfeSchema,
  "IIM": segments.iimSchema
}).register(hl7v2Metadata, {
  title: "MFN_M15.MF_INV_ITEM",
  version: "2.9",
  description: "HL7 v2.9 MFN_M15.MF_INV_ITEM group",
  type: "Group"
});
 ...
 */
export const mfn_m15Schema = z.object({
  ...
  title: "MFN_M15",
  version: "2.9",
  description: "HL7 v2.9 MFN_M15 message",
  type: "Message"
});
