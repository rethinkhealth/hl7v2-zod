...
/**
 * HL7 v2.9 MFN_M17 Message
 * 
 * HL7 v2.9 MFN_M17 message definition
 ...
 */
export const mfnM17MfDrgSchema = z.object({
  "MFE": segments.mfeSchema,
  "DMI": segments.dmiSchema
}).register(hl7v2Metadata, {
  title: "MFN_M17.MF_DRG",
  version: "2.9",
  description: "HL7 v2.9 MFN_M17.MF_DRG group",
  type: "Group"
});
 ...
 */
export const mfn_m17Schema = z.object({
  ...
  title: "MFN_M17",
  version: "2.9",
  description: "HL7 v2.9 MFN_M17 message",
  type: "Message"
});
