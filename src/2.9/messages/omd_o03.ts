...
/**
 * HL7 v2.9 OMD_O03 Message
 * 
 * HL7 v2.9 OMD_O03 message definition
...
export const omdO03PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.PATIENT_VISIT group",
  type: "Group"
});
...
export const omdO03InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.INSURANCE group",
  type: "Group"
});
...
export const omdO03TimingDietSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.TIMING_DIET group",
  type: "Group"
});
...
export const omdO03ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.OBSERVATION group",
  type: "Group"
});
...
export const omdO03TimingTraySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.TIMING_TRAY group",
  type: "Group"
});
...
export const omdO03PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.PATIENT group",
  type: "Group"
});
...
export const omdO03DietSchema = z.object({
  ...
  title: "OMD_O03.DIET",
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.DIET group",
  type: "Group"
});
...
export const omdO03OrderTraySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.ORDER_TRAY group",
  type: "Group"
});
...
export const omdO03OrderDietSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMD_O03.ORDER_DIET group",
  type: "Group"
});
...
export const omd_o03Schema = z.object({
  ...
  title: "OMD_O03",
  version: "2.9",
  description: "HL7 v2.9 OMD_O03 message",
  type: "Message"
});
