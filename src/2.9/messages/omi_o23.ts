...
/**
 * HL7 v2.9 OMI_O23 Message
 * 
 * HL7 v2.9 OMI_O23 message definition
...
/**
 * OMI_O23.OCCUPATIONAL_DATA_FOR_HEALTH group schema
 * Defines the structure and validation rules for the OMI_O23.OCCUPATIONAL_DATA_FOR_HEALTH group
 */
export const omiO23OccupationalDataForHealthSchema = z.object({
  ...
  title: "OMI_O23.OCCUPATIONAL_DATA_FOR_HEALTH",
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.OCCUPATIONAL_DATA_FOR_HEALTH group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OMI_O23.OCCUPATIONAL_DATA_FOR_HEALTH schema
 */
export type OMI_O23_OCCUPATIONAL_DATA_FOR_HEALTH = z.infer<typeof omiO23OccupationalDataForHealthSchema>;

/**
 * OMI_O23.PATIENT_VISIT group schema
 * Defines the structure and validation rules for the OMI_O23.PATIENT_VISIT group
 */
export const omiO23PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const omiO23InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.INSURANCE group",
  type: "Group"
});
 ...
 */
export const omiO23TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "OMI_O23.TIMING",
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.TIMING group",
  type: "Group"
});
 ...
 */
export const omiO23ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.OBSERVATION group",
  type: "Group"
});
...
/**
 * OMI_O23.DEVICE group schema
 * Defines the structure and validation rules for the OMI_O23.DEVICE group
 */
export const omiO23DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OMI_O23.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OMI_O23.DEVICE schema
 */
export type OMI_O23_DEVICE = z.infer<typeof omiO23DeviceSchema>;

/**
 * OMI_O23.PATIENT group schema
 * Defines the structure and validation rules for the OMI_O23.PATIENT group
 */
export const omiO23PatientSchema = z.object({
  "PID": segments.pidSchema,
  "PD1": segments.pd1Schema.optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  "OCCUPATIONAL_DATA_FOR_HEALTH": omiO23OccupationalDataForHealthSchema.optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.PATIENT group",
  type: "Group"
});
 ...
 */
export const omiO23OrderSchema = z.object({
  ...
  title: "OMI_O23.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OMI_O23.ORDER group",
  type: "Group"
});
 ...
 */
export const omi_o23Schema = z.object({
  ...
  "DEVICE": z.array(omiO23DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "OMI_O23",
  version: "2.9",
  description: "HL7 v2.9 OMI_O23 message",
  type: "Message"
});
