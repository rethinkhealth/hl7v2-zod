...
/**
 * HL7 v2.9 OML_O21 Message
 * 
 * HL7 v2.9 OML_O21 message definition
...
/**
 * OML_O21.OCCUPATIONAL_DATA_FOR_HEALTH group schema
 * Defines the structure and validation rules for the OML_O21.OCCUPATIONAL_DATA_FOR_HEALTH group
 */
export const omlO21OccupationalDataForHealthSchema = z.object({
  ...
  title: "OML_O21.OCCUPATIONAL_DATA_FOR_HEALTH",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.OCCUPATIONAL_DATA_FOR_HEALTH group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O21.OCCUPATIONAL_DATA_FOR_HEALTH schema
 */
export type OML_O21_OCCUPATIONAL_DATA_FOR_HEALTH = z.infer<typeof omlO21OccupationalDataForHealthSchema>;

/**
 * OML_O21.NEXT_OF_KIN group schema
 * Defines the structure and validation rules for the OML_O21.NEXT_OF_KIN group
 */
export const omlO21NextOfKinSchema = z.object({
  "NK1": segments.nk1Schema,
  "OH2": z.array(segments.oh2Schema).optional(),
  "OH3": segments.oh3Schema.optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.NEXT_OF_KIN",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.NEXT_OF_KIN group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O21.NEXT_OF_KIN schema
 */
export type OML_O21_NEXT_OF_KIN = z.infer<typeof omlO21NextOfKinSchema>;

/**
 * OML_O21.PATIENT_VISIT group schema
 * Defines the structure and validation rules for the OML_O21.PATIENT_VISIT group
 */
export const omlO21PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const omlO21InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.INSURANCE group",
  type: "Group"
});
 ...
 */
export const omlO21TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.TIMING",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.TIMING group",
  type: "Group"
});
 ...
 */
export const omlO21ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.OBSERVATION group",
  type: "Group"
});
...
/**
 * OML_O21.SPECIMEN_OBSERVATION group schema
 * Defines the structure and validation rules for the OML_O21.SPECIMEN_OBSERVATION group
 */
export const omlO21SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.SPECIMEN_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.SPECIMEN_OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O21.SPECIMEN_OBSERVATION schema
 */
export type OML_O21_SPECIMEN_OBSERVATION = z.infer<typeof omlO21SpecimenObservationSchema>;

/**
 * OML_O21.CONTAINER_OBSERVATION group schema
 * Defines the structure and validation rules for the OML_O21.CONTAINER_OBSERVATION group
 */
export const omlO21ContainerObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.CONTAINER_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.CONTAINER_OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O21.CONTAINER_OBSERVATION schema
 */
export type OML_O21_CONTAINER_OBSERVATION = z.infer<typeof omlO21ContainerObservationSchema>;

/**
 * OML_O21.PATIENT_PRIOR group schema
 * Defines the structure and validation rules for the OML_O21.PATIENT_PRIOR group
 */
export const omlO21PatientPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.PATIENT_PRIOR group",
  type: "Group"
});
 ...
 */
export const omlO21PatientVisitPriorSchema = z.object({
  "PV1": segments.pv1Schema,
  "PV2": segments.pv2Schema.optional(),
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.PATIENT_VISIT_PRIOR group",
  type: "Group"
});
...
/**
 * OML_O21.OBSERVATION_PARTICIPATION_PRIOR group schema
 * Defines the structure and validation rules for the OML_O21.OBSERVATION_PARTICIPATION_PRIOR group
 */
export const omlO21ObservationParticipationPriorSchema = z.object({
  "PRT": segments.prtSchema,
  "DEV": z.array(segments.devSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.OBSERVATION_PARTICIPATION_PRIOR",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.OBSERVATION_PARTICIPATION_PRIOR group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O21.OBSERVATION_PARTICIPATION_PRIOR schema
 */
export type OML_O21_OBSERVATION_PARTICIPATION_PRIOR = z.infer<typeof omlO21ObservationParticipationPriorSchema>;

/**
 * OML_O21.TIMING_PRIOR group schema
 * Defines the structure and validation rules for the OML_O21.TIMING_PRIOR group
 */
export const omlO21TimingPriorSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.TIMING_PRIOR",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.TIMING_PRIOR group",
  type: "Group"
});
 ...
 */
export const omlO21ObservationPriorSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.OBSERVATION_PRIOR group",
  type: "Group"
});
...
/**
 * OML_O21.DEVICE group schema
 * Defines the structure and validation rules for the OML_O21.DEVICE group
 */
export const omlO21DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O21.DEVICE schema
 */
export type OML_O21_DEVICE = z.infer<typeof omlO21DeviceSchema>;

/**
 * OML_O21.PATIENT group schema
 * Defines the structure and validation rules for the OML_O21.PATIENT group
 */
export const omlO21PatientSchema = z.object({
  "PID": segments.pidSchema,
  "PD1": segments.pd1Schema.optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  "OCCUPATIONAL_DATA_FOR_HEALTH": omlO21OccupationalDataForHealthSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  "NEXT_OF_KIN": z.array(omlO21NextOfKinSchema).optional(),
  "ARV": z.array(segments.arvSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.PATIENT group",
  type: "Group"
});
 ...
 */
export const omlO21ContainerSchema = z.object({
  "SAC": segments.sacSchema,
  "NTE": z.array(segments.nteSchema).optional(),
  "CONTAINER_OBSERVATION": z.array(omlO21ContainerObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.CONTAINER",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.CONTAINER group",
  type: "Group"
});
 ...
 */
export const omlO21OrderPriorSchema = z.object({
  "ORC": segments.orcSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "OBR": segments.obrSchema,
  "NTE": z.array(segments.nteSchema).optional(),
  "OBSERVATION_PARTICIPATION_PRIOR": z.array(omlO21ObservationParticipationPriorSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.ORDER_PRIOR group",
  type: "Group"
});
 ...
 */
export const omlO21SpecimenSchema = z.object({
  "SPM": segments.spmSchema,
  "NTE": z.array(segments.nteSchema).optional(),
  "SPECIMEN_OBSERVATION": z.array(omlO21SpecimenObservationSchema).optional(),
  "CONTAINER": z.array(omlO21ContainerSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21.SPECIMEN",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.SPECIMEN group",
  type: "Group"
});
 ...
 */
export const omlO21PriorResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.PRIOR_RESULT group",
  type: "Group"
});
 ...
 */
export const omlO21ObservationRequestSchema = z.object({
  "OBR": segments.obrSchema,
  "TCD": segments.tcdSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O21.OBSERVATION_REQUEST group",
  type: "Group"
});
 ...
 */
export const omlO21OrderSchema = z.object({
  "ORC": segments.orcSchema,
  "NTE": z.array(segments.nteSchema).optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  ...
  title: "OML_O21.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OML_O21.ORDER group",
  type: "Group"
});
 ...
 */
export const oml_o21Schema = z.object({
  ...
  "DEVICE": z.array(omlO21DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O21",
  version: "2.9",
  description: "HL7 v2.9 OML_O21 message",
  type: "Message"
});
