...
/**
 * HL7 v2.9 OML_O33 Message
 * 
 * HL7 v2.9 OML_O33 message definition
...
/**
 * OML_O33.OCCUPATIONAL_DATA_FOR_HEALTH group schema
 * Defines the structure and validation rules for the OML_O33.OCCUPATIONAL_DATA_FOR_HEALTH group
 */
export const omlO33OccupationalDataForHealthSchema = z.object({
  ...
  title: "OML_O33.OCCUPATIONAL_DATA_FOR_HEALTH",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.OCCUPATIONAL_DATA_FOR_HEALTH group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O33.OCCUPATIONAL_DATA_FOR_HEALTH schema
 */
export type OML_O33_OCCUPATIONAL_DATA_FOR_HEALTH = z.infer<typeof omlO33OccupationalDataForHealthSchema>;

/**
 * OML_O33.NEXT_OF_KIN group schema
 * Defines the structure and validation rules for the OML_O33.NEXT_OF_KIN group
 */
export const omlO33NextOfKinSchema = z.object({
  "NK1": segments.nk1Schema,
  "OH2": z.array(segments.oh2Schema).optional(),
  "OH3": segments.oh3Schema.optional()
}).register(hl7v2Metadata, {
  title: "OML_O33.NEXT_OF_KIN",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.NEXT_OF_KIN group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O33.NEXT_OF_KIN schema
 */
export type OML_O33_NEXT_OF_KIN = z.infer<typeof omlO33NextOfKinSchema>;
...
export const omlO33PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.PATIENT_VISIT group",
  type: "Group"
});
...
export const omlO33InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.INSURANCE group",
  type: "Group"
});
...
export const omlO33SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
/**
 * OML_O33.SPECIMEN_CONTAINER group schema
 * Defines the structure and validation rules for the OML_O33.SPECIMEN_CONTAINER group
 */
export const omlO33SpecimenContainerSchema = z.object({
  "SAC": segments.sacSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O33.SPECIMEN_CONTAINER",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.SPECIMEN_CONTAINER group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O33.SPECIMEN_CONTAINER schema
 */
export type OML_O33_SPECIMEN_CONTAINER = z.infer<typeof omlO33SpecimenContainerSchema>;
...
export const omlO33TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.TIMING group",
  type: "Group"
});
...
export const omlO33ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.OBSERVATION group",
  type: "Group"
});
...
export const omlO33PatientPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.PATIENT_PRIOR group",
  type: "Group"
});
...
export const omlO33PatientVisitPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.PATIENT_VISIT_PRIOR group",
  type: "Group"
});
...
/**
 * OML_O33.OBSERVATION_PARTICIPATION_PRIOR group schema
 * Defines the structure and validation rules for the OML_O33.OBSERVATION_PARTICIPATION_PRIOR group
 */
export const omlO33ObservationParticipationPriorSchema = z.object({
  "PRT": segments.prtSchema,
  "DEV": z.array(segments.devSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O33.OBSERVATION_PARTICIPATION_PRIOR",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.OBSERVATION_PARTICIPATION_PRIOR group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O33.OBSERVATION_PARTICIPATION_PRIOR schema
 */
export type OML_O33_OBSERVATION_PARTICIPATION_PRIOR = z.infer<typeof omlO33ObservationParticipationPriorSchema>;
...
export const omlO33TimingPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.TIMING_PRIOR group",
  type: "Group"
});
...
export const omlO33ObservationPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.OBSERVATION_PRIOR group",
  type: "Group"
});
...
/**
 * OML_O33.DEVICE group schema
 * Defines the structure and validation rules for the OML_O33.DEVICE group
 */
export const omlO33DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O33.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O33.DEVICE schema
 */
export type OML_O33_DEVICE = z.infer<typeof omlO33DeviceSchema>;
...
export const omlO33PatientSchema = z.object({
  ...
  "PD1": segments.pd1Schema.optional(),
  "PRT": z.array(segments.prtSchema).optional(),
  "OCCUPATIONAL_DATA_FOR_HEALTH": omlO33OccupationalDataForHealthSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  "NEXT_OF_KIN": z.array(omlO33NextOfKinSchema).optional(),
  "ARV": z.array(segments.arvSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.PATIENT group",
  type: "Group"
});
...
export const omlO33OrderPriorSchema = z.object({
  ...
  "NTE": z.array(segments.nteSchema).optional(),
  "OBSERVATION_PARTICIPATION_PRIOR": z.array(omlO33ObservationParticipationPriorSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.ORDER_PRIOR group",
  type: "Group"
});
...
export const omlO33PriorResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.PRIOR_RESULT group",
  type: "Group"
});
...
export const omlO33ObservationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O33.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const omlO33OrderSchema = z.object({
  ...
  title: "OML_O33.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.ORDER group",
  type: "Group"
});
...
export const omlO33SpecimenSchema = z.object({
  ...
  "SPECIMEN_CONTAINER": z.array(omlO33SpecimenContainerSchema).optional(),
  "ORDER": z.array(omlO33OrderSchema)
}).register(hl7v2Metadata, {
  title: "OML_O33.SPECIMEN",
  version: "2.9",
  description: "HL7 v2.9 OML_O33.SPECIMEN group",
  type: "Group"
});
...
export const oml_o33Schema = z.object({
  ...
  "DEVICE": z.array(omlO33DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O33",
  version: "2.9",
  description: "HL7 v2.9 OML_O33 message",
  type: "Message"
});
