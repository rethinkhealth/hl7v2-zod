...
/**
 * HL7 v2.9 OML_O39 Message
 * 
 * HL7 v2.9 OML_O39 message definition
...
/**
 * OML_O39.OCCUPATIONAL_DATA_FOR_HEALTH group schema
 * Defines the structure and validation rules for the OML_O39.OCCUPATIONAL_DATA_FOR_HEALTH group
 */
export const omlO39OccupationalDataForHealthSchema = z.object({
  ...
  title: "OML_O39.OCCUPATIONAL_DATA_FOR_HEALTH",
  version: "2.9",
  description: "HL7 v2.9 OML_O39.OCCUPATIONAL_DATA_FOR_HEALTH group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O39.OCCUPATIONAL_DATA_FOR_HEALTH schema
 */
export type OML_O39_OCCUPATIONAL_DATA_FOR_HEALTH = z.infer<typeof omlO39OccupationalDataForHealthSchema>;

/**
 * OML_O39.NEXT_OF_KIN group schema
 * Defines the structure and validation rules for the OML_O39.NEXT_OF_KIN group
 */
export const omlO39NextOfKinSchema = z.object({
  "NK1": segments.nk1Schema,
  "OH2": z.array(segments.oh2Schema).optional(),
  "OH3": segments.oh3Schema.optional()
}).register(hl7v2Metadata, {
  title: "OML_O39.NEXT_OF_KIN",
  version: "2.9",
  description: "HL7 v2.9 OML_O39.NEXT_OF_KIN group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O39.NEXT_OF_KIN schema
 */
export type OML_O39_NEXT_OF_KIN = z.infer<typeof omlO39NextOfKinSchema>;
...
export const omlO39PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.PATIENT_VISIT group",
  type: "Group"
});
...
export const omlO39InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.INSURANCE group",
  type: "Group"
});
...
export const omlO39TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.TIMING group",
  type: "Group"
});
...
export const omlO39ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.OBSERVATION group",
  type: "Group"
});
...
export const omlO39ShipmentObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.SHIPMENT_OBSERVATION group",
  type: "Group"
});
...
export const omlO39SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const omlO39ContainerObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.CONTAINER_OBSERVATION group",
  type: "Group"
});
...
/**
 * OML_O39.DEVICE group schema
 * Defines the structure and validation rules for the OML_O39.DEVICE group
 */
export const omlO39DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O39.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OML_O39.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OML_O39.DEVICE schema
 */
export type OML_O39_DEVICE = z.infer<typeof omlO39DeviceSchema>;
...
export const omlO39PatientSchema = z.object({
  ...
  "PRT": z.array(segments.prtSchema).optional(),
  "OCCUPATIONAL_DATA_FOR_HEALTH": omlO39OccupationalDataForHealthSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  "NEXT_OF_KIN": z.array(omlO39NextOfKinSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.PATIENT group",
  type: "Group"
});
...
export const omlO39SpecimenContainerInPackageSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.SPECIMEN_CONTAINER_IN_PACKAGE group",
  type: "Group"
});
...
export const omlO39SpecimenInPackageSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.SPECIMEN_IN_PACKAGE group",
  type: "Group"
});
...
export const omlO39PackageSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.PACKAGE group",
  type: "Group"
});
...
export const omlO39SpecimenShipmentSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.SPECIMEN_SHIPMENT group",
  type: "Group"
});
...
export const omlO39ObservationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OML_O39.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const omlO39OrderSchema = z.object({
  ...
  title: "OML_O39.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OML_O39.ORDER group",
  type: "Group"
});
...
export const oml_o39Schema = z.object({
  ...
  "DEVICE": z.array(omlO39DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "OML_O39",
  version: "2.9",
  description: "HL7 v2.9 OML_O39 message",
  type: "Message"
});
