...
/**
 * HL7 v2.9 OMQ_O57 Message
 * 
 * HL7 v2.9 OMQ_O57 message definition
...
export const omqO57PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.PATIENT_VISIT group",
  type: "Group"
});
...
export const omqO57InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.INSURANCE group",
  type: "Group"
});
...
export const omqO57ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.OBSERVATION group",
  type: "Group"
});
...
export const omqO57PatientPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.PATIENT_PRIOR group",
  type: "Group"
});
...
export const omqO57PatientVisitPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.PATIENT_VISIT_PRIOR group",
  type: "Group"
});
...
export const omqO57TimingPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.TIMING_PRIOR group",
  type: "Group"
});
...
/**
 * OMQ_O57.OBSERVATION_PARTICIPATION_PRIOR group schema
 * Defines the structure and validation rules for the OMQ_O57.OBSERVATION_PARTICIPATION_PRIOR group
 */
export const omqO57ObservationParticipationPriorSchema = z.object({
  "PRT": segments.prtSchema,
  "DEV": z.array(segments.devSchema).optional()
}).register(hl7v2Metadata, {
  title: "OMQ_O57.OBSERVATION_PARTICIPATION_PRIOR",
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.OBSERVATION_PARTICIPATION_PRIOR group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OMQ_O57.OBSERVATION_PARTICIPATION_PRIOR schema
 */
export type OMQ_O57_OBSERVATION_PARTICIPATION_PRIOR = z.infer<typeof omqO57ObservationParticipationPriorSchema>;
...
export const omqO57ObservationPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.OBSERVATION_PRIOR group",
  type: "Group"
});
...
export const omqO57PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.PATIENT group",
  type: "Group"
});
...
export const omqO57OrderPriorSchema = z.object({
  ...
  "NTE": z.array(segments.nteSchema).optional(),
  "OBSERVATION_PARTICIPATION_PRIOR": z.array(omqO57ObservationParticipationPriorSchema).optional(),
  "CTD": segments.ctdSchema.optional(),
  "OBSERVATION_PRIOR": z.array(omqO57ObservationPriorSchema)
}).register(hl7v2Metadata, {
  title: "OMQ_O57.ORDER_PRIOR",
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.ORDER_PRIOR group",
  type: "Group"
});
...
export const omqO57PriorResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.PRIOR_RESULT group",
  type: "Group"
});
...
export const omqO57OrderSchema = z.object({
  ...
  title: "OMQ_O57.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57.ORDER group",
  type: "Group"
});
...
export const omq_o57Schema = z.object({
  ...
  title: "OMQ_O57",
  version: "2.9",
  description: "HL7 v2.9 OMQ_O57 message",
  type: "Message"
});
