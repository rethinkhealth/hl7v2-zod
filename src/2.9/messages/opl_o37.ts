...
/**
 * HL7 v2.9 OPL_O37 Message
 * 
 * HL7 v2.9 OPL_O37 message definition
...
export const oplO37GuarantorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.GUARANTOR group",
  type: "Group"
});
...
export const oplO37ObservationsOnPatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.OBSERVATIONS_ON_PATIENT group",
  type: "Group"
});
...
export const oplO37InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.INSURANCE group",
  type: "Group"
});
...
export const oplO37SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const oplO37ContainerObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.CONTAINER_OBSERVATION group",
  type: "Group"
});
...
export const oplO37TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.TIMING group",
  type: "Group"
});
...
export const oplO37OrderRelatedObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.ORDER_RELATED_OBSERVATION group",
  type: "Group"
});
...
export const oplO37PatientPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.PATIENT_PRIOR group",
  type: "Group"
});
...
export const oplO37PatientVisitPriorSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.PATIENT_VISIT_PRIOR group",
  type: "Group"
});
...
/**
 * OPL_O37.OBSERVATION_PARTICIPATION_PRIOR group schema
 * Defines the structure and validation rules for the OPL_O37.OBSERVATION_PARTICIPATION_PRIOR group
 */
export const oplO37ObservationParticipationPriorSchema = z.object({
  "PRT": segments.prtSchema,
  "DEV": z.array(segments.devSchema).optional()
}).register(hl7v2Metadata, {
  title: "OPL_O37.OBSERVATION_PARTICIPATION_PRIOR",
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.OBSERVATION_PARTICIPATION_PRIOR group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OPL_O37.OBSERVATION_PARTICIPATION_PRIOR schema
 */
export type OPL_O37_OBSERVATION_PARTICIPATION_PRIOR = z.infer<typeof oplO37ObservationParticipationPriorSchema>;
...
export const oplO37ObservationResultGroupSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.OBSERVATION_RESULT_GROUP group",
  type: "Group"
});
...
export const oplO37PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.PATIENT group",
  type: "Group"
});
...
export const oplO37ContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.CONTAINER group",
  type: "Group"
});
...
export const oplO37ObservationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const oplO37OrderPriorSchema = z.object({
  ...
  "OBSERVATION_PARTICIPATION_PRIOR": z.array(oplO37ObservationParticipationPriorSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.ORDER_PRIOR group",
  type: "Group"
});
...
export const oplO37SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.SPECIMEN group",
  type: "Group"
});
...
export const oplO37PriorResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.PRIOR_RESULT group",
  type: "Group"
});
...
export const oplO37OrderSchema = z.object({
  ...
  title: "OPL_O37.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OPL_O37.ORDER group",
  type: "Group"
});
...
export const opl_o37Schema = z.object({
  ...
  title: "OPL_O37",
  version: "2.9",
  description: "HL7 v2.9 OPL_O37 message",
  type: "Message"
});
