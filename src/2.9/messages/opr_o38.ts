...
/**
 * HL7 v2.9 OPR_O38 Message
 * 
 * HL7 v2.9 OPR_O38 message definition
...
/**
 * OPR_O38.PATIENT group schema
 * Defines the structure and validation rules for the OPR_O38.PATIENT group
 */
export const oprO38PatientSchema = z.object({
  "PID": segments.pidSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "ARV": z.array(segments.arvSchema).optional()
}).register(hl7v2Metadata, {
  title: "OPR_O38.PATIENT",
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.PATIENT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OPR_O38.PATIENT schema
 */
export type OPR_O38_PATIENT = z.infer<typeof oprO38PatientSchema>;
 ...
 */
export const oprO38SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OPR_O38.SPECIMEN_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.SPECIMEN_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const oprO38ObservationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.OBSERVATION_REQUEST group",
  type: "Group"
});
 ...
 */
export const oprO38TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "OPR_O38.TIMING",
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.TIMING group",
  type: "Group"
});
 ...
 */
export const oprO38SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.SPECIMEN group",
  type: "Group"
});
 ...
 */
export const oprO38OrderSchema = z.object({
  "NK1": z.array(segments.nk1Schema),
  "PATIENT": oprO38PatientSchema.optional(),
  "SPECIMEN": z.array(oprO38SpecimenSchema).optional()
}).register(hl7v2Metadata, {
  title: "OPR_O38.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.ORDER group",
  type: "Group"
});
 ...
 */
export const oprO38ResponseSchema = z.object({
  "ORDER": z.array(oprO38OrderSchema)
}).register(hl7v2Metadata, {
  title: "OPR_O38.RESPONSE",
  version: "2.9",
  description: "HL7 v2.9 OPR_O38.RESPONSE group",
  type: "Group"
});
 ...
 */
export const opr_o38Schema = z.object({
  ...
  title: "OPR_O38",
  version: "2.9",
  description: "HL7 v2.9 OPR_O38 message",
  type: "Message"
});
