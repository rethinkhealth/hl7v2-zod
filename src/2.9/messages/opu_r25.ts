...
/**
 * HL7 v2.9 OPU_R25 Message
 * 
 * HL7 v2.9 OPU_R25 message definition
...
export const opuR25PatientVisitObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.PATIENT_VISIT_OBSERVATION group",
  type: "Group"
});
...
export const opuR25PatientObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const opuR25SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const opuR25ContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.CONTAINER group",
  type: "Group"
});
...
export const opuR25CommonOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.COMMON_ORDER group",
  type: "Group"
});
...
export const opuR25TimingQtySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.TIMING_QTY group",
  type: "Group"
});
...
export const opuR25ResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.RESULT group",
  type: "Group"
});
...
export const opuR25PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.PATIENT group",
  type: "Group"
});
...
export const opuR25OrderSchema = z.object({
  ...
  title: "OPU_R25.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.ORDER group",
  type: "Group"
});
...
export const opuR25SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.SPECIMEN group",
  type: "Group"
});
...
export const opuR25AccessionDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OPU_R25.ACCESSION_DETAIL group",
  type: "Group"
});
...
export const opu_r25Schema = z.object({
  ...
  title: "OPU_R25",
  version: "2.9",
  description: "HL7 v2.9 OPU_R25 message",
  type: "Message"
});
