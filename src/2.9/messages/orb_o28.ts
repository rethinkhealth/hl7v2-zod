...
/**
 * HL7 v2.9 ORB_O28 Message
 * 
 * HL7 v2.9 ORB_O28 message definition
 ...
 */
export const orbO28TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "ORB_O28.TIMING",
  version: "2.9",
  description: "HL7 v2.9 ORB_O28.TIMING group",
  type: "Group"
});
 ...
 */
export const orbO28OrderSchema = z.object({
  ...
  title: "ORB_O28.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORB_O28.ORDER group",
  type: "Group"
});
 ...
 */
export const orbO28PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORB_O28.PATIENT group",
  type: "Group"
});
 ...
 */
export const orbO28ResponseSchema = z.object({
  "PATIENT": orbO28PatientSchema.optional()
}).register(hl7v2Metadata, {
  title: "ORB_O28.RESPONSE",
  version: "2.9",
  description: "HL7 v2.9 ORB_O28.RESPONSE group",
  type: "Group"
});
 ...
 */
export const orb_o28Schema = z.object({
  ...
  title: "ORB_O28",
  version: "2.9",
  description: "HL7 v2.9 ORB_O28 message",
  type: "Message"
});
