...
/**
 * HL7 v2.9 ORD_O04 Message
 * 
 * HL7 v2.9 ORD_O04 message definition
...
export const ordO04PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORD_O04.PATIENT group",
  type: "Group"
});
...
export const ordO04TimingDietSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORD_O04.TIMING_DIET group",
  type: "Group"
});
...
export const ordO04TimingTraySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORD_O04.TIMING_TRAY group",
  type: "Group"
});
...
export const ordO04OrderDietSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORD_O04.ORDER_DIET group",
  type: "Group"
});
...
export const ordO04OrderTraySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORD_O04.ORDER_TRAY group",
  type: "Group"
});
...
export const ordO04ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORD_O04.RESPONSE group",
  type: "Group"
});
...
export const ord_o04Schema = z.object({
  ...
  title: "ORD_O04",
  version: "2.9",
  description: "HL7 v2.9 ORD_O04 message",
  type: "Message"
});
