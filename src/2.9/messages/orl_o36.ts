...
/**
 * HL7 v2.9 ORL_O36 Message
 * 
 * HL7 v2.9 ORL_O36 message definition
...
export const orlO36SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const orlO36TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.TIMING group",
  type: "Group"
});
...
export const orlO36ObservationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.OBSERVATION_REQUEST group",
  type: "Group"
});
...
export const orlO36OrderSchema = z.object({
  ...
  title: "ORL_O36.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.ORDER group",
  type: "Group"
});
...
export const orlO36SpecimenContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.SPECIMEN_CONTAINER group",
  type: "Group"
});
...
export const orlO36SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.SPECIMEN group",
  type: "Group"
});
...
export const orlO36ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O36.RESPONSE group",
  type: "Group"
});
...
export const orl_o36Schema = z.object({
  ...
  title: "ORL_O36",
  version: "2.9",
  description: "HL7 v2.9 ORL_O36 message",
  type: "Message"
});
