...
/**
 * HL7 v2.9 ORL_O40 Message
 * 
 * HL7 v2.9 ORL_O40 message definition
 ...
 */
export const orlO40TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "ORL_O40.TIMING",
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.TIMING group",
  type: "Group"
});
 ...
 */
export const orlO40SpecimenContainerInPackageSchema = z.object({
  "SAC": segments.sacSchema
}).register(hl7v2Metadata, {
  title: "ORL_O40.SPECIMEN_CONTAINER_IN_PACKAGE",
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.SPECIMEN_CONTAINER_IN_PACKAGE group",
  type: "Group"
});
 ...
 */
export type ORL_O40_SPECIMEN_CONTAINER_IN_PACKAGE = z.infer<typeof orlO40SpecimenContainerInPackageSchema>;
 ...
 */
export const orlO40SpecimenInPackageSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.SPECIMEN_IN_PACKAGE group",
  type: "Group"
});
 ...
 */
export const orlO40SpecimenShipmentSchema = z.object({
  "SHP": segments.shpSchema,
  "PACKAGE": z.array(orlO40PackageSchema)
}).register(hl7v2Metadata, {
  title: "ORL_O40.SPECIMEN_SHIPMENT",
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.SPECIMEN_SHIPMENT group",
  type: "Group"
});
 ...
 */
export const orlO40ObservationRequestSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.OBSERVATION_REQUEST group",
  type: "Group"
});
 ...
 */
export const orlO40OrderSchema = z.object({
  ...
  title: "ORL_O40.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.ORDER group",
  type: "Group"
});
 ...
 */
export const orlO40PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.PATIENT group",
  type: "Group"
});
 ...
 */
export const orlO40ResponseSchema = z.object({
  "PATIENT": orlO40PatientSchema.optional()
}).register(hl7v2Metadata, {
  title: "ORL_O40.RESPONSE",
  version: "2.9",
  description: "HL7 v2.9 ORL_O40.RESPONSE group",
  type: "Group"
});
 ...
 */
export const orl_o40Schema = z.object({
  ...
  title: "ORL_O40",
  version: "2.9",
  description: "HL7 v2.9 ORL_O40 message",
  type: "Message"
});
