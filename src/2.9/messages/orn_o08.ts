...
/**
 * HL7 v2.9 ORN_O08 Message
 * 
 * HL7 v2.9 ORN_O08 message definition
...
export const ornO08PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORN_O08.PATIENT group",
  type: "Group"
});
...
export const ornO08TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORN_O08.TIMING group",
  type: "Group"
});
...
export const ornO08OrderSchema = z.object({
  ...
  title: "ORN_O08.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORN_O08.ORDER group",
  type: "Group"
});
...
export const ornO08ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORN_O08.RESPONSE group",
  type: "Group"
});
...
export const orn_o08Schema = z.object({
  ...
  title: "ORN_O08",
  version: "2.9",
  description: "HL7 v2.9 ORN_O08 message",
  type: "Message"
});
