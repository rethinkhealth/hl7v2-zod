...
/**
 * HL7 v2.9 ORP_O10 Message
 * 
 * HL7 v2.9 ORP_O10 message definition
...
export const orpO10PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORP_O10.PATIENT group",
  type: "Group"
});
...
export const orpO10TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORP_O10.TIMING group",
  type: "Group"
});
...
export const orpO10ComponentSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORP_O10.COMPONENT group",
  type: "Group"
});
...
export const orpO10OrderDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORP_O10.ORDER_DETAIL group",
  type: "Group"
});
...
export const orpO10OrderSchema = z.object({
  ...
  title: "ORP_O10.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORP_O10.ORDER group",
  type: "Group"
});
...
export const orpO10ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORP_O10.RESPONSE group",
  type: "Group"
});
...
export const orp_o10Schema = z.object({
  ...
  title: "ORP_O10",
  version: "2.9",
  description: "HL7 v2.9 ORP_O10 message",
  type: "Message"
});
