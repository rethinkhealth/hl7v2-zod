...
/**
 * HL7 v2.9 ORS_O06 Message
 * 
 * HL7 v2.9 ORS_O06 message definition
 ...
 */
export const orsO06PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORS_O06.PATIENT group",
  type: "Group"
});
 ...
 */
export const orsO06TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "ORS_O06.TIMING",
  version: "2.9",
  description: "HL7 v2.9 ORS_O06.TIMING group",
  type: "Group"
});
 ...
 */
export const orsO06OrderSchema = z.object({
  ...
  title: "ORS_O06.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORS_O06.ORDER group",
  type: "Group"
});
 ...
 */
export const ors_o06Schema = z.object({
  ...
  title: "ORS_O06",
  version: "2.9",
  description: "HL7 v2.9 ORS_O06 message",
  type: "Message"
});
