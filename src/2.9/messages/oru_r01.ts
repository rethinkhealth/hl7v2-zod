...
/**
 * HL7 v2.9 ORU_R01 Message
 * 
 * HL7 v2.9 ORU_R01 message definition
...
/**
 * ORU_R01.NEXT_OF_KIN group schema
 * Defines the structure and validation rules for the ORU_R01.NEXT_OF_KIN group
 */
export const oruR01NextOfKinSchema = z.object({
  "NK1": segments.nk1Schema,
  "OH2": z.array(segments.oh2Schema).optional(),
  "OH3": segments.oh3Schema.optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.NEXT_OF_KIN",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.NEXT_OF_KIN group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.NEXT_OF_KIN schema
 */
export type ORU_R01_NEXT_OF_KIN = z.infer<typeof oruR01NextOfKinSchema>;
...
export const oruR01PatientObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const oruR01VisitSchema = z.object({
  ...
  title: "ORU_R01.VISIT",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.VISIT group",
  type: "Group"
});
...
/**
 * ORU_R01.INSURANCE group schema
 * Defines the structure and validation rules for the ORU_R01.INSURANCE group
 */
export const oruR01InsuranceSchema = z.object({
  "IN1": segments.in1Schema,
  "IN2": segments.in2Schema.optional(),
  "IN3": segments.in3Schema.optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.INSURANCE",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.INSURANCE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.INSURANCE schema
 */
export type ORU_R01_INSURANCE = z.infer<typeof oruR01InsuranceSchema>;

/**
 * ORU_R01.ORDER_DOCUMENT group schema
 * Defines the structure and validation rules for the ORU_R01.ORDER_DOCUMENT group
 */
export const oruR01OrderDocumentSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "TXA": segments.txaSchema
}).register(hl7v2Metadata, {
  title: "ORU_R01.ORDER_DOCUMENT",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.ORDER_DOCUMENT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.ORDER_DOCUMENT schema
 */
export type ORU_R01_ORDER_DOCUMENT = z.infer<typeof oruR01OrderDocumentSchema>;

/**
 * ORU_R01.OBSERVATION_PARTICIPATION group schema
 * Defines the structure and validation rules for the ORU_R01.OBSERVATION_PARTICIPATION group
 */
export const oruR01ObservationParticipationSchema = z.object({
  "PRT": segments.prtSchema,
  "DEV": z.array(segments.devSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.OBSERVATION_PARTICIPATION",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.OBSERVATION_PARTICIPATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.OBSERVATION_PARTICIPATION schema
 */
export type ORU_R01_OBSERVATION_PARTICIPATION = z.infer<typeof oruR01ObservationParticipationSchema>;
...
export const oruR01TimingQtySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.TIMING_QTY group",
  type: "Group"
});
...
export const oruR01ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.OBSERVATION group",
  type: "Group"
});
...
/**
 * ORU_R01.SPECIMEN_OBSERVATION group schema
 * Defines the structure and validation rules for the ORU_R01.SPECIMEN_OBSERVATION group
 */
export const oruR01SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.SPECIMEN_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.SPECIMEN_OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.SPECIMEN_OBSERVATION schema
 */
export type ORU_R01_SPECIMEN_OBSERVATION = z.infer<typeof oruR01SpecimenObservationSchema>;

/**
 * ORU_R01.DEVICE group schema
 * Defines the structure and validation rules for the ORU_R01.DEVICE group
 */
export const oruR01DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.DEVICE schema
 */
export type ORU_R01_DEVICE = z.infer<typeof oruR01DeviceSchema>;
...
export const oruR01PatientSchema = z.object({
  ...
  "NTE": z.array(segments.nteSchema).optional(),
  "NEXT_OF_KIN": z.array(oruR01NextOfKinSchema).optional(),
  "ARV": z.array(segments.arvSchema).optional(),
  "PATIENT_OBSERVATION": z.array(oruR01PatientObservationSchema).optional(),
  "VISIT": oruR01VisitSchema.optional(),
  "INSURANCE": z.array(oruR01InsuranceSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.PATIENT",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.PATIENT group",
  type: "Group"
});
...
/**
 * ORU_R01.COMMON_ORDER group schema
 * Defines the structure and validation rules for the ORU_R01.COMMON_ORDER group
 */
export const oruR01CommonOrderSchema = z.object({
  "ORC": segments.orcSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "ORDER_DOCUMENT": oruR01OrderDocumentSchema.optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.COMMON_ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.COMMON_ORDER group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R01.COMMON_ORDER schema
 */
export type ORU_R01_COMMON_ORDER = z.infer<typeof oruR01CommonOrderSchema>;
...
export const oruR01SpecimenSchema = z.object({
  ...
  "SPECIMEN_OBSERVATION": z.array(oruR01SpecimenObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.SPECIMEN",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.SPECIMEN group",
  type: "Group"
});
...
export const oruR01OrderObservationSchema = z.object({
  "COMMON_ORDER": oruR01CommonOrderSchema.optional(),
  "OBR": segments.obrSchema,
  "NTE": z.array(segments.nteSchema).optional(),
  "OBSERVATION_PARTICIPATION": z.array(oruR01ObservationParticipationSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.ORDER_OBSERVATION group",
  type: "Group"
});
...
export const oruR01PatientResultSchema = z.object({
  ...
  "DEVICE": z.array(oruR01DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R01.PATIENT_RESULT",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01.PATIENT_RESULT group",
  type: "Group"
});
...
export const oru_r01Schema = z.object({
  ...
  title: "ORU_R01",
  version: "2.9",
  description: "HL7 v2.9 ORU_R01 message",
  type: "Message"
});
