...
/**
 * HL7 v2.9 ORU_R30 Message
 * 
 * HL7 v2.9 ORU_R30 message definition
 ...
 */
export const oruR30PatientObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R30.PATIENT_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 ORU_R30.PATIENT_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const oruR30VisitSchema = z.object({
  ...
  title: "ORU_R30.VISIT",
  version: "2.9",
  description: "HL7 v2.9 ORU_R30.VISIT group",
  type: "Group"
});
 ...
 */
export const oruR30TimingQtySchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R30.TIMING_QTY",
  version: "2.9",
  description: "HL7 v2.9 ORU_R30.TIMING_QTY group",
  type: "Group"
});
 ...
 */
export const oruR30ObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 ORU_R30.OBSERVATION group",
  type: "Group"
});
...
/**
 * ORU_R30.DEVICE group schema
 * Defines the structure and validation rules for the ORU_R30.DEVICE group
 */
export const oruR30DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R30.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 ORU_R30.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the ORU_R30.DEVICE schema
 */
export type ORU_R30_DEVICE = z.infer<typeof oruR30DeviceSchema>;

/**
 * ORU_R30 message schema
 * Defines the structure and validation rules for the ORU_R30 message
 */
export const oru_r30Schema = z.object({
  ...
  "DEVICE": z.array(oruR30DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "ORU_R30",
  version: "2.9",
  description: "HL7 v2.9 ORU_R30 message",
  type: "Message"
});
