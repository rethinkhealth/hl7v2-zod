...
/**
 * HL7 v2.9 ORX_O58 Message
 * 
 * HL7 v2.9 ORX_O58 message definition
...
export const orxO58PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORX_O58.PATIENT group",
  type: "Group"
});
...
export const orxO58OrderSchema = z.object({
  ...
  title: "ORX_O58.ORDER",
  version: "2.9",
  description: "HL7 v2.9 ORX_O58.ORDER group",
  type: "Group"
});
...
export const orxO58ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 ORX_O58.RESPONSE group",
  type: "Group"
});
...
export const orx_o58Schema = z.object({
  ...
  title: "ORX_O58",
  version: "2.9",
  description: "HL7 v2.9 ORX_O58 message",
  type: "Message"
});
