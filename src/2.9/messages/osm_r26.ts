...
/**
 * HL7 v2.9 OSM_R26 Message
 * 
 * HL7 v2.9 OSM_R26 message definition
...
export const osmR26ShippingObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.SHIPPING_OBSERVATION group",
  type: "Group"
});
...
export const osmR26SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const osmR26ContainerObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.CONTAINER_OBSERVATION group",
  type: "Group"
});
...
export const osmR26PatientObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const osmR26PatientVisitObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.PATIENT_VISIT_OBSERVATION group",
  type: "Group"
});
...
export const osmR26ContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.CONTAINER group",
  type: "Group"
});
...
export const osmR26SubjectPersonOrAnimalIdentificationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.SUBJECT_PERSON_OR_ANIMAL_IDENTIFICATION group",
  type: "Group"
});
...
export const osmR26SubjectPopulationOrLocationIdentificationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.SUBJECT_POPULATION_OR_LOCATION_IDENTIFICATION group",
  type: "Group"
});
...
export const osmR26SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.SPECIMEN group",
  type: "Group"
});
...
export const osmR26PackageSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.PACKAGE group",
  type: "Group"
});
...
export const osmR26ShipmentSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OSM_R26.SHIPMENT group",
  type: "Group"
});
...
export const osm_r26Schema = z.object({
  ...
  title: "OSM_R26",
  version: "2.9",
  description: "HL7 v2.9 OSM_R26 message",
  type: "Message"
});
