...
/**
 * HL7 v2.9 OUL_R22 Message
 * 
 * HL7 v2.9 OUL_R22 message definition
 ...
 */
export const oulR22PatientObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R22.PATIENT_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const oulR22VisitSchema = z.object({
  ...
  title: "OUL_R22.VISIT",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.VISIT group",
  type: "Group"
});
 ...
 */
export const oulR22SpecimenObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R22.SPECIMEN_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const oulR22ContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.CONTAINER group",
  type: "Group"
});
...
/**
 * OUL_R22.ORDER_DOCUMENT group schema
 * Defines the structure and validation rules for the OUL_R22.ORDER_DOCUMENT group
 */
export const oulR22OrderDocumentSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "TXA": segments.txaSchema
}).register(hl7v2Metadata, {
  title: "OUL_R22.ORDER_DOCUMENT",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.ORDER_DOCUMENT group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OUL_R22.ORDER_DOCUMENT schema
 */
export type OUL_R22_ORDER_DOCUMENT = z.infer<typeof oulR22OrderDocumentSchema>;
...
export const oulR22TimingQtySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.TIMING_QTY group",
  type: "Group"
});
...
export const oulR22ResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.RESULT group",
  type: "Group"
});
...
/**
 * OUL_R22.DEVICE group schema
 * Defines the structure and validation rules for the OUL_R22.DEVICE group
 */
export const oulR22DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R22.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OUL_R22.DEVICE schema
 */
export type OUL_R22_DEVICE = z.infer<typeof oulR22DeviceSchema>;
...
export const oulR22PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.PATIENT group",
  type: "Group"
});
...
/**
 * OUL_R22.COMMON_ORDER group schema
 * Defines the structure and validation rules for the OUL_R22.COMMON_ORDER group
 */
export const oulR22CommonOrderSchema = z.object({
  "ORC": segments.orcSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  "ORDER_DOCUMENT": oulR22OrderDocumentSchema.optional()
}).register(hl7v2Metadata, {
  title: "OUL_R22.COMMON_ORDER",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.COMMON_ORDER group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OUL_R22.COMMON_ORDER schema
 */
export type OUL_R22_COMMON_ORDER = z.infer<typeof oulR22CommonOrderSchema>;
...
export const oulR22OrderSchema = z.object({
  ...
  "PRT": z.array(segments.prtSchema).optional(),
  "COMMON_ORDER": oulR22CommonOrderSchema.optional(),
  "NTE": z.array(segments.nteSchema).optional(),
  ...
  title: "OUL_R22.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.ORDER group",
  type: "Group"
});
...
export const oulR22SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R22.SPECIMEN group",
  type: "Group"
});
...
export const oul_r22Schema = z.object({
  ...
  "DEVICE": z.array(oulR22DeviceSchema).optional(),
  "DSC": segments.dscSchema.optional()
}).register(hl7v2Metadata, {
  title: "OUL_R22",
  version: "2.9",
  description: "HL7 v2.9 OUL_R22 message",
  type: "Message"
});
