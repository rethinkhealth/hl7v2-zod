...
/**
 * HL7 v2.9 OUL_R23 Message
 * 
 * HL7 v2.9 OUL_R23 message definition
...
export const oulR23PatientObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const oulR23VisitSchema = z.object({
  ...
  title: "OUL_R23.VISIT",
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.VISIT group",
  type: "Group"
});
...
export const oulR23SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const oulR23OrderDocumentSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.ORDER_DOCUMENT group",
  type: "Group"
});
...
export const oulR23TimingQtySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.TIMING_QTY group",
  type: "Group"
});
...
export const oulR23ResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.RESULT group",
  type: "Group"
});
...
/**
 * OUL_R23.DEVICE group schema
 * Defines the structure and validation rules for the OUL_R23.DEVICE group
 */
export const oulR23DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R23.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OUL_R23.DEVICE schema
 */
export type OUL_R23_DEVICE = z.infer<typeof oulR23DeviceSchema>;
...
export const oulR23PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.PATIENT group",
  type: "Group"
});
...
export const oulR23CommonOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.COMMON_ORDER group",
  type: "Group"
});
...
export const oulR23OrderSchema = z.object({
  ...
  title: "OUL_R23.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.ORDER group",
  type: "Group"
});
...
export const oulR23ContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.CONTAINER group",
  type: "Group"
});
...
export const oulR23SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R23.SPECIMEN group",
  type: "Group"
});
...
export const oul_r23Schema = z.object({
  ...
  "DEVICE": z.array(oulR23DeviceSchema).optional(),
  "DSC": segments.dscSchema.optional()
}).register(hl7v2Metadata, {
  title: "OUL_R23",
  version: "2.9",
  description: "HL7 v2.9 OUL_R23 message",
  type: "Message"
});
