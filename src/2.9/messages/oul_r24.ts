...
/**
 * HL7 v2.9 OUL_R24 Message
 * 
 * HL7 v2.9 OUL_R24 message definition
...
export const oulR24PatientObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.PATIENT_OBSERVATION group",
  type: "Group"
});
...
export const oulR24VisitSchema = z.object({
  ...
  title: "OUL_R24.VISIT",
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.VISIT group",
  type: "Group"
});
...
export const oulR24OrderDocumentSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.ORDER_DOCUMENT group",
  type: "Group"
});
...
export const oulR24TimingQtySchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.TIMING_QTY group",
  type: "Group"
});
...
export const oulR24SpecimenObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.SPECIMEN_OBSERVATION group",
  type: "Group"
});
...
export const oulR24ContainerSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.CONTAINER group",
  type: "Group"
});
...
export const oulR24ResultSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.RESULT group",
  type: "Group"
});
...
/**
 * OUL_R24.DEVICE group schema
 * Defines the structure and validation rules for the OUL_R24.DEVICE group
 */
export const oulR24DeviceSchema = z.object({
  "DEV": segments.devSchema,
  "OBX": z.array(segments.obxSchema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R24.DEVICE",
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.DEVICE group",
  type: "Group"
});

/**
 * TypeScript type inferred from the OUL_R24.DEVICE schema
 */
export type OUL_R24_DEVICE = z.infer<typeof oulR24DeviceSchema>;
...
export const oulR24PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.PATIENT group",
  type: "Group"
});
...
export const oulR24CommonOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.COMMON_ORDER group",
  type: "Group"
});
...
export const oulR24SpecimenSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.SPECIMEN group",
  type: "Group"
});
...
export const oulR24OrderSchema = z.object({
  ...
  "DEVICE": z.array(oulR24DeviceSchema).optional()
}).register(hl7v2Metadata, {
  title: "OUL_R24.ORDER",
  version: "2.9",
  description: "HL7 v2.9 OUL_R24.ORDER group",
  type: "Group"
});
...
export const oul_r24Schema = z.object({
  ...
  title: "OUL_R24",
  version: "2.9",
  description: "HL7 v2.9 OUL_R24 message",
  type: "Message"
});
