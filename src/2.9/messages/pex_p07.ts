...
/**
 * HL7 v2.9 PEX_P07 Message
 * 
 * HL7 v2.9 PEX_P07 message definition
 ...
 */
export const pexP07VisitSchema = z.object({
  ...
  title: "PEX_P07.VISIT",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.VISIT group",
  type: "Group"
});
 ...
 */
export const pexP07TimingQtySchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "PEX_P07.TIMING_QTY",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.TIMING_QTY group",
  type: "Group"
});
 ...
 */
export const pexP07RxAdministrationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.RX_ADMINISTRATION group",
  type: "Group"
});
...
/**
 * PEX_P07.OBSERVATION group schema
 * Defines the structure and validation rules for the PEX_P07.OBSERVATION group
 */
export const pexP07ObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "PEX_P07.OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the PEX_P07.OBSERVATION schema
 */
export type PEX_P07_OBSERVATION = z.infer<typeof pexP07ObservationSchema>;

/**
 * PEX_P07.NK1_TIMING_QTY group schema
 * Defines the structure and validation rules for the PEX_P07.NK1_TIMING_QTY group
 */
export const pexP07Nk1TimingQtySchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "PEX_P07.NK1_TIMING_QTY",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.NK1_TIMING_QTY group",
  type: "Group"
});
 ...
 */
export const pexP07AssociatedRxAdminSchema = z.object({
  "RXA": segments.rxaSchema,
  "RXR": segments.rxrSchema.optional(),
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  ...
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.ASSOCIATED_RX_ADMIN group",
  type: "Group"
});
...
/**
 * PEX_P07.ASSOCIATED_OBSERVATION group schema
 * Defines the structure and validation rules for the PEX_P07.ASSOCIATED_OBSERVATION group
 */
export const pexP07AssociatedObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "PEX_P07.ASSOCIATED_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.ASSOCIATED_OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the PEX_P07.ASSOCIATED_OBSERVATION schema
 */
export type PEX_P07_ASSOCIATED_OBSERVATION = z.infer<typeof pexP07AssociatedObservationSchema>;

/**
 * PEX_P07.STUDY group schema
 * Defines the structure and validation rules for the PEX_P07.STUDY group
 */
export const pexP07StudySchema = z.object({
  "CSR": segments.csrSchema,
  "CSP": z.array(segments.cspSchema).optional()
}).register(hl7v2Metadata, {
  title: "PEX_P07.STUDY",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.STUDY group",
  type: "Group"
});
 ...
 */
export const pexP07RxOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.RX_ORDER group",
  type: "Group"
});
 ...
 */
export const pexP07AssociatedRxOrderSchema = z.object({
  "RXE": segments.rxeSchema,
  "PRT": z.array(segments.prtSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.ASSOCIATED_RX_ORDER group",
  type: "Group"
});
 ...
 */
export const pexP07AssociatedPersonSchema = z.object({
  ...
  "ASSOCIATED_OBSERVATION": z.array(pexP07AssociatedObservationSchema).optional()
}).register(hl7v2Metadata, {
  title: "PEX_P07.ASSOCIATED_PERSON",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.ASSOCIATED_PERSON group",
  type: "Group"
});
 ...
 */
export const pexP07PexCauseSchema = z.object({
  ...
  "PRB": z.array(segments.prbSchema).optional(),
  "OBSERVATION": z.array(pexP07ObservationSchema).optional(),
  ...
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.PEX_CAUSE group",
  type: "Group"
});
 ...
 */
export const pexP07PexObservationSchema = z.object({
  "PEO": segments.peoSchema,
  "PEX_CAUSE": z.array(pexP07PexCauseSchema)
}).register(hl7v2Metadata, {
  title: "PEX_P07.PEX_OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07.PEX_OBSERVATION group",
  type: "Group"
});
 ...
 */
export const pex_p07Schema = z.object({
  ...
  title: "PEX_P07",
  version: "2.9",
  description: "HL7 v2.9 PEX_P07 message",
  type: "Message"
});
