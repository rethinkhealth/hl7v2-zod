...
/**
 * HL7 v2.9 RDE_O11 Message
 * 
 * HL7 v2.9 RDE_O11 message definition
 ...
 */
export const rdeO11PatientVisitSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.PATIENT_VISIT group",
  type: "Group"
});
 ...
 */
export const rdeO11InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.INSURANCE group",
  type: "Group"
});
 ...
 */
export const rdeO11TimingSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RDE_O11.TIMING",
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.TIMING group",
  type: "Group"
});
 ...
 */
export const rdeO11ComponentSchema = z.object({
  "RXC": segments.rxcSchema,
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RDE_O11.COMPONENT",
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.COMPONENT group",
  type: "Group"
});
 ...
 */
export const rdeO11TimingEncodedSchema = z.object({
  "TQ1": segments.tq1Schema,
  "TQ2": z.array(segments.tq2Schema).optional()
}).register(hl7v2Metadata, {
  title: "RDE_O11.TIMING_ENCODED",
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.TIMING_ENCODED group",
  type: "Group"
});
 ...
 */
export const rdeO11ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.OBSERVATION group",
  type: "Group"
});
 ...
 */
export const rdeO11PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.PATIENT group",
  type: "Group"
});
 ...
 */
export const rdeO11OrderDetailSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.ORDER_DETAIL group",
  type: "Group"
});
 ...
 */
export const rdeO11PharmacyTreatmentInfusionOrderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.PHARMACY_TREATMENT_INFUSION_ORDER group",
  type: "Group"
});
 ...
 */
export type RDE_O11_PHARMACY_TREATMENT_INFUSION_ORDER = z.infer<typeof rdeO11PharmacyTreatmentInfusionOrderSchema>;

/**
 * RDE_O11.ORDER group schema
 * Defines the structure and validation rules for the RDE_O11.ORDER group
 */
export const rdeO11OrderSchema = z.object({
  ...
  "NTE": z.array(segments.nteSchema).optional(),
  "TIMING_ENCODED": z.array(rdeO11TimingEncodedSchema),
  "PHARMACY_TREATMENT_INFUSION_ORDER": z.array(rdeO11PharmacyTreatmentInfusionOrderSchema).optional(),
  "RXR": z.array(segments.rxrSchema),
  ...
  title: "RDE_O11.ORDER",
  version: "2.9",
  description: "HL7 v2.9 RDE_O11.ORDER group",
  type: "Group"
});
 ...
 */
export const rde_o11Schema = z.object({
  ...
  title: "RDE_O11",
  version: "2.9",
  description: "HL7 v2.9 RDE_O11 message",
  type: "Message"
});
