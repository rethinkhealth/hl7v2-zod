...
/**
 * HL7 v2.9 RPA_I08 Message
 * 
 * HL7 v2.9 RPA_I08 message definition
...
export const rpaI08AuthorizationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.AUTHORIZATION group",
  type: "Group"
});
...
export const rpaI08ProviderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.PROVIDER group",
  type: "Group"
});
...
export const rpaI08InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.INSURANCE group",
  type: "Group"
});
...
export const rpaI08ResultsSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.RESULTS group",
  type: "Group"
});
...
export const rpaI08VisitSchema = z.object({
  ...
  title: "RPA_I08.VISIT",
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.VISIT group",
  type: "Group"
});
...
export const rpaI08ProcedureSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.PROCEDURE group",
  type: "Group"
});
...
export const rpaI08ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPA_I08.OBSERVATION group",
  type: "Group"
});
...
export const rpa_i08Schema = z.object({
  ...
  title: "RPA_I08",
  version: "2.9",
  description: "HL7 v2.9 RPA_I08 message",
  type: "Message"
});
