...
/**
 * HL7 v2.9 RPI_I01 Message
 * 
 * HL7 v2.9 RPI_I01 message definition
...
export const rpiI01ProviderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPI_I01.PROVIDER group",
  type: "Group"
});
...
export const rpiI01InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPI_I01.INSURANCE group",
  type: "Group"
});
...
export const rpiI01GuarantorInsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPI_I01.GUARANTOR_INSURANCE group",
  type: "Group"
});
...
export const rpi_i01Schema = z.object({
  ...
  title: "RPI_I01",
  version: "2.9",
  description: "HL7 v2.9 RPI_I01 message",
  type: "Message"
});
