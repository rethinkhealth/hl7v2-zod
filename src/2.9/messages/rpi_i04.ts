...
/**
 * HL7 v2.9 RPI_I04 Message
 * 
 * HL7 v2.9 RPI_I04 message definition
...
export const rpiI04ProviderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPI_I04.PROVIDER group",
  type: "Group"
});
...
export const rpiI04InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPI_I04.INSURANCE group",
  type: "Group"
});
...
export const rpiI04GuarantorInsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RPI_I04.GUARANTOR_INSURANCE group",
  type: "Group"
});
...
export const rpi_i04Schema = z.object({
  ...
  title: "RPI_I04",
  version: "2.9",
  description: "HL7 v2.9 RPI_I04 message",
  type: "Message"
});
