...
/**
 * HL7 v2.9 RQA_I08 Message
 * 
 * HL7 v2.9 RQA_I08 message definition
...
export const rqaI08AuthorizationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.AUTHORIZATION group",
  type: "Group"
});
...
export const rqaI08ProviderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.PROVIDER group",
  type: "Group"
});
...
export const rqaI08InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.INSURANCE group",
  type: "Group"
});
...
export const rqaI08ResultsSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.RESULTS group",
  type: "Group"
});
...
export const rqaI08VisitSchema = z.object({
  ...
  title: "RQA_I08.VISIT",
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.VISIT group",
  type: "Group"
});
...
export const rqaI08ProcedureSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.PROCEDURE group",
  type: "Group"
});
...
export const rqaI08GuarantorInsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.GUARANTOR_INSURANCE group",
  type: "Group"
});
...
export const rqaI08ObservationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQA_I08.OBSERVATION group",
  type: "Group"
});
...
export const rqa_i08Schema = z.object({
  ...
  title: "RQA_I08",
  version: "2.9",
  description: "HL7 v2.9 RQA_I08 message",
  type: "Message"
});
