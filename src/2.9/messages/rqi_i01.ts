...
/**
 * HL7 v2.9 RQI_I01 Message
 * 
 * HL7 v2.9 RQI_I01 message definition
...
export const rqiI01ProviderSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQI_I01.PROVIDER group",
  type: "Group"
});
...
export const rqiI01InsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQI_I01.INSURANCE group",
  type: "Group"
});
...
export const rqiI01GuarantorInsuranceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RQI_I01.GUARANTOR_INSURANCE group",
  type: "Group"
});
...
export const rqi_i01Schema = z.object({
  ...
  title: "RQI_I01",
  version: "2.9",
  description: "HL7 v2.9 RQI_I01 message",
  type: "Message"
});
