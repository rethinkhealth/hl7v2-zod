...
/**
 * HL7 v2.9 RRD_O14 Message
 * 
 * HL7 v2.9 RRD_O14 message definition
...
export const rrdO14PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRD_O14.PATIENT group",
  type: "Group"
});
...
export const rrdO14TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRD_O14.TIMING group",
  type: "Group"
});
...
export const rrdO14DispenseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRD_O14.DISPENSE group",
  type: "Group"
});
...
export const rrdO14OrderSchema = z.object({
  ...
  title: "RRD_O14.ORDER",
  version: "2.9",
  description: "HL7 v2.9 RRD_O14.ORDER group",
  type: "Group"
});
...
export const rrdO14ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRD_O14.RESPONSE group",
  type: "Group"
});
...
export const rrd_o14Schema = z.object({
  ...
  title: "RRD_O14",
  version: "2.9",
  description: "HL7 v2.9 RRD_O14 message",
  type: "Message"
});
