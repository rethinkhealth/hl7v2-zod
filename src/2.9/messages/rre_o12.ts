...
/**
 * HL7 v2.9 RRE_O12 Message
 * 
 * HL7 v2.9 RRE_O12 message definition
...
export const rreO12PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRE_O12.PATIENT group",
  type: "Group"
});
...
export const rreO12TimingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRE_O12.TIMING group",
  type: "Group"
});
...
export const rreO12TimingEncodedSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRE_O12.TIMING_ENCODED group",
  type: "Group"
});
...
export const rreO12EncodingSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRE_O12.ENCODING group",
  type: "Group"
});
...
export const rreO12OrderSchema = z.object({
  ...
  title: "RRE_O12.ORDER",
  version: "2.9",
  description: "HL7 v2.9 RRE_O12.ORDER group",
  type: "Group"
});
...
export const rreO12ResponseSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RRE_O12.RESPONSE group",
  type: "Group"
});
...
export const rre_o12Schema = z.object({
  ...
  title: "RRE_O12",
  version: "2.9",
  description: "HL7 v2.9 RRE_O12 message",
  type: "Message"
});
