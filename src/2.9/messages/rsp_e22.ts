...
/**
 * HL7 v2.9 RSP_E22 Message
 * 
 * HL7 v2.9 RSP_E22 message definition
...
export const rspE22PslItemInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RSP_E22.PSL_ITEM_INFO group",
  type: "Group"
});
...
export const rspE22AuthorizationInfoSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RSP_E22.AUTHORIZATION_INFO group",
  type: "Group"
});
...
export const rspE22QueryAckSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RSP_E22.QUERY_ACK group",
  type: "Group"
});
...
export const rsp_e22Schema = z.object({
  ...
  title: "RSP_E22",
  version: "2.9",
  description: "HL7 v2.9 RSP_E22 message",
  type: "Message"
});
