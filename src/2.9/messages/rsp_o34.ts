...
/**
 * HL7 v2.9 RSP_O34 Message
 * 
 * HL7 v2.9 RSP_O34 message definition
...
/**
 * RSP_O34.DONOR_OBSERVATIONS group schema
 * Defines the structure and validation rules for the RSP_O34.DONOR_OBSERVATIONS group
 */
export const rspO34DonorObservationsSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "RSP_O34.DONOR_OBSERVATIONS",
  version: "2.9",
  description: "HL7 v2.9 RSP_O34.DONOR_OBSERVATIONS group",
  type: "Group"
});

/**
 * TypeScript type inferred from the RSP_O34.DONOR_OBSERVATIONS schema
 */
export type RSP_O34_DONOR_OBSERVATIONS = z.infer<typeof rspO34DonorObservationsSchema>;
 ...
 */
export const rspO34DonorRegistrationSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 RSP_O34.DONOR_REGISTRATION group",
  type: "Group"
});
 ...
 */
export const rspO34DonationSchema = z.object({
  "DON": segments.donSchema,
  "DONOR_OBSERVATIONS": z.array(rspO34DonorObservationsSchema).optional(),
  "NTE": z.array(segments.nteSchema).optional()
}).register(hl7v2Metadata, {
  title: "RSP_O34.DONATION",
  version: "2.9",
  description: "HL7 v2.9 RSP_O34.DONATION group",
  type: "Group"
});
 ...
 */
export const rspO34DonorSchema = z.object({
  ...
  title: "RSP_O34.DONOR",
  version: "2.9",
  description: "HL7 v2.9 RSP_O34.DONOR group",
  type: "Group"
});
 ...
 */
export const rsp_o34Schema = z.object({
  ...
  title: "RSP_O34",
  version: "2.9",
  description: "HL7 v2.9 RSP_O34 message",
  type: "Message"
});
