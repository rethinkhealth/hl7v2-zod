...
/**
 * HL7 v2.9 RTB_Z74 Message
 * 
 * HL7 v2.9 RTB_Z74 message definition
 ...
 */
export const rtbZ74RowDefinitionSchema = z.object({
  "RDF": segments.rdfSchema,
  "RDT": z.array(segments.rdtSchema).optional()
}).register(hl7v2Metadata, {
  title: "RTB_Z74.ROW_DEFINITION",
  version: "2.9",
  description: "HL7 v2.9 RTB_Z74.ROW_DEFINITION group",
  type: "Group"
});
 ...
 */
export const rtb_z74Schema = z.object({
  ...
  title: "RTB_Z74",
  version: "2.9",
  description: "HL7 v2.9 RTB_Z74 message",
  type: "Message"
});
