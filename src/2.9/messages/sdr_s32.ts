...
/**
 * HL7 v2.9 SDR_S32 Message
 * 
 * HL7 v2.9 SDR_S32 message definition
 ...
 */
export const sdrS32Anti-microbialDeviceCycleDataSchema = z.object({
  "SDD": segments.sddSchema,
  "SCD": z.array(segments.scdSchema).optional()
}).register(hl7v2Metadata, {
  title: "SDR_S32.ANTI-MICROBIAL_DEVICE_CYCLE_DATA",
  version: "2.9",
  description: "HL7 v2.9 SDR_S32.ANTI-MICROBIAL_DEVICE_CYCLE_DATA group",
  type: "Group"
});
 ...
 */
export type SDR_S32_ANTI-MICROBIAL_DEVICE_CYCLE_DATA = z.infer<typeof sdrS32Anti-microbialDeviceCycleDataSchema>;

/**
 * SDR_S32 message schema
 * Defines the structure and validation rules for the SDR_S32 message
 */
export const sdr_s32Schema = z.object({
  "MSH": segments.mshSchema,
  "SFT": z.array(segments.sftSchema).optional(),
  "UAC": segments.uacSchema.optional(),
  "ANTI-MICROBIAL_DEVICE_CYCLE_DATA": sdrS32Anti-microbialDeviceCycleDataSchema
}).register(hl7v2Metadata, {
  title: "SDR_S32",
  version: "2.9",
  description: "HL7 v2.9 SDR_S32 message",
  type: "Message"
});
