...
/**
 * HL7 v2.9 SRM_S01 Message
 * 
 * HL7 v2.9 SRM_S01 message definition
...
/**
 * SRM_S01.OBSERVATION group schema
 * Defines the structure and validation rules for the SRM_S01.OBSERVATION group
 */
export const srmS01ObservationSchema = z.object({
  "OBX": segments.obxSchema,
  "PRT": z.array(segments.prtSchema).optional()
}).register(hl7v2Metadata, {
  title: "SRM_S01.OBSERVATION",
  version: "2.9",
  description: "HL7 v2.9 SRM_S01.OBSERVATION group",
  type: "Group"
});

/**
 * TypeScript type inferred from the SRM_S01.OBSERVATION schema
 */
export type SRM_S01_OBSERVATION = z.infer<typeof srmS01ObservationSchema>;

/**
 * SRM_S01.SERVICE group schema
 * Defines the structure and validation rules for the SRM_S01.SERVICE group
 */
export const srmS01ServiceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRM_S01.SERVICE group",
  type: "Group"
});
 ...
 */
export const srmS01GeneralResourceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRM_S01.GENERAL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const srmS01LocationResourceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRM_S01.LOCATION_RESOURCE group",
  type: "Group"
});
 ...
 */
export const srmS01PersonnelResourceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRM_S01.PERSONNEL_RESOURCE group",
  type: "Group"
});
 ...
 */
export const srmS01ResourcesSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRM_S01.RESOURCES group",
  type: "Group"
});
 ...
 */
export const srm_s01Schema = z.object({
  ...
  title: "SRM_S01",
  version: "2.9",
  description: "HL7 v2.9 SRM_S01 message",
  type: "Message"
});
