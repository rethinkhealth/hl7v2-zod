...
/**
 * HL7 v2.9 SRR_S01 Message
 * 
 * HL7 v2.9 SRR_S01 message definition
...
export const srrS01PatientSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.PATIENT group",
  type: "Group"
});
...
export const srrS01ServiceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.SERVICE group",
  type: "Group"
});
...
export const srrS01GeneralResourceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.GENERAL_RESOURCE group",
  type: "Group"
});
...
export const srrS01LocationResourceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.LOCATION_RESOURCE group",
  type: "Group"
});
...
export const srrS01PersonnelResourceSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.PERSONNEL_RESOURCE group",
  type: "Group"
});
...
export const srrS01ResourcesSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.RESOURCES group",
  type: "Group"
});
 ...
 */
export type SRR_S01_RESOURCES = z.infer<typeof srrS01ResourcesSchema>;
...
export const srrS01ScheduleSchema = z.object({
  ...
  version: "2.9",
  description: "HL7 v2.9 SRR_S01.SCHEDULE group",
  type: "Group"
});
...
export const srr_s01Schema = z.object({
  ...
  title: "SRR_S01",
  version: "2.9",
  description: "HL7 v2.9 SRR_S01 message",
  type: "Message"
});
