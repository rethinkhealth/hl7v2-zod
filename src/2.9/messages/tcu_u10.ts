...
/**
 * HL7 v2.9 TCU_U10 Message
 * 
 * HL7 v2.9 TCU_U10 message definition
 ...
 */
export const tcuU10TestConfigurationSchema = z.object({
  "SPM": segments.spmSchema.optional(),
  "TCC": z.array(segments.tccSchema)
}).register(hl7v2Metadata, {
  title: "TCU_U10.TEST_CONFIGURATION",
  version: "2.9",
  description: "HL7 v2.9 TCU_U10.TEST_CONFIGURATION group",
  type: "Group"
});
 ...
 */
export const tcu_u10Schema = z.object({
  ...
  title: "TCU_U10",
  version: "2.9",
  description: "HL7 v2.9 TCU_U10 message",
  type: "Message"
});
